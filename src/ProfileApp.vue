...
const projects = computed(() => [
  ...
  { icon: '港', name: '香港中文大学(深圳) AI智能助手', nameEn: 'CUHK-SZ AI Assistant', description: locale.value === 'zh' ? '校园智能问答助手' : 'Campus Q&A assistant', descriptionFull: locale.value === 'zh' ? '为研究生招生、教务、政策咨询提供智能化回答系统，实现信息发布自动化、FAQ智能匹配与流程指引。' : 'Smart Q&A for graduate admissions, academic affairs, and policy consultation.', descriptionFullEn: 'Intelligent Q&A system for graduate admissions, academic affairs, and policy consultation.', color: 'from-blue-500 to-cyan-500', link: 'http://www.llmhi.com:9200', status: locale.value === 'zh' ? '已上线' : 'Online', features: locale.value === 'zh' ? ['Q&A 智能助手', '学院知识库构建', 'LLM + RAG 智能体系'] : ['Q&A AI Assistant', 'Knowledge base construction', 'LLM + RAG system'], tech: ['Qwen', 'LLM Fine-tuning', 'Qdrant', 'RAG'] },
  { icon: 'G', name: '广东以色列理工学院 AI助手', nameEn: 'GTIIT AI Assistant', description: locale.value === 'zh' ? '为GTIIT提供的智能问答助手' : 'Q&A assistant for GTIIT', descriptionFull: locale.value === 'zh' ? '人工智能驱动的招生问答、政策解释与招生策略推荐系统。' : 'AI-driven admissions Q&A and strategy recommendation.', descriptionFullEn: 'AI-driven admissions Q&A, policy interpretation, and strategy recommendation system.', color: 'from-emerald-500 to-teal-500', link: 'https://gtiitscholar.com', status: locale.value === 'zh' ? '已上线' : 'Online', features: locale.value === 'zh' ? ['招生政策问答', '招生流程指引', '国际办学体系FAQ', '招生材料自动校验'] : ['Admissions Policy Q&A', 'Process Guidance', 'International Education FAQ', 'Auto Material Verification'], tech: ['LLM Q&A', 'Multi-KB Routing', 'Vector Retrieval'] },
  { icon: 'V', name: 'VoxChina 生成式科研平台', nameEn: 'VoxChina Generative Research', description: locale.value === 'zh' ? '生成式AI科研协作平台' : 'Generative AI research platform', descriptionFull: locale.value === 'zh' ? '搭建文章摘要、多篇聚合摘要、语音播报和知识问答的 AI 内容平台。' : 'AI content platform for summarization and knowledge Q&A.', descriptionFullEn: 'AI content platform for article summarization, voice broadcast, and knowledge Q&A.', color: 'from-orange-500 to-amber-500', status: locale.value === 'zh' ? '开发中' : 'In Dev', features: locale.value === 'zh' ? ['文章智能摘要', '多篇聚合分析', '语音播报系统', '知识问答引擎'] : ['Smart article summarization', 'Multi-article aggregation', 'Voice broadcast', 'Knowledge Q&A engine'], tech: ['Qwen', 'Whisper', 'Qdrant', 'RAG'] },
