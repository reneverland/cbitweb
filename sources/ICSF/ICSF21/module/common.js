...
var generateHeaderFrame = function() {
	return  '<div class="container">'+
			...
			'					<a title="International Conference on Smart Finance 2021" href="index.html">' + 
			'						ICSF 2021' + 
			'					</a>' + 
			'				</div>' + 
			'			</div>' + 
...
var generateFooterFrame = function() {
	return  '<div class="container">' + 
			...
			'ICSF 2021' +
			'		Copyright © 2021 <span>CUHKSZ</span> All rights reserved. ' + 
...
var generateFooter = function(p_locale) {
	...
	var html_text =  
					...
					'ICSF 2021 Copyright © 2021 <span>CUHKSZ</span> All rights reserved.';
