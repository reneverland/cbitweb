...
var i18n_header_footer = {
	'en-us': {
		'issf': 'Intercollegiate Conference on Smart Finance 2018',
		'home': 'Home',
		'about': 'About',
...
var generateHeaderFrame = function() {
	return  '<div class="container">'+
			...
			'					<a title="International Conference on Smart Finance 2018" href="index.html">' + 
			'						ICSF 2018' + 
			'					</a>' + 
			'				</div>' + 
			'			</div>' + 
			...
			'		   				</div>' + 
			'					<div class="row">' + 
			'						<div align= "center" style="font-size:280%">' + 					
			'							International Conference on Smart Finance 2018' + 
			'						</a>' + 
			'						</div>' + 
			'					</div>' +
			'		   			</div>' + 
...
var generateFooterFrame = function() {
	return  '<div class="container">' + 
			...
			'ICSF 2018' +
			'		Copyright © 2018 <span>SUST</span> All rights reserved. ' + 
			'	</div>' + 
			'</div>';
};
...
var generateFooter = function(p_locale) {
	...
	var html_text =  
					...
					'ICSF 2018 Copyright © 2018 <span>SUST</span> All rights reserved.';
