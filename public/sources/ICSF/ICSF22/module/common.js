...
var i18n_header_footer = {
	'en-us': {
		...
		'host': 'hosts',
		'contact': 'Secretariat of ICSF 2022',
...
var generateHeaderFrame = function() {
	return  '<div class="container">'+
			...
			'					<a title="International Conference on Smart Finance 2022" href="index.html">' + 
			'						ICSF 2022' + 
			'					</a>' + 
			'				</div>' + 
			'			</div>' + 
...
var generateFooterFrame = function() {
	return  '<div class="container">' + 
			...
			'ICSF 2022' +
			'		Copyright © 2022 <span>HKU</span> All rights reserved. ' + 
...
var generateFooter = function(p_locale) {
	...
	var html_text =  
					...
					'ICSF 2022 Copyright © 2022 <span>HKU</span> All rights reserved.';
