"function" != typeof Object.create && (Object.create = function(obj) {
    ...
    }), window.lazySizesConfig = window.lazySizesConfig || {}, window.lazySizesConfig.lazyClass = "aux-preload", window.lazySizesConfig.loadingClass = "aux-preloading", window.lazySizesConfig.loadedClass = "aux-preloaded", document.addEventListener("lazybeforeunveil", function(e) {
        var color = e.target.getAttribute("data-bg-color");
        color && (e.target.style.backgroundColor = color)
    }), document.addEventListener("lazyloaded", function(e) {
        if (e.target.getAttribute("data-bg-color") && (e.target.style.backgroundColor = "initial"), e.target.classList.contains("aux-has-preload-height") && (e.target.classList.remove("aux-has-preload-height"), e.target.style.height = "auto"), "VIDEO" === e.target.nodeName) {
            var video = e.target;
            for (var source in video.children) {
                var videoSource = video.children[source];
                "SOURCE" === videoSource.tagName && videoSource.getAttribute("data-src") && (videoSource.src = videoSource.getAttribute("data-src"))
            }
    ...
    function($, window, document) {
        ...
        function resposiveNotLoadedImages() {
            ...
            Array.prototype.forEach.call(lazysizeImages, function(el, i) {
                (width = el.getAttribute("width")) && (height = el.getAttribute("height")) && (el.style.height = el.clientWidth / (width / height) + "px", el.classList.add("aux-has-preload-height"))
            })
        }
        window.addEventListener("orientationchange", resposiveNotLoadedImages), window.addEventListener("resize", resposiveNotLoadedImages), $(resposiveNotLoadedImages)
    ...
    function(factory) {
        ...
        $.extend($.easing, {
            ...
            easeInOutBack: function(x) {
                return x < .5 ? pow(2 * x, 2) * (7.189819 * x - c2) / 2 : (pow(2 * x - 2, 2) * ((1 + c2) * (2 * x - 2) + c2) + 2) / 2
            },
    ...
    function(factory) {
        ...
        var nullLowestDeltaTimeout, lowestDelta, toFix = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
            toBind = "onwheel" in window.document || 9 <= window.document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"],
        ...
        function handler(event) {
            ...
            if ((event = $.event.fix(orgEvent)).type = "mousewheel", "detail" in orgEvent && (deltaY = -1 * orgEvent.detail), "wheelDelta" in orgEvent && (deltaY = orgEvent.wheelDelta), "wheelDeltaY" in orgEvent && (deltaY = orgEvent.wheelDeltaY), "wheelDeltaX" in orgEvent && (deltaX = -1 * orgEvent.wheelDeltaX), "axis" in orgEvent && orgEvent.axis === orgEvent.HORIZONTAL_AXIS && (deltaX = -1 * deltaY, deltaY = 0), delta = 0 === deltaY ? deltaX : deltaY, "deltaY" in orgEvent && (delta = deltaY = -1 * orgEvent.deltaY), "deltaX" in orgEvent && (deltaX = orgEvent.deltaX, 0 === deltaY && (delta = -1 * deltaX)), 0 !== deltaY || 0 !== deltaX) {
                ...
                if (absDelta = Math.max(Math.abs(deltaY), Math.abs(deltaX)), (!lowestDelta || absDelta < lowestDelta) && shouldAdjustOldDeltas(orgEvent, lowestDelta = absDelta) && (lowestDelta /= 40), shouldAdjustOldDeltas(orgEvent, absDelta) && (delta /= 40, deltaX /= 40, deltaY /= 40), delta = Math[1 <= delta ? "floor" : "ceil"](delta / lowestDelta), deltaX = Math[1 <= deltaX ? "floor" : "ceil"](deltaX / lowestDelta), deltaY = Math[1 <= deltaY ? "floor" : "ceil"](deltaY / lowestDelta), special.settings.normalizeOffset && this.getBoundingClientRect) {
                    ...
                    event.offsetX = event.clientX - boundingRect.left, event.offsetY = event.clientY - boundingRect.top
                }
                return event.deltaX = deltaX, event.deltaY = deltaY, event.deltaFactor = lowestDelta, event.deltaMode = 0, args.unshift(event, delta, deltaX, deltaY), nullLowestDeltaTimeout && window.clearTimeout(nullLowestDeltaTimeout), nullLowestDeltaTimeout = window.setTimeout(nullLowestDelta, 200), ($.event.dispatch || $.event.handle).apply(this, args)
            }
        }
    ...
    function(a, b) {
        ...
        function h(a, b) {
            return a = a.replace("#", ""), "jQuery" in window && b ? $("#" + a, b)[0] : document.getElementById(a)
        }
        var k, l, a = function(a, b) {
                var c;
                if (a === b) return a;
            ...
            b = function(a, b) {
                ...
                if (Array.prototype.map && a.map === Array.prototype.map) e = Array.prototype.map.call(a, function(a) {
                    ...
                    for (c = 0; c < f; c++) callback_params = d, callback_params.splice(0, 0, a[c]), e.push(b.apply(this, callback_params));
                return e
            },
            c = function(a) {
                var b, c = [];
            ...
            f = function(a, b) {
                var c;
                for (c = 0; c < a.length; c++) a[c] instanceof google.maps.LatLng || (0 < a[c].length && "object" == typeof a[c][0] ? a[c] = f(a[c], b) : a[c] = d(a[c], b));
                return a
            },
            j = function() {
                var c = document,
                    d = function(b) {
                        ...
                        if ("string" == typeof b.el || "string" == typeof b.div ? -1 < n.indexOf("#") ? this.el = h(n, b.context) : this.el = function(a, b) {
                                var c = a.replace(".", "");
                                return "jQuery" in this && b ? $("." + c, b)[0] : document.getElementsByClassName(c)[0]
                            }.apply(this, [n, b.context]) : this.el = n, void 0 === this.el || null === this.el) throw "No element defined.";
                        ...
                        function D(a, b) {
                            ...
                            if (h("gmaps_context_menu")) {
                                ...
                                for (e = 0; e < l; e++) {
                                    var m = k[e];
                                    google.maps.event.clearListeners(m, "click"), google.maps.event.addDomListenerOnce(m, "click", function(c) {
                        ...
                        function E(a, c) {
                            google.maps.event.addListener(a, c, function(a) {
                                null == a && (a = this), b[c].apply(this, [a]), j.hideContextMenu()
                            })
                        }
                        ...
                        google.maps.event.addListener(this.map, "rightclick", function(a) {
                            b.rightclick && b.rightclick.apply(this, [a]), null != window.context_menu[j.el.id].map && j.buildContextMenu("map", a)
        ...
        return j.prototype.createControl = function(a) {
            var b = document.createElement("div");
            for (var c in b.style.cursor = "pointer", !0 !== a.disableDefaultStyles && (b.style.fontFamily = "Roboto, Arial, sans-serif", b.style.fontSize = "11px", b.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px"), a.style) b.style[c] = a.style[c];
            for (var d in a.id && (b.id = a.id), a.title && (b.title = a.title), a.classes && (b.className = a.classes), a.content && ("string" == typeof a.content ? b.innerHTML = a.content : a.content instanceof HTMLElement && b.appendChild(a.content)), a.position && (b.position = google.maps.ControlPosition[a.position.toUpperCase()]), a.events) ! function(b, c) {
            ...
            if (null == b.lat && null == b.lng && null == b.position) throw "No latitude or longitude defined.";
            var c = this,
                d = b.details,
                e = b.fences,
                f = b.outside,
            ...
            for (k = 0; k < l.length; k++) ! function(a, c) {
                b[c] && google.maps.event.addListener(a, c, function() {
                    b[c].apply(this, [this])
                })
            }(i, l[k]);
            for (k = 0; k < m.length; k++) ! function(a, c, d) {
            ...
            return google.maps.event.addListener(i, "click", function() {
                ...
                a.marker = this, b.rightclick && b.rightclick.apply(this, [a]), null != window.context_menu[c.el.id].marker && c.buildContextMenu("marker", a)
            ...
            if (void 0 === a) {
                for (var c = 0; c < this.markers.length; c++) {
                    (d = this.markers[c]).setMap(null), j.fire("marker_removed", d, this)
                }
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (-1 < e)(d = this.markers[e]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(d), j.fire("marker_removed", d, this)
                }
            ...
            return b.setMap(this.map), null != a.auto_show && (c = a.auto_show), b.onAdd = function() {
                ...
                var e = this.getProjection().fromLatLngToDivPixel(new google.maps.LatLng(a.lat, a.lng));
            ...
            d.hasOwnProperty("useGeoJSON") && (e = d.useGeoJSON), delete d.useGeoJSON, d = a({
                map: this.map
            }, d), 0 == e && (d.paths = [d.paths.slice(0)]), 0 < d.paths.length && 0 < d.paths[0].length && (d.paths = c(b(d.paths, f, e)));
            ...
            0 < (d = a({
                ...
                path: !1,
                samples: 256
            }, d)).locations.length && 0 < d.locations[0].length && (d.locations = c(b([d.locations], f, !1)));
            var e = d.callback;
            delete d.callback;
            ...
            if (a.origin && a.destination) this.getRoutes({
                ...
                error: a.error,
                callback: function(b) {
                    if (0 < b.length && a.start && a.start(b[b.length - 1]), 0 < b.length && a.step) {
                        var c = b[b.length - 1];
                        if (0 < c.legs.length)
            ...
            if (a.origin && a.destination) this.getRoutes({
                ...
                error: a.error,
                callback: function(c) {
                    if (0 < c.length && a.start && a.start(c[c.length - 1]), 0 < c.length && a.step) {
                        var d = c[c.length - 1];
                        if (0 < d.legs.length)
            ...
            a = a || {};
            var b = {};
            if (b.size = a.size || [this.el.clientWidth, this.el.clientHeight], b.lat = this.getCenter().lat(), b.lng = this.getCenter().lng(), 0 < this.markers.length) {
                b.markers = [];
            ...
            function b(a, b) {
                if ("#" === a[0] && (a = a.replace("#", "0x"), b)) {
                    ...
                    1 === (b = (255 * b).toString(16)).length && (b += b), a = a.slice(0, 8) + b
                }
                return a
            }
            var c, d = [],
            ...
            var j = a.size;
            j ? (j.join && (j = j.join("x")), delete a.size) : j = "630x300", d.push("size=" + j), a.zoom || !1 === a.zoom || (a.zoom = 15);
            var k = !a.hasOwnProperty("sensor") || !!a.sensor;
            for (var l in delete a.sensor, d.push("sensor=" + k), a) a.hasOwnProperty(l) && d.push(l + "=" + a[l]);
            if (f)
                for (var m, n, o = 0; c = f[o]; o++) {
                    for (var l in m = [], c.size && "normal" !== c.size ? (m.push("size:" + c.size), delete c.size) : c.icon && (m.push("icon:" + encodeURI(c.icon)), delete c.icon), c.color && (m.push("color:" + c.color.replace("#", "0x")), delete c.color), c.label && (m.push("label:" + c.label[0].toUpperCase()), delete c.label), n = c.address ? c.address : c.lat + "," + c.lng, delete c.address, delete c.lat, delete c.lng, c) c.hasOwnProperty(l) && m.push(l + ":" + c[l]);
            ...
            for (f = 0; f < d.length; f++) ! function(a, c) {
                b[c] && google.maps.event.addListener(a, c, function() {
                    b[c].apply(this)
                })
            }(g, d[f]);
            ...
            if (-1 == j.custom_events.indexOf(a)) return b instanceof j && (b = b.map), google.maps.event.addListenerOnce(b, a, c)
            ...
            if (0 == c) return -1;
            var d = 0;
            if (1 < arguments.length && ((d = Number(arguments[1])) != d ? d = 0 : 0 != d && d != 1 / 0 && d != -1 / 0 && (d = (0 < d || -1) * Math.floor(Math.abs(d)))), c <= d) return -1;
...
! function(factory) {
    "function" == typeof define && define.amd ? define(["jquery"], factory) : "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = function(root, jQuery) {
        return void 0 === jQuery && (jQuery = "undefined" != typeof window ? require("jquery") : require("jquery")(root)), factory(jQuery), jQuery
    } : factory(jQuery)
}(function($) {
    return $.fn.tilt = function(options) {
        var requestTick = function() {
                this.ticking || (requestAnimationFrame(updateTransforms.bind(this)), this.ticking = !0)
            },
            setTransition = function() {
                var _this2 = this;
                void 0 !== this.timeout && clearTimeout(this.timeout), $(this).css({
                    ...
                    $(_this2).css({
                        transition: ""
                    }), _this2.settings.glare && _this2.glareElement.css({
                        transition: ""
                    })
                }, this.settings.speed)
            },
            mouseEnter = function() {
                this.ticking = !1, $(this).css({
                    "will-change": "transform"
                }), setTransition.call(this), $(this).trigger("tilt.mouseEnter")
            },
            ...
            mouseMove = function(event) {
                this.mousePositions = getMousePositions(event), requestTick.call(this)
            },
            mouseLeave = function() {
                setTransition.call(this), this.reset = !0, requestTick.call(this), $(this).trigger("tilt.mouseLeave")
            },
            getValues = function() {
                ...
                return {
                    tiltX: reverse * (this.settings.maxTilt / 2 - percentageX * this.settings.maxTilt).toFixed(2),
                    tiltY: reverse * (percentageY * this.settings.maxTilt - this.settings.maxTilt / 2).toFixed(2),
            ...
            updateTransforms = function() {
                if (this.transforms = getValues.call(this), this.reset) return this.reset = !1, $(this).css("transform", "perspective(" + this.settings.perspective + "px) rotateX(0deg) rotateY(0deg)"), void(this.settings.glare && (this.glareElement.css("transform", "rotate(180deg) translate(-50%, -50%)"), this.glareElement.css("opacity", "0")));
        ...
        return $.fn.tilt.destroy = function() {
            $(this).each(function() {
                $(this).find(".js-tilt-glare").remove(), $(this).css({
                    "will-change": "",
                    transform: ""
            ...
            return $(this).each(function() {
                this.mousePositions = getMousePositions.call(this), results.push(getValues.call(this))
            }), results
        }, $.fn.tilt.reset = function() {
            $(this).each(function() {
                var _this3 = this;
                this.mousePositions = getMousePositions.call(this), this.settings = $(this).data("settings"), mouseLeave.call(this), setTimeout(function() {
                    _this3.reset = !1
            ...
            this.settings = $.extend({
                ...
                reverse: !!$(this).is("[data-tilt-reverse]") && $(this).data("tilt-reverse")
            }, options), null !== this.settings.axis && (console.warn("Tilt.js: the axis setting has been renamed to disableAxis. See https://github.com/gijsroge/tilt.js/pull/26 for more information"), this.settings.disableAxis = this.settings.axis), this.init = function() {
                $(_this4).data("settings", _this4.settings), _this4.settings.glare && function() {
                    ...
                    function() {
                        $(this).on("mousemove", mouseMove), $(this).on("mouseenter", mouseEnter), this.settings.reset && $(this).on("mouseleave", mouseLeave), this.settings.glare && $(window).on("resize", updateGlareSize.bind(this))
                    }.call(_this4)
            }, this.init()
        })
    }, $("[data-tilt]").tilt(), !0
...
function(window, factory) {
    ...
    function jQueryBridget(namespace, PluginClass, $) {
        ($ = $ || jQuery || window.jQuery) && (PluginClass.prototype.option || (PluginClass.prototype.option = function(opts) {
            ...
            }(this, arg0, arraySlice.call(arguments, 1)) : (function($elems, options) {
...
function(window, factory) {
    ...
    utils.makeArray = function(obj) {
        ...
        return elems.forEach(function(elem) {
            if (function(elem) {
                    return "object" == typeof HTMLElement ? elem instanceof HTMLElement : elem && "object" == typeof elem && null !== elem && 1 === elem.nodeType && "string" == typeof elem.nodeName
                }(elem))
                if (selector) {
...
function(window, factory) {
    ...
    proto.setPosition = function() {
        if (_setPosition.apply(this, arguments), this.layout.options.imgSizes) {
            this.imageElements || (this.imageElements = this.element.querySelectorAll('img[sizes="auto"]'));
            for (var images = this.imageElements, i = 0, len = images.length; i !== len; i++) {
                var img = images[i];
                img.setAttribute("sizes", img.offsetWidth + "px")
            }
        }!this._lazyloadStarted && this.layout.options.lazyload && (this._lazyloadStarted = !0, this._lazyload())
    }, proto._lazyload = function() {
        this.layout.dispatchEvent("beforeItemLoading", null, [this]);
        for (var imagesLoadedInstance, images = this.element.querySelectorAll("img[data-src]"), i = 0, len = images.length; i !== len; i++) {
            var img = images[i];
            img.setAttribute("src", img.getAttribute("data-src")), img.removeAttribute("data-src"), img.getAttribute("data-srcset") && (img.setAttribute("srcset", img.getAttribute("data-srcset")), img.removeAttribute("data-srcset"))
        }
        this.layout.options.useImagesLoaded && window.imagesLoaded && (imagesLoadedInstance = window.imagesLoaded(this.element)), this.layout.dispatchEvent("itemLoading", null, [this, imagesLoadedInstance])
    };
...
function(window, factory) {
    ...
    function LayoutMode(isotope) {
        (this.isotope = isotope) && (this.options = isotope.options[this.namespace], this.element = isotope.element, this.items = isotope.filteredItems, this.size = isotope.size)
    }
    var proto = LayoutMode.prototype;
    return ["_resetLayout", "_getItemLayoutPosition", "_manageStamp", "_getContainerSize", "_getElementOffset", "needsResizeLayout", "_getOption"].forEach(function(methodName) {
        proto[methodName] = function() {
            return Outlayer.prototype[methodName].apply(this.isotope, arguments)
        }
    }), proto.needsVerticalResizeLayout = function() {
        var size = getSize(this.isotope.element);
        return this.isotope.size && size && size.innerHeight != this.isotope.size.innerHeight
        ...
        return (Mode.prototype = Object.create(proto)).constructor = Mode, options && (Mode.options = options), LayoutMode.modes[Mode.prototype.namespace = namespace] = Mode
    }, LayoutMode
}),
function(window, factory) {
...
function(window, factory) {
    "function" == typeof define && define.amd ? define("isotope-layout/js/layout-modes/masonry", ["../layout-mode", "masonry-layout/masonry"], factory) : "object" == typeof module && module.exports ? module.exports = factory(require("../layout-mode")) : factory(window.Isotope.LayoutMode, window.Masonry)
...
function(window, factory) {
    "use strict";
    "function" == typeof define && define.amd ? define("isotope-layout/js/layout-modes/justify-rows", ["../layout-mode"], factory) : "object" == typeof exports ? module.exports = factory(require("../layout-mode")) : factory(window.Isotope.LayoutMode)
    ...
    return proto._resetLayout = function() {
        ...
        for (var totalHeight = 0, i = 0, len = rowItems.length; i !== len; i++) {
            var itemEle = rowItems[i].element;
            totalHeight += (parseInt(itemEle.getAttribute("data-width"), 10) || rowItems[i].size.outerWidth) / (parseInt(itemEle.getAttribute("data-height"), 10) || rowItems[i].size.outerHeight)
        }
        ...
        for (var i = 0, len = rowItems.length; i !== len; i++) {
            ...
            itemEle.style.width = rowHeight * w / h + "px", itemEle.style.height = rowHeight + "px"
        }
    }, proto._beforeLayout = function() {
        var row, rowHeight, maxHeight = this.options.maxHeight || 200,
        ...
        newRow: for (; 0 < checkItems.length;) {
            for (var i = 0, len = checkItems.length; i !== len; i++)
                if (row = checkItems.slice(0, i + 1), (rowHeight = this._getRowHeight(row, containerWidth)) < maxHeight) {
                    this._resizeItems(row, rowHeight), checkItems = checkItems.slice(i + 1);
                    continue newRow
                }
...
function(window, factory) {
    "function" == typeof define && define.amd ? define("isotope-layout/js/isotope", ["outlayer/outlayer", "get-size/get-size", "desandro-matches-selector/matches-selector", "fizzy-ui-utils/utils", "./item", "./layout-mode", "./layout-modes/masonry", "./layout-modes/justify-rows", "./layout-modes/fit-rows", "./layout-modes/vertical"], function(Outlayer, getSize, matchesSelector, utils, Item, LayoutMode) {
        return factory(window, Outlayer, getSize, matchesSelector, utils, Item, LayoutMode)
    }) : "object" == typeof module && module.exports ? module.exports = factory(window, require("outlayer"), require("get-size"), require("desandro-matches-selector"), require("fizzy-ui-utils"), require("./item"), require("./layout-mode"), require("./layout-modes/masonry"), require("./layout-modes/fit-rows"), require("./layout-modes/justify-rows"), require("./layout-modes/vertical")) : window.Isotope = factory(window, window.Outlayer, window.getSize, window.matchesSelector, window.fizzyUIUtils, window.Isotope.Item, window.Isotope.LayoutMode)
    ...
    Isotope.prototype.layoutItems = function(items, isInstant) {
        this._beforeLayout(items, isInstant), _layoutItems.apply(this, arguments)
    }, proto.arrange = function(opts) {
        this.option(opts), this._getIsInstant();
        var filtered = this._filter(this.items);
        if (this.filteredItems = filtered.matches, this.notPaginatedItems = this.filteredItems, this._sort(), this.options.pagination) {
            var paginationResult = this._pagination();
            filtered.needHide = filtered.needHide.concat(paginationResult.needHide), filtered.needReveal = paginationResult.needReveal
        }
        if (this._bindArrangeComplete(), this._hideRevealItems(filtered), this._layout(), this.options.pagination)
            for (var i = 0, l = this.filteredItems.length; i !== l; i++) this.filteredItems[i].isLayoutInstant = !1
    }, Isotope.prototype._init = Isotope.prototype.arrange, proto._hideRevealItems = function(items) {
        this._isInstant ? this._noTransition(this._hideReveal, [items]) : this._hideReveal(items)
        ...
        this._lastFilter !== this.options.filter && (this._lastFilter = this.options.filter, this.options.page = 1), this.notPaginatedItems || (this.notPaginatedItems = this.filteredItems);
        ...
        for (var i = 0, len = items.length; i !== len; i++) {
            var item = items[i];
            startItemInPage <= i && i <= endItemInPage ? (inPage.push(item), item.isHidden && (needReveal.push(item), item.isLayoutInstant = !0)) : item.isHidden || needHide.push(item)
        }
        return this.filteredItems = inPage, pageChanged && this.dispatchEvent("paginationUpdate", null, [page, totalPages, inPage]), {
            matches: inPage,
            needHide: needHide,
            needReveal: needReveal
        }
    }, proto.page = function(pageNum) {
        this.options.page = Math.max(1, Math.min(pageNum, this.totalPages())), this._hideRevealItems(this._pagination()), this._layout()
        ...
        var items;
        items = elems ? (elems = utils.makeArray(elems), this.getItems(elems)) : this.items, this._getSorters(), this._updateItemsSortData(items)
    };
    ...
    proto._getSorters = function() {
            ...
            var itemSorter = function(sortBys, sortAsc) {
                return function(itemA, itemB) {
                    for (var i = 0; i < sortBys.length; i++) {
                        ...
                        if (b < a || a < b) return (b < a ? 1 : -1) * ((void 0 !== sortAsc[sortBy] ? sortAsc[sortBy] : sortAsc) ? 1 : -1)
                    }
                    return 0
                }
            }(this.sortHistory, this.options.sortAscending);
            this.options.pagination ? this.notPaginatedItems.sort(itemSorter) : this.filteredItems.sort(itemSorter)
        }
        ...
        this.isResizeBound && this.needsResizeLayout() && (this.options.resizeTransition ? this.layout() : this._noTransition(this.layout))
    }, proto.appended = function(elems) {
        var items = this.addItems(elems);
        if (items.length) {
            ...
            if (pagination) {
                this.notPaginatedItems = this.notPaginatedItems.concat(filteredItems), this._resetLayout(), this._manageStamps();
                var paginateResult = this._pagination();
                this._hideRevealItems(paginateResult), this.layoutItems(this.filteredItems)
            } else this.filteredItems = this.filteredItems.concat(filteredItems)
        }
    }, proto.prepended = function(elems) {
        var items = this._itemize(elems);
        if (items.length) {
            ...
            if (pagination) {
                ...
                var paginateResult = this._pagination();
                this._hideRevealItems(paginateResult), this.layoutItems(this.filteredItems)
            } else this.layoutItems(this.filteredItems), this.filteredItems = filteredItems.concat(this.filteredItems);
...
function(window, factory) {
    ...
    return proto.contains = function(rect) {
        ...
        }), freeRects.push(freeRect)), rectRight < thisRight && (freeRect = new Rect({
            x: rectRight,
            y: this.y,
            width: thisRight - rectRight,
            height: this.height
        }), freeRects.push(freeRect)), rectBottom < thisBottom && (freeRect = new Rect({
            x: this.x,
            y: rectBottom,
            width: this.width,
...
function(window, factory) {
    ...
    proto.reset = function() {
        ...
        for (var i = 0; i < this.spaces.length; i++) {
            var space = this.spaces[i];
            if (space.x <= rect.x && space.x + space.width >= rect.x + rect.width && space.height >= rect.height - .01) {
        ...
        for (var i = 0; i < this.spaces.length; i++) {
            var space = this.spaces[i];
            if (space.y <= rect.y && space.y + space.height >= rect.y + rect.height && space.width >= rect.width - .01) {
...
function(window, factory) {
    ...
    var transformProperty = "string" == typeof document.documentElement.style.transform ? "transform" : "WebkitTransform",
    ...
    return proto.moveTo = function(x, y) {
        ...
        this.layout.dragItemCount && !this.isPlacing && !this.isTransitioning && dx < 1 && dy < 1 ? this.goTo(x, y) : _moveTo.apply(this, arguments)
...
function(window, factory) {
    ...
    proto._create = function() {
        ...
        if (this._setRectSize(item.element, item.rect), this.isShifting || 0 < this.dragItemCount) {
        ...
        return measurement = Math[remainder && remainder < 1 ? "round" : "ceil"](measurement / gridSize) * gridSize
    }, proto._getContainerSize = function() {
        ...
        var boundsSize, isHorizontal = this._getOption("horizontal"),
            segmentName = isHorizontal ? "rowHeight" : "columnWidth",
            measure = isHorizontal ? "height" : "width";
        ...
        if (segment = segment && segment + this.gutter) {
            ...
            for (var i = 0; i < segs; i++) this._addShiftTarget(i * segment, 0, boundsSize)
        ...
        items.forEach(function(item) {
            ...
            if (this._addShiftTarget(cornerX, cornerY, boundsSize), segment)
                for (var segSpan = Math.round(rect[measure] / segment), i = 1; i < segSpan; i++) {
        ...
        if (!(0 !== checkCoord && boundsSize < checkCoord)) {
            var key = x + "," + y; - 1 != this.shiftTargetKeys.indexOf(key) || (this.shiftTargetKeys.push(key), this.shiftTargets.push({
                x: x,
                y: y
            }))
        }
        ...
        this.shiftTargets.forEach(function(target) {
            ...
            distance < minDistance && (shiftPosition = target, minDistance = distance)
    ...
    proto.itemDragMove = function(elem, x, y) {
        ...
        if (item) {
            ...
            var _this = this,
                now = new Date;
            this._itemDragTime && now - this._itemDragTime < 120 ? (clearTimeout(this.dragTimeout), this.dragTimeout = setTimeout(onDrag, 120)) : (onDrag(), this._itemDragTime = now)
        }
        ...
        function onDragEndLayoutComplete() {
            2 == ++completeCount && (item.element.classList.remove("is-positioning-post-drag"), item.hideDropPlaceholder(), _this.dispatchEvent("dragItemPositioned", null, [item]))
        }
    ...
    return function(template, UiClass, items, options) {
        var framework = {
            ...
            detectFeatures: function() {
                ...
                var helperStyle = framework.createEl().style,
                    vendor = "",
                    features = {};
                if (features.oldIE = document.all && !document.addEventListener, features.touch = "ontouchstart" in window, window.requestAnimationFrame && (features.raf = window.requestAnimationFrame, features.caf = window.cancelAnimationFrame), features.pointerEvent = !!window.PointerEvent || navigator.msPointerEnabled, !features.pointerEvent) {
                    var ua = navigator.userAgent;
                    if (/iP(hone|od)/.test(navigator.platform)) {
                        var v = navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/);
                        v && 0 < v.length && 1 <= (v = parseInt(v[1], 10)) && v < 8 && (features.isOldIOSPhone = !0)
                    }
                    var match = ua.match(/Android\s([0-9\.]*)/),
                        androidversion = match ? match[1] : 0;
                    1 <= (androidversion = parseFloat(androidversion)) && (androidversion < 4.4 && (features.isOldAndroid = !0), features.androidVersion = androidversion), features.isMobileOpera = /opera mini|opera mobi/i.test(ua)
                }
                for (var styleCheckItem, styleName, styleChecks = ["transform", "perspective", "animationName"], vendors = ["", "webkit", "Moz", "ms", "O"], i = 0; i < 4; i++) {
                    vendor = vendors[i];
                    for (var a = 0; a < 3; a++) styleCheckItem = styleChecks[a], styleName = vendor + (vendor ? styleCheckItem.charAt(0).toUpperCase() + styleCheckItem.slice(1) : styleCheckItem), !features[styleCheckItem] && styleName in helperStyle && (features[styleCheckItem] = styleName);
                ...
                return features.svg = !!document.createElementNS && !!document.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, framework.features = features
            }
        };
        ...
        function _moveMainScroll(x, dragging) {
            if (!_options.loop && dragging) {
                ...
                (newSlideIndexOffset < 0 && 0 < delta || newSlideIndexOffset >= _getNumItems() - 1 && delta < 0) && (x = _mainScrollPos.x + delta * _options.mainScrollEndFriction)
            }
        ...
        function _calculatePanOffset(axis, zoomLevel) {
            ...
            return _startPanOffset[axis] + _currPanDist[axis] + m - zoomLevel / _startZoomLevel * m
        }
        ...
        function _getMaxZoomLevel(item) {
            return 0 < (item = item || self.currItem).w ? _options.maxSpreadZoom : 1
        }

        function _modifyDestPanOffset(axis, destPanBounds, destPanOffset, destZoomLevel) {
            return destZoomLevel === self.currItem.initialZoomLevel ? (destPanOffset[axis] = self.currItem.initialPosition[axis], !0) : (destPanOffset[axis] = _calculatePanOffset(axis, destZoomLevel), destPanOffset[axis] > destPanBounds.min[axis] ? (destPanOffset[axis] = destPanBounds.min[axis], !0) : destPanOffset[axis] < destPanBounds.max[axis] && (destPanOffset[axis] = destPanBounds.max[axis], !0))
        }
        ...
        function _animateProp(name, b, endProp, d, easingFn, onUpdate, onComplete) {
            var t, startAnimTime = _getCurrentTime();
            _registerStartAnimation(name);
            var animloop = function() {
                if (_animations[name]) {
                    if (t = _getCurrentTime() - startAnimTime, d <= t) return _stopAnimation(name), onUpdate(endProp), void(onComplete && onComplete());
        ...
        function _onDragStart(e) {
            if (!("mousedown" === e.type && 0 < e.button))
                ...
                if (_preventDefaultEventBehaviour(e, !0) && e.preventDefault(), _shout("pointerDown"), _pointerEventEnabled) {
                    ...
                    pointerIndex < 0 && (pointerIndex = _currPointers.length), _currPointers[pointerIndex] = {
                        x: e.pageX,
                        y: e.pageY,
                        id: e.pointerId
                    }
        ...
        function _onDragMove(e) {
            ...
            if (_isDragging) {
                ...
                if (_direction || _moved || _isZooming) _currentPoints = touchesList;
                    ...
                    10 <= Math.abs(diff) && (_direction = 0 < diff ? "h" : "v", _currentPoints = touchesList)
                }
            }
        }
        ...
        function _onDragRelease(e) {
            if (_features.isOldAndroid) {
                if (_oldAndroidTouchEndTimeout && "mouseup" === e.type) return; - 1 < e.type.indexOf("touch") && (clearTimeout(_oldAndroidTouchEndTimeout), _oldAndroidTouchEndTimeout = setTimeout(function() {
                    _oldAndroidTouchEndTimeout = 0
                }, 600))
            }
            var releasePoint;
            if (_shout("pointerUp"), _preventDefaultEventBehaviour(e, !1) && e.preventDefault(), _pointerEventEnabled) {
                var pointerIndex = framework.arraySearch(_currPointers, e.pointerId, "id");
                if (-1 < pointerIndex)
                    if (releasePoint = _currPointers.splice(pointerIndex, 1)[0], navigator.msPointerEnabled) {
                        releasePoint.type = {
                            ...
                            2: "touch",
                            3: "pen"
                        }[e.pointerType], releasePoint.type || (releasePoint.type = e.pointerType || "mouse")
            ...
            if (0 === numPoints && (_isDragging = !1, framework.unbind(window, _upMoveEvents, self), _stopDragUpdateLoop(), _isZooming ? releaseTimeDiff = 0 : -1 !== _lastReleaseTime && (releaseTimeDiff = _getCurrentTime() - _lastReleaseTime)), _lastReleaseTime = 1 === numPoints ? _getCurrentTime() : -1, gestureType = -1 !== releaseTimeDiff && releaseTimeDiff < 150 ? "zoom" : "swipe", _isZooming && numPoints < 2 && (_isZooming = !1, 1 === numPoints && (gestureType = "zoomPointerUp"), _shout("zoomGestureEnded")), _currentPoints = null, _moved || _zoomStarted || _mainScrollAnimating || _verticalDragInitiated)
                if (_stopAllAnimations(), (_releaseAnimData = _releaseAnimData || _initDragReleaseAnimationData()).calculateSwipeSpeed("x"), _verticalDragInitiated) {
                    if (_calculateVerticalDragOpacityRatio() < _options.verticalDragRange) self.close();
                    else {
                    ...
                    if ((_mainScrollShifted || _mainScrollAnimating) && 0 === numPoints) {
                        if (_finishSwipeMainScrollGesture(gestureType, _releaseAnimData)) return;
                        gestureType = "zoomPointerUp"
                    }
                    _mainScrollAnimating || ("swipe" === gestureType ? !_mainScrollShifted && _currZoomLevel > self.currItem.fitRatio && _completePanGesture(_releaseAnimData) : _completeZoomGesture())
                }
        }
        var _isOpen, _isDestroying, _closedByScroll, _currentItemIndex, _containerStyle, _containerShiftIndex, _upMoveEvents, _downEvents, _globalEventHandlers, _currZoomLevel, _startZoomLevel, _translatePrefix, _translateSufix, _updateSizeInterval, _itemsNeedUpdate, _itemHolders, _prevItemIndex, _dragStartEvent, _dragMoveEvent, _dragEndEvent, _dragCancelEvent, _transformKey, _pointerEventEnabled, _likelyTouchDevice, _requestAF, _cancelAF, _initalClassName, _initalWindowScrollY, _oldIE, _currentWindowScrollY, _features, _orientationChangeTimeout, _gestureStartTime, _gestureCheckSpeedTime, _releaseAnimData, _isZoomingIn, _verticalDragInitiated, _oldAndroidTouchEndTimeout, _isDragging, _isMultitouch, _zoomStarted, _moved, _dragAnimFrame, _mainScrollShifted, _currentPoints, _isZooming, _startPointsDistance, _currPanBounds, _currZoomElementStyle, _mainScrollAnimating, _direction, _isFirstMove, _opacityChanged, _bgOpacity, _wasOverInitialZoom, _tempCounter, _currPanDist = {
                x: 0,
                y: 0
            },
            _startPanOffset = {
            ...
            publicMethods = {
                ...
                init: function() {
                    if (!_isOpen && !_isDestroying) {
                        ...
                        self.framework = framework, self.template = template, self.bg = framework.getChildByClass(template, "pswp__bg"), _initalClassName = template.className, _isOpen = !0, _features = framework.detectFeatures(), _requestAF = _features.raf, _cancelAF = _features.caf, _transformKey = _features.transform, _oldIE = _features.oldIE, self.scrollWrap = framework.getChildByClass(template, "pswp__scroll-wrap"), self.container = framework.getChildByClass(self.scrollWrap, "pswp__container"), _containerStyle = self.container.style, self.itemHolders = _itemHolders = [{
                            ...
                            function() {
                                if (_transformKey) {
                                    ...
                                    return _translatePrefix = "translate" + (allow3dTransform ? "3d(" : "("), _translateSufix = _features.perspective ? ", 0px)" : ")"
                                }
                                ...
                                orientationchange: function() {
                                    clearTimeout(_orientationChangeTimeout), _orientationChangeTimeout = setTimeout(function() {
                                        _viewportSize.x !== self.scrollWrap.clientWidth && self.updateSize()
                                    }, 500)
                                },
                        ...
                        for (_options.mainClass && (rootClasses += _options.mainClass + " "), _options.showHideOpacity && (rootClasses += "pswp--animate_opacity "), rootClasses += _likelyTouchDevice ? "pswp--touch" : "pswp--notouch", rootClasses += _features.animationName ? " pswp--css_animation" : "", rootClasses += _features.svg ? " pswp--svg" : "", framework.addClass(template, rootClasses), self.updateSize(), _containerShiftIndex = -1, _indexDiff = null, i = 0; i < 3; i++) _setTranslateX((i + _containerShiftIndex) * _slideSize.x, _itemHolders[i].el.style);
                        _oldIE || framework.bind(self.scrollWrap, _downEvents, self), _listen("initialZoomInEnd", function() {
                            self.setContent(_itemHolders[0], _currentItemIndex - 1), self.setContent(_itemHolders[2], _currentItemIndex + 1), _itemHolders[0].el.style.display = _itemHolders[2].el.style.display = "block", _options.focus && template.focus(), framework.bind(document, "keydown", self), _features.transform && framework.bind(self.scrollWrap, "click", self), _options.mouseUsed || framework.bind(document, "mousemove", _onFirstMouseMove), framework.bind(window, "resize scroll orientationchange", self), _shout("bindEvents")
                ...
                close: function() {
                    _isOpen && (_isDestroying = !(_isOpen = !1), _shout("close"), framework.unbind(window, "resize scroll orientationchange", self), framework.unbind(window, "scroll", _globalEventHandlers.scroll), framework.unbind(document, "keydown", self), framework.unbind(document, "mousemove", _onFirstMouseMove), _features.transform && framework.unbind(self.scrollWrap, "click", self), _isDragging && framework.unbind(window, _upMoveEvents, self), clearTimeout(_orientationChangeTimeout), _shout("unbindEvents"), _showOrHide(self.currItem, null, !0, self.destroy))
                },
                destroy: function() {
                ...
                invalidateCurrItems: function() {
                    _itemsNeedUpdate = !0;
                    for (var i = 0; i < 3; i++) _itemHolders[i].item && (_itemHolders[i].item.needsUpdate = !0)
                },
                updateCurrItem: function(beforeAnimation) {
                    if (0 !== _indexDiff) {
                        var tempHolder, diffAbs = Math.abs(_indexDiff);
                        if (!(beforeAnimation && diffAbs < 2)) {
                            self.currItem = _getItemAt(_currentItemIndex), _renderMaxResolution = !1, _shout("beforeChange", _indexDiff), 3 <= diffAbs && (_containerShiftIndex += _indexDiff + (0 < _indexDiff ? -3 : 3), diffAbs = 3);
                            for (var i = 0; i < diffAbs; i++) 0 < _indexDiff ? (tempHolder = _itemHolders.shift(), _itemHolders[2] = tempHolder, _setTranslateX((++_containerShiftIndex + 2) * _slideSize.x, tempHolder.el.style), self.setContent(tempHolder, _currentItemIndex - diffAbs + i + 1 + 1)) : (tempHolder = _itemHolders.pop(), _itemHolders.unshift(tempHolder), _setTranslateX(--_containerShiftIndex * _slideSize.x, tempHolder.el.style), self.setContent(tempHolder, _currentItemIndex + diffAbs - i - 1 - 1));
                ...
                updateSize: function(force) {
                    ...
                    if (_viewportSize.x = self.scrollWrap.clientWidth, _viewportSize.y = self.scrollWrap.clientHeight, _updatePageScrollOffset(), _slideSize.x = _viewportSize.x + Math.round(_viewportSize.x * _options.spacing), _slideSize.y = _viewportSize.y, _moveMainScroll(_slideSize.x * _currPositionIndex), _shout("beforeResize"), void 0 !== _containerShiftIndex) {
                        for (var holder, item, hIndex, i = 0; i < 3; i++) holder = _itemHolders[i], _setTranslateX((i + _containerShiftIndex) * _slideSize.x, holder.el.style), hIndex = _currentItemIndex + i - 1, _options.loop && 2 < _getNumItems() && (hIndex = _getLoopedId(hIndex)), (item = _getItemAt(hIndex)) && (_itemsNeedUpdate || item.needsUpdate || !item.bounds) ? (self.cleanSlide(item), self.setContent(holder, hIndex), 1 === i && (self.currItem = item, self.updateCurrZoomItem(!0)), item.needsUpdate = !1) : -1 === holder.index && 0 <= hIndex && self.setContent(holder, hIndex), item && item.container && (_calculateItemSize(item, _viewportSize), _setImageSize(item), _applyZoomPanToItem(item));
                        _itemsNeedUpdate = !1
                    }
                    _startZoomLevel = _currZoomLevel = self.currItem.initialZoomLevel, (_currPanBounds = self.currItem.bounds) && (_panOffset.x = _currPanBounds.center.x, _panOffset.y = _currPanBounds.center.y, _applyCurrentZoomPan(!0)), _shout("resize")
                },
            ...
            _closestElement = function(el, fn) {
                return !(!el || el === document) && (!(el.getAttribute("class") && -1 < el.getAttribute("class").indexOf("pswp__scroll-wrap")) && (fn(el) ? el : _closestElement(el.parentNode, fn)))
            },
            _preventObj = {},
            _ePoint1 = {},
            _ePoint2 = {},
            ...
            _renderMovement = function() {
                if (_currentPoints) {
                    ...
                    if (0 !== numPoints)
                        if (_equalizePoints(p, _currentPoints[0]), delta.x = p.x - _currPoint.x, delta.y = p.y - _currPoint.y, _isZooming && 1 < numPoints) {
                            if (_currPoint.x = p.x, _currPoint.y = p.y, !delta.x && !delta.y && function(p1, p2) {
                                    return p1.x === p2.x && p1.y === p2.y
                                }(_currentPoints[1], p2)) return;
                            ...
                            if (zoomLevel < minZoomLevel)
                                if (_options.pinchToClose && !_wasOverInitialZoom && _startZoomLevel <= self.currItem.initialZoomLevel) {
                                    var percent = 1 - (minZoomLevel - zoomLevel) / (minZoomLevel / 1.2);
                                    _applyBgOpacity(percent), _shout("onPinchClose", percent), _opacityChanged = !0
                                } else 1 < (zoomFriction = (minZoomLevel - zoomLevel) / minZoomLevel) && (zoomFriction = 1), zoomLevel = minZoomLevel - zoomFriction * (minZoomLevel / 3);
                            else maxZoomLevel < zoomLevel && (1 < (zoomFriction = (zoomLevel - maxZoomLevel) / (6 * minZoomLevel)) && (zoomFriction = 1), zoomLevel = maxZoomLevel + zoomFriction * minZoomLevel);
                            zoomFriction < 0 && (zoomFriction = 0), pointsDistance, _findCenterOfPoints(p, p2, _centerPoint), _currPanDist.x += _centerPoint.x - _currCenterPoint.x, _currPanDist.y += _centerPoint.y - _currCenterPoint.y, _equalizePoints(_currCenterPoint, _centerPoint), _panOffset.x = _calculatePanOffset("x", zoomLevel), _panOffset.y = _calculatePanOffset("y", zoomLevel), _isZoomingIn = _currZoomLevel < zoomLevel, _currZoomLevel = zoomLevel, _applyCurrentZoomPan()
                        } else {
                            if (!_direction) return;
                            if (_isFirstMove && (_isFirstMove = !1, 10 <= Math.abs(delta.x) && (delta.x -= _currentPoints[0].x - _startPoint.x), 10 <= Math.abs(delta.y) && (delta.y -= _currentPoints[0].y - _startPoint.y)), _currPoint.x = p.x, _currPoint.y = p.y, 0 === delta.x && 0 === delta.y) return;
                            if ("v" === _direction && _options.closeOnVerticalDrag && "fit" === _options.scaleMode && _currZoomLevel === self.currItem.initialZoomLevel) {
                            ...
                            }(_getCurrentTime(), p.x, p.y), _moved = !0, _currPanBounds = self.currItem.bounds, _panOrMoveMainScroll("x", delta) || (_panOrMoveMainScroll("y", delta), _roundPoint(_panOffset), _applyCurrentZoomPan())
                        }
                }
            },
            _initDragReleaseAnimationData = function() {
                var lastFlickDuration, tempReleasePos, s = {
                    ...
                    calculateSwipeSpeed: function(axis) {
                        tempReleasePos = 1 < _posPoints.length ? (lastFlickDuration = _getCurrentTime() - _gestureCheckSpeedTime + 50, _posPoints[_posPoints.length - 2][axis]) : (lastFlickDuration = _getCurrentTime() - _gestureStartTime, _startPoint[axis]), s.lastFlickOffset[axis] = _currPoint[axis] - tempReleasePos, s.lastFlickDist[axis] = Math.abs(s.lastFlickOffset[axis]), 20 < s.lastFlickDist[axis] ? s.lastFlickSpeed[axis] = s.lastFlickOffset[axis] / lastFlickDuration : s.lastFlickSpeed[axis] = 0, Math.abs(s.lastFlickSpeed[axis]) < .1 && (s.lastFlickSpeed[axis] = 0), s.slowDownRatio[axis] = .95, s.slowDownRatioReverse[axis] = 1 - s.slowDownRatio[axis], s.speedDecelerationRatio[axis] = 1
                    },
                    ...
                    panAnimLoop: function() {
                        if (_animations.zoomPan && (_animations.zoomPan.raf = _requestAF(s.panAnimLoop), s.now = _getCurrentTime(), s.timeDiff = s.now - s.lastNow, s.lastNow = s.now, s.calculateAnimOffset("x"), s.calculateAnimOffset("y"), _applyCurrentZoomPan(), s.calculateOverBoundsAnimOffset("x"), s.calculateOverBoundsAnimOffset("y"), s.speedDecelerationRatioAbs.x < .05 && s.speedDecelerationRatioAbs.y < .05)) return _panOffset.x = Math.round(_panOffset.x), _panOffset.y = Math.round(_panOffset.y), _applyCurrentZoomPan(), void _stopAnimation("zoomPan")
                    }
                };
                return s
            },
            _completePanGesture = function(animData) {
                if (animData.calculateSwipeSpeed("y"), _currPanBounds = self.currItem.bounds, animData.backAnimDestination = {}, animData.backAnimStarted = {}, Math.abs(animData.lastFlickSpeed.x) <= .05 && Math.abs(animData.lastFlickSpeed.y) <= .05) return animData.speedDecelerationRatioAbs.x = animData.speedDecelerationRatioAbs.y = 0, animData.calculateOverBoundsAnimOffset("x"), animData.calculateOverBoundsAnimOffset("y"), !0;
            ...
            _finishSwipeMainScrollGesture = function(gestureType, _releaseAnimData) {
                ...
                if (_mainScrollAnimating || (_currZoomedItemIndex = _currentItemIndex), "swipe" === gestureType) {
                    var totalShiftDist = _currPoint.x - _startPoint.x,
                        isFastLastFlick = _releaseAnimData.lastFlickDist.x < 10;
                    30 < totalShiftDist && (isFastLastFlick || 20 < _releaseAnimData.lastFlickOffset.x) ? itemsDiff = -1 : totalShiftDist < -30 && (isFastLastFlick || _releaseAnimData.lastFlickOffset.x < -20) && (itemsDiff = 1)
                }
                itemsDiff && ((_currentItemIndex += itemsDiff) < 0 ? (_currentItemIndex = _options.loop ? _getNumItems() - 1 : 0, nextCircle = !0) : _currentItemIndex >= _getNumItems() && (_currentItemIndex = _options.loop ? 0 : _getNumItems() - 1, nextCircle = !0), nextCircle && !_options.loop || (_indexDiff += itemsDiff, _currPositionIndex -= itemsDiff, itemChanged = !0));
                var finishAnimDuration, animateToX = _slideSize.x * _currPositionIndex,
                    animateToDist = Math.abs(animateToX - _mainScrollPos.x);
                return finishAnimDuration = itemChanged || animateToX > _mainScrollPos.x == 0 < _releaseAnimData.lastFlickSpeed.x ? (finishAnimDuration = 0 < Math.abs(_releaseAnimData.lastFlickSpeed.x) ? animateToDist / Math.abs(_releaseAnimData.lastFlickSpeed.x) : 333, finishAnimDuration = Math.min(finishAnimDuration, 400), Math.max(finishAnimDuration, 250)) : 333, _currZoomedItemIndex === _currentItemIndex && (itemChanged = !1), _mainScrollAnimating = !0, _shout("mainScrollAnimStart"), _animateProp("mainScroll", _mainScrollPos.x, animateToX, finishAnimDuration, framework.easing.cubic.out, _moveMainScroll, function() {
            ...
            _completeZoomGesture = function() {
                var destZoomLevel = _currZoomLevel,
                    minZoomLevel = _getMinZoomLevel(),
                    maxZoomLevel = _getMaxZoomLevel();
                _currZoomLevel < minZoomLevel ? destZoomLevel = minZoomLevel : maxZoomLevel < _currZoomLevel && (destZoomLevel = maxZoomLevel);
                var onUpdate, initialOpacity = _bgOpacity;
                return _opacityChanged && !_isZoomingIn && !_wasOverInitialZoom && _currZoomLevel < minZoomLevel ? self.close() : (_opacityChanged && (onUpdate = function(now) {
        ...
        function _checkForError(item, cleanUp) {
            if (item.src && item.loadError && item.container) return cleanUp && (item.container.innerHTML = ""), item.container.innerHTML = _options.errorMsg.replace("%url%", item.src), !0
        }

        function _appendImagesPool() {
            if (_imagesToAppendPool.length) {
                for (var poolItem, i = 0; i < _imagesToAppendPool.length; i++)(poolItem = _imagesToAppendPool[i]).holder.index === poolItem.index && _appendImage(poolItem.index, poolItem.item, poolItem.baseDiv, poolItem.img, 0, poolItem.clearPlaceholder);
                _imagesToAppendPool = []
            }
        }
        var _showOrHideTimeout, _items, _initialContentSet, _initialZoomRunning, _getItemAt, _getNumItems, _showOrHide = function(item, img, out, completeFn) {
                var thumbBounds;
                _showOrHideTimeout && clearTimeout(_showOrHideTimeout), _initialContentSet = _initialZoomRunning = !0, item.initialLayout ? (thumbBounds = item.initialLayout, item.initialLayout = null) : thumbBounds = _options.getThumbBoundsFn && _options.getThumbBoundsFn(_currentItemIndex);
                ...
                closeWithRaf = _closedByScroll, fadeEverything = !self.currItem.src || self.currItem.loadError || _options.showHideOpacity, item.miniImg && (item.miniImg.style.webkitBackfaceVisibility = "hidden"), out || (_currZoomLevel = thumbBounds.w / item.w, _panOffset.x = thumbBounds.x, _panOffset.y = thumbBounds.y - _initalWindowScrollY, self[fadeEverything ? "template" : "bg"].style.opacity = .001, _applyCurrentZoomPan()), _registerStartAnimation("initialZoom"), out && !closeWithRaf && framework.removeClass(template, "pswp--animated-in"), fadeEverything && (out ? framework[(closeWithRaf ? "remove" : "add") + "Class"](template, "pswp--animate_opacity") : setTimeout(function() {
            ...
            _calculateItemSize = function(item, viewportSize, zoomLevel) {
                if (!item.src || item.loadError) return item.w = item.h = 0, item.initialZoomLevel = item.fitRatio = 1, item.bounds = {
                    center: {
                        x: 0,
                        y: 0
                    },
                ...
                if (isInitial && (item.vGap || (item.vGap = {
                    ...
                    "orig" === scaleMode ? zoomLevel = 1 : "fit" === scaleMode && (zoomLevel = item.fitRatio), 1 < zoomLevel && (zoomLevel = 1), item.initialZoomLevel = zoomLevel, item.bounds || (item.bounds = {
                        center: {
                            x: 0,
                            y: 0
                        },
                ...
                return zoomLevel ? (function(item, realPanElementW, realPanElementH) {
                ...
                }(item, item.w * zoomLevel, item.h * zoomLevel), isInitial && zoomLevel === item.initialZoomLevel && (item.initialPosition = item.bounds.center), item.bounds) : void 0
            },
        ...
        _registerModule("Controller", {
            publicMethods: {
                ...
                initController: function() {
                    framework.extend(_options, _controllerDefaultOptions, !0), self.items = _items = items, _getItemAt = self.getItemAt, _getNumItems = _options.getNumItemsFn, _options.loop, _getNumItems() < 3 && (_options.loop = !1), _listen("beforeChange", function(diff) {
                        ...
                        for (var item, i = 0; i < _items.length; i++)(item = _items[i]).container && (item.container = null), item.placeholder && (item.placeholder = null), item.img && (item.img = null), item.preloader && (item.preloader = null), item.loadError && (item.loaded = item.loadError = !1);
                ...
                allowProgressiveImg: function() {
                    return _options.forceProgressiveLoading || !_likelyTouchDevice || _options.mouseUsed || 1200 < screen.width
                },
                setContent: function(holder, index) {
                    ...
                    if (item) {
                        ...
                        var baseDiv = (holder.item = item).container = framework.createEl("pswp__zoom-wrap");
                        if (!item.src && item.html && (item.html.tagName ? baseDiv.appendChild(item.html) : baseDiv.innerHTML = item.html), _checkForError(item), _calculateItemSize(item, _viewportSize), !item.src || item.loadError || item.loaded) item.src && !item.loadError && ((img = framework.createEl("pswp__img", "img")).style.opacity = 1, img.src = item.src, _setImageSize(item, img), _appendImage(0, item, baseDiv, img));
                        else {
        ...
        var tapTimer, _wheelDelta, tapReleasePoint = {};
        _registerModule("Tap", {
            publicMethods: {
                initTap: function() {
                ...
                onTapRelease: function(e, releasePoint) {
                    if (releasePoint && !_moved && !_isMultitouch && !_numAnimations) {
                        var p0 = releasePoint;
                        if (tapTimer && (clearTimeout(tapTimer), tapTimer = null, function(touch0, touch1) {
                                return Math.abs(touch0.x - touch1.x) < 25 && Math.abs(touch0.y - touch1.y) < 25
                            }(p0, tapReleasePoint))) return void _shout("doubleTap", p0);
                        if ("mouse" === releasePoint.type) return void _dispatchTapEvent(e, releasePoint, "mouse");
                        if ("BUTTON" === e.target.tagName.toUpperCase() || framework.hasClass(e.target, "pswp__single-tap")) return void _dispatchTapEvent(e, releasePoint);
            ...
            publicMethods: {
                ...
                setupDesktopZoom: function(onInit) {
                    ...
                    function updateZoomable() {
                        self.mouseZoomedIn && (framework.removeClass(template, "pswp--zoomed-in"), self.mouseZoomedIn = !1), _currZoomLevel < 1 ? framework.addClass(template, "pswp--zoom-allowed") : framework.removeClass(template, "pswp--zoom-allowed"), removeDraggingClass()
                    }
                    var hasDraggingClass, removeDraggingClass = function() {
                ...
                handleMouseWheel: function(e) {
                    if (_currZoomLevel <= self.currItem.fitRatio) return _options.modal && (!_options.closeOnScroll || _numAnimations || _isDragging ? e.preventDefault() : _transformKey && 2 < Math.abs(e.deltaY) && (_closedByScroll = !0, self.close())), !0;
                    ...
                    else if ("wheelDelta" in e) e.wheelDeltaX && (_wheelDelta.x = -.16 * e.wheelDeltaX), e.wheelDeltaY ? _wheelDelta.y = -.16 * e.wheelDeltaY : _wheelDelta.y = -.16 * e.wheelDelta;
                    else {
        ...
        var _historyUpdateTimeout, _hashChangeTimeout, _hashAnimCheckTimeout, _hashChangedByScript, _hashChangedByHistory, _hashReseted, _initialHash, _historyChanged, _closedFromURL, _urlChangedOnce, _windowLoc, _supportsPushState, _historyDefaultOptions = {
            ...
            _updateHash = function() {
                if (_hashAnimCheckTimeout && clearTimeout(_hashAnimCheckTimeout), _numAnimations || _isDragging) _hashAnimCheckTimeout = setTimeout(_updateHash, 500);
                else {
            ...
            publicMethods: {
                initHistory: function() {
                    if (framework.extend(_options, _historyDefaultOptions, !0), _options.history) {
                        _windowLoc = window.location, _historyChanged = _closedFromURL = _urlChangedOnce = !1, _initialHash = _getHash(), _supportsPushState = "pushState" in history, -1 < _initialHash.indexOf("gid=") && (_initialHash = (_initialHash = _initialHash.split("&gid=")[0]).split("?gid=")[0]), _listen("afterChange", self.updateURL), _listen("unbindEvents", function() {
                        ...
                        var index = _initialHash.indexOf("pid="); - 1 < index && "&" === (_initialHash = _initialHash.substring(0, index)).slice(-1) && (_initialHash = _initialHash.slice(0, -1)), setTimeout(function() {
                            _isOpen && framework.bind(window, "hashchange", self.onHashChange)
                        }, 40)
                    }
                },
                onHashChange: function() {
                    if (_getHash() === _initialHash) return _closedFromURL = !0, void self.close();
                    _hashChangedByScript || (_hashChangedByHistory = !0, self.goTo(_parseItemIndexFromURL().pid), _hashChangedByHistory = !1)
                },
                updateURL: function() {
...
function(root, factory) {
    ...
    return function(pswp, framework) {
        function _onControlsTap(e) {
            ...
            for (var uiElement, found, clickedClass = (e.target || e.srcElement).getAttribute("class") || "", i = 0; i < _uiElements.length; i++)(uiElement = _uiElements[i]).onTap && -1 < clickedClass.indexOf("pswp__" + uiElement.name) && (uiElement.onTap(), found = !0);
            if (found) {
        ...
        function _toggleShareModal() {
            return (_shareModalHidden = !_shareModalHidden) ? (framework.removeClass(_shareModal, "pswp__share-modal--fade-in"), setTimeout(function() {
        ...
        function _openWindowPopup(e) {
            ...
            return pswp.shout("shareLinkClick", e, target), !!target.href && (!!target.hasAttribute("download") || (window.open(target.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), _shareModalHidden || _toggleShareModal(), !1))
        }
        ...
        function _applyNavBarGaps(item) {
            var gap = item.vGap;
            if (!pswp.likelyTouchDevice || _options.mouseUsed || screen.width > _options.fitControlsWidth) {
            ...
            function loopThroughChildElements(sChildren) {
                if (sChildren)
                    for (var l = sChildren.length, i = 0; i < l; i++) {
                        ...
                        for (var a = 0; a < _uiElements.length; a++) uiElement = _uiElements[a], -1 < classAttr.indexOf("pswp__" + uiElement.name) && (_options[uiElement.option] ? (framework.removeClass(item, "pswp__element--disabled"), uiElement.onInit && uiElement.onInit(item)) : framework.addClass(item, "pswp__element--disabled"))
                    }
            }
        ...
        var _fullscrenAPI, _controls, _captionContainer, _fakeCaptionContainer, _indexIndicator, _shareButton, _shareModal, _initalCloseOnScrollValue, _isIdle, _listen, _loadingIndicator, _loadingIndicatorHidden, _loadingIndicatorTimeout, _galleryHasOneSlide, _options, _blockControlsTap, _idleInterval, _idleTimer, ui = this,
            _overlayUIUpdated = !1,
            _controlsVisible = !0,
            _shareModalHidden = !0,
            _defaultUIOptions = {
        ...
        ui.init = function() {
            framework.extend(pswp.options, _defaultUIOptions, !0), _options = pswp.options, _controls = framework.getChildByClass(pswp.scrollWrap, "pswp__ui"), _listen = pswp.listen,
                function() {
                    var pinchControlsHidden;
                    _listen("onVerticalDrag", function(now) {
                        _controlsVisible && now < .95 ? ui.hideControls() : !_controlsVisible && .95 <= now && ui.showControls()
                    }), _listen("onPinchClose", function(now) {
                        _controlsVisible && now < .9 ? (ui.hideControls(), pinchControlsHidden = !0) : pinchControlsHidden && !_controlsVisible && .9 < now && ui.showControls()
                    }), _listen("zoomGestureEnded", function() {
                        (pinchControlsHidden = !1) && !_controlsVisible && ui.showControls()
                    })
                }(), _listen("beforeChange", ui.update), _listen("doubleTap", function(point) {
                    ...
                    t && t.getAttribute("class") && -1 < e.type.indexOf("mouse") && (0 < t.getAttribute("class").indexOf("__caption") || /(SMALL|STRONG|EM)/i.test(t.tagName)) && (preventObj.prevent = !1)
                }), _listen("bindEvents", function() {
                ...
                }), _listen("parseVerticalMargin", _applyNavBarGaps), _setupUIElements(), _options.shareEl && _shareButton && _shareModal && (_shareModalHidden = !0), _countNumItems(), _options.timeToIdle && _listen("mouseUsed", function() {
                ...
                }), _options.fullscreenEl && !framework.features.isOldAndroid && ((_fullscrenAPI = _fullscrenAPI || ui.getFullscreenAPI()) ? (framework.bind(document, _fullscrenAPI.eventK, ui.updateFullscreen), ui.updateFullscreen(), framework.addClass(pswp.template, "pswp--supports-fs")) : framework.removeClass(pswp.template, "pswp--supports-fs")), _options.preloaderEl && (_toggleLoadingIndicator(!0), _listen("beforeChange", function() {
            ...
            _overlayUIUpdated = !(!_controlsVisible || !pswp.currItem) && (ui.updateIndexIndicator(), _options.captionEl && (_options.addCaptionHTMLFn(pswp.currItem, _captionContainer), _togglePswpClass(_captionContainer, "caption--empty", !pswp.currItem.title)), !0), _shareModalHidden || _toggleShareModal(), _countNumItems()
            ...
            return dE.requestFullscreen ? api = {
                ...
                if (_initalCloseOnScrollValue = _options.closeOnScroll, _options.closeOnScroll = !1, "webkitRequestFullscreen" !== this.enterK) return pswp.template[this.enterK]();
...
function(factory) {
    ...
    return $scrollTo.defaults = {
        ...
        "object" == typeof duration && (settings = duration, duration = 0), "function" == typeof settings && (settings = {
            onAfter: settings
        }), "max" === target && (target = 9e9), settings = $.extend({}, $scrollTo.defaults, settings), duration = duration || settings.duration;
        ...
        return queue && (duration /= 2), settings.offset = both(settings.offset), settings.over = both(settings.over), this.each(function() {
            if (null !== target) {
                ...
                $.each(settings.axis.split(""), function(i, axis) {
                    ...
                    if (toff) attr[key] = toff[pos] + (win ? 0 : prev - $elem.offset()[pos]), settings.margin && (attr[key] -= parseInt(targ.css("margin" + Pos), 10) || 0, attr[key] -= parseInt(targ.css("border" + Pos + "Width"), 10) || 0), attr[key] += offset[pos] || 0, settings.over[pos] && (attr[key] += targ["x" === axis ? "width" : "height"]() * settings.over[pos]);
                    else {
                        var val = targ[pos];
                        attr[key] = val.slice && "%" === val.slice(-1) ? parseFloat(val) / 100 * max : val
                    }
                    settings.limit && /^\d+$/.test(attr[key]) && (attr[key] = attr[key] <= 0 ? 0 : Math.min(attr[key], max)), !i && 1 < settings.axis.length && (prev === attr[key] ? attr = {} : queue && (animate(settings.onAfterFirst), attr = {}))
...
function(fn) {
    "function" == typeof define && define.amd ? define([], fn) : "undefined" != typeof module && null !== module && module.exports ? module.exports = fn : fn()
}(function() {
    var assign = Object.assign || window.jQuery && jQuery.extend,
        threshold = 8,
        requestFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(fn, element) {
    ...
    function on(node, types, fn, data) {
        ...
        var type, events = getEvents(node),
            i = types.length;

        function handler(e) {
            fn(e, data)
        }
        for (; i--;)(events[type = types[i]] || (events[type] = [])).push([fn, handler]), node.addEventListener(type, handler)
    }

    function off(node, types, fn) {
        types = types.split(rspaces);
        var type, handlers, k, events = getEvents(node),
            i = types.length;
        if (events)
            for (; i--;)
                if (handlers = events[type = types[i]])
                    for (k = handlers.length; k--;) handlers[k][0] === fn && (node.removeEventListener(type, handlers[k][1]), handlers.splice(k, 1))
    }
    ...
    function Timer(fn) {
        ...
        function trigger(time) {
            active ? (callback(), requestFrame(trigger), active = !(running = !0)) : running = !1
        }
        this.kick = function(fn) {
            active = !0, running || trigger()
        }, this.end = function(fn) {
            var cb = callback;
            fn && (running ? (callback = active ? function() {
                cb(), fn()
            } : fn, active = !0) : fn())
        }
    }
    ...
    function changedTouch(e, data) {
        ...
        if (touch && (touch.pageX !== data.pageX || touch.pageY !== data.pageY)) return touch
    }
    ...
    function removeMouse() {
        off(document, mouseevents.move, mousemove), off(document, mouseevents.cancel, mouseend)
    }

    function removeTouch(data) {
        off(document, touchevents.move, data.touchmove), off(document, touchevents.cancel, data.touchend)
    }

    function checkThreshold(e, data, touch, fn) {
        var distX = touch.pageX - data.pageX,
            distY = touch.pageY - data.pageY;
        distX * distX + distY * distY < threshold * threshold || function(e, data, touch, distX, distY, fn) {
            var touches = e.targetTouches,
                ...
                template = {
                    ...
                    enableMove: function() {
                        this.moveEnabled = !0, this.enableMove = noop, e.preventDefault()
                    }
                };
    ...
    function activeMouseend(e, data) {
        var target = data.target,
            event = data.event,
            timer = data.timer;
        off(document, mouseevents.move, activeMousemove), off(document, mouseevents.end, activeMouseend), endEvent(target, event, timer, function() {
            setTimeout(function() {
    ...
    function activeTouchend(e, data) {
        var target = data.target,
            event = data.event,
            timer = data.timer;
        identifiedTouch(e.changedTouches, event.identifier) && (function(data) {
            off(document, touchevents.move, data.activeTouchmove), off(document, touchevents.end, data.activeTouchend)
        }(data), endEvent(target, event, timer))
    }
    ...
    if (on(document, "mousedown", function(e) {
            ! function(e) {
                return 1 === e.which && !e.ctrlKey && !e.altKey
            }(e) || function(e) {
                return !!ignoreTags[e.target.tagName.toLowerCase()]
            }(e) || (on(document, mouseevents.move, mousemove, e), on(document, mouseevents.cancel, mouseend, e))
                ...
                var touch = e.changedTouches[0],
                    data = {
                        ...
                        touchend: function(e, data) {
                            ! function(e, data) {
                                if (!identifiedTouch(e.changedTouches, data.identifier)) return;
                                removeTouch(data)
                            }(e, data)
                        }
                    };
                on(document, touchevents.move, data.touchmove, data), on(document, touchevents.cancel, data.touchend, data)
            }
                    ...
                    data = {
                        ...
                        timer: new Timer(function(time) {
                            (function(event, touch, timeStamp) {
                                ...
                                event.distX = touch.pageX - event.startX, event.distY = touch.pageY - event.startY, event.deltaX = touch.pageX - event.pageX, event.deltaY = touch.pageY - event.pageY, event.velocityX = .3 * event.velocityX + .7 * event.deltaX / time, event.velocityY = .3 * event.velocityY + .7 * event.deltaY / time, event.pageX = touch.pageX, event.pageY = touch.pageY
                            })(event, data.touch, data.timeStamp), trigger(data.target, "move", event)
                        }),
                        touch: void 0,
                        timeStamp: e.timeStamp
                    };
                void 0 === e.identifier ? (on(e.target, "click", preventDefault), on(document, mouseevents.move, activeMousemove, data), on(document, mouseevents.end, activeMouseend, data)) : (data.activeTouchmove = function(e, data) {
                    ! function(e, data) {
                        var event = data.event,
                            timer = data.timer,
                            touch = changedTouch(e, event);
                        touch && (e.preventDefault(), event.targetTouches = e.targetTouches, data.touch = touch, data.timeStamp = e.timeStamp, timer.kick())
                    }(e, data)
                }, data.activeTouchend = function(e, data) {
                    activeTouchend(e, data)
                }, on(document, touchevents.move, data.activeTouchmove, data), on(document, touchevents.end, data.activeTouchend, data))
            }
        }), window.jQuery) {
    ...
    function add(handleObj) {
        ...
        handleObj.handler = function(e) {
            for (var property, i = properties.length; i--;) e[property = properties[i]] = e.originalEvent[property];
...
function(window, $) {
    ...
    function getOrApply(value, context) {
        return isFunction(value) ? value.apply(context, $.makeArray(arguments).slice(2)) : value
    }
    ...
    function Socials(element, config) {
        var $element = $(element);
        $element.data("JSSocials", this), this._$element = $element, this.shares = [], this._init(config), this._render()
    }
    Socials.prototype = {
        url: "",
        text: "",
        ...
        showLabel: function(screenWidth) {
            return !1 === this.showCount ? screenWidth > this.smallScreenWidth : screenWidth >= this.largeScreenWidth
        },
        ...
        _init: function(config) {
            this._initDefaults(), $.extend(this, config), this._initShares(), this._attachWindowResizeCallback()
        },
        _initDefaults: function() {
            this.url = window.location.href, this.text = ($("meta[name=description]").attr("content") || $("title").text()).trim()
        },
        _initShares: function() {
            this.shares = $.map(this.shares, proxy(function(shareConfig) {
                "string" == typeof shareConfig && (shareConfig = {
                    share: shareConfig
                });
        ...
        _windowResizeHandler: function() {
            (isFunction(this.showLabel) || isFunction(this.showCount)) && (window.clearTimeout(this._resizeTimer), this._resizeTimer = setTimeout(proxy(this.refresh, this), this.resizeTimeout))
        },
        _render: function() {
            this._clear(), this._defineOptionsByScreen(), this._$element.addClass(this.elementClass), this._$shares = $("<div>").addClass(this.sharesClass).appendTo(this._$element), this._renderShares()
        },
        _defineOptionsByScreen: function() {
            this._screenWidth = $(window).width(), this._showLabel = getOrApply(this.showLabel, this, this._screenWidth), this._showCount = getOrApply(this.showCount, this, this._screenWidth)
        },
        ...
        _renderShare: function(share) {
            (isFunction(share.renderer) ? $(share.renderer()) : this._createShare(share)).addClass(this.shareClass).addClass(share.share ? "jssocials-share-" + share.share : "").addClass(share.css).appendTo(this._$shares)
        },
        _createShare: function(share) {
            ...
            if (this._showCount) {
                var isInsideCount = "inside" === this._showCount,
                    $countContainer = isInsideCount ? $shareLink : $("<div>").addClass(this.shareCountBoxClass).appendTo($result);
                $countContainer.addClass(isInsideCount ? this.shareLinkCountClass : this.shareCountBoxClass), this._renderShareCount(share, $countContainer)
            }
            return $result
        },
        _createShareLink: function(share) {
            ...
            return $result.addClass(this.shareLinkClass).append(this._createShareLogo(share)), this._showLabel && $result.append(this._createShareLabel(share)), $.each(this.on || {}, function(event, handler) {
        ...
        _createShareLogo: function(share) {
            var logo = share.logo,
                $result = IMG_SRC_REGEX.test(logo) ? $("<img>").attr("src", share.logo) : $("<i>").addClass(logo);
        ...
        _renderShareCount: function(share, $container) {
            ...
            $container.addClass(this.shareZeroCountClass).append($count), this._loadCount(share).done(proxy(function(count) {
                count && ($container.removeClass(this.shareZeroCountClass), $count.text(count))
            }, this))
        },
        _loadCount: function(share) {
            ...
            return $.getJSON(countUrl).done(handleSuccess).fail(function() {
        ...
        _formatNumber: function(number) {
            return $.each(MEASURES, function(letter, value) {
                if (value <= number) return number = parseFloat((number / value).toFixed(2)) + letter, !1
            }), number
        },
        ...
        _passOptionToShares: function(key, value) {
            ...
            $.each(["url", "text"], function(_, optionName) {
                optionName === key && $.each(shares, function(_, share) {
                    share[key] = value
                })
            })
        },
        _normalizeShare: function(share) {
            return $.isNumeric(share) ? this.shares[share] : "string" == typeof share ? $.grep(this.shares, function(s) {
        ...
        destroy: function() {
            this._clear(), this._detachWindowResizeCallback(), this._$element.removeClass(this.elementClass).removeData("JSSocials")
        },
        option: function(key, value) {
            if (1 === arguments.length) return this[key];
            this[key] = value, this._passOptionToShares(key, value), this.refresh()
        },
        shareOption: function(share, key, value) {
            if (share = this._normalizeShare(share), 2 === arguments.length) return share[key];
        ...
        var methodArgs = $.makeArray(arguments).slice(1),
            result = this;
        return this.each(function() {
            var methodResult, $element = $(this),
                instance = $element.data("JSSocials");
            if (instance)
                if ("string" == typeof config) {
                    if (void 0 !== (methodResult = instance[config].apply(instance, methodArgs)) && methodResult !== instance) return result = methodResult, !1
    ...
    var shareStrategies = {
        popup: function(args) {
            return $("<a>").attr("href", "#").on("click", function() {
                return window.open(args.shareUrl, null, "width=600, height=400, location=0, menubar=0, resizeable=0, scrollbars=0, status=0, titlebar=0, toolbar=0"), !1
            })
        },
        blank: function(args) {
            return $("<a>").attr({
    ...
    window.jsSocials = {
        ...
        setDefaults: function(config) {
            var component;
            $.isPlainObject(config) ? component = Socials.prototype : (component = shares[config], config = arguments[1] || {}), $.extend(component, config)
        }
    }
}(window, jQuery),
...
function($) {
    $.fn.twentytwenty = function(options) {
        ...
        return this.each(function() {
            ...
            if (container.wrap("<div class='twentytwenty-wrapper twentytwenty-" + sliderOrientation + "'></div>"), !options.no_overlay) {
            ...
            slider.append("<span class='twentytwenty-" + beforeDirection + "-arrow'></span>"), slider.append("<span class='twentytwenty-" + afterDirection + "-arrow'></span>"), container.addClass("twentytwenty-container"), beforeImg.addClass("twentytwenty-before"), afterImg.addClass("twentytwenty-after");
            ...
            function adjustSlider(pct) {
                ...
                slider.css("vertical" === sliderOrientation ? "top" : "left", "vertical" === sliderOrientation ? offset.ch : offset.cw),
                    function(offset) {
                        "vertical" === sliderOrientation ? (beforeImg.css("clip", "rect(0," + offset.w + "," + offset.ch + ",0)"), afterImg.css("clip", "rect(" + offset.ch + "," + offset.w + "," + offset.h + ",0)")) : (beforeImg.css("clip", "rect(0," + offset.cw + "," + offset.h + ",0)"), afterImg.css("clip", "rect(0," + offset.w + "," + offset.h + "," + offset.cw + ")")), container.css("height", offset.h)
                    }(offset)
            }
            ...
            function getSliderPercentage(positionX, positionY) {
                ...
                }("vertical" === sliderOrientation ? (positionY - offsetY) / imgHeight : (positionX - offsetX) / imgWidth, 0, 1)
            }
            ...
            function onMoveStart(e) {
                (e.distX > e.distY && e.distX < -e.distY || e.distX < e.distY && e.distX > -e.distY) && "vertical" !== sliderOrientation ? e.preventDefault() : (e.distX < e.distY && e.distX < -e.distY || e.distX > e.distY && e.distX > -e.distY) && "vertical" === sliderOrientation && e.preventDefault(), container.addClass("active"), offsetX = container.offset().left, offsetY = container.offset().top, imgWidth = beforeImg.width(), imgHeight = beforeImg.height()
            }

            function onMove(e) {
                container.hasClass("active") && (sliderPct = getSliderPercentage(e.pageX, e.pageY), adjustSlider(sliderPct))
            }
            ...
            moveTarget.on("movestart", onMoveStart), moveTarget.on("move", onMove), moveTarget.on("moveend", onMoveEnd), options.move_slider_on_hover && (container.on("mouseenter", onMoveStart), container.on("mousemove", onMove), container.on("mouseleave", onMoveEnd)), slider.on("touchmove", function(e) {
                e.preventDefault()
            }), container.find("img").on("mousedown", function(event) {
                event.preventDefault()
            }), options.click_to_move && container.on("click", function(e) {
                offsetX = container.offset().left, offsetY = container.offset().top, imgWidth = beforeImg.width(), imgHeight = beforeImg.height(), sliderPct = getSliderPercentage(e.pageX, e.pageY), adjustSlider(sliderPct)
...
function(window) {
    ...
    UAParser.VERSION = "0.7.9", UAParser.BROWSER = {
        NAME: NAME,
        MAJOR: "major",
        VERSION: VERSION
    }, UAParser.CPU = {
...
}("object" == typeof window ? window : this), window.averta = {},
    function($) {
        ...
        Function.prototype.extend = function(superclass) {
            "function" == typeof superclass.prototype.constructor ? extend(this.prototype, superclass.prototype) : this.prototype.extend(superclass), this.prototype.constructor = this
        };
        var trans = {
            Moz: "-moz-",
            Webkit: "-webkit-",
        ...
        function supports3DTransforms() {
            ...
            for (var t in el.style.display = "block", document.body.insertBefore(el, null), transforms) void 0 !== el.style[t] && (el.style[t] = "translate3d(1px,1px,1px)", has3d = window.getComputedStyle(el).getPropertyValue(transforms[t]));
            return document.body.removeChild(el), null != has3d && 0 < has3d.length && "none" !== has3d
        }
        window._mobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), window._touch = "ontouchstart" in document, window.parseQueryString = function(url) {
            var queryString = {};
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function(callback, element) {
                ...
                for ((from = from < 0 ? Math.ceil(from) : Math.floor(from)) < 0 && (from += len); from < len; from++)
                ...
                for (exclude = exclude || [], i = 0; i < dataAttrsLen; i++) "data-" === (attrName = dataAttrs[i].name).substring(0, 5) && -1 === exclude.indexOf(attrName) && dataAttrsToDelete.push(dataAttrs[i].name);
            ...
            function() {
                ...
                }, browser.webkit = "WebKit" === AuxUserAgent.engine.name, browser.firefox = "Firefox" === browser.name, browser.opera = "Opera" === browser.name, browser.chrome = "Chrome" === browser.name, browser.safari = "Safari" === browser.name, browser.msie = "IE" === browser.name, averta.browser = browser, window.AuxBrowser = browser
    ...
    function() {
        ...
        st.add = function(listener, ref) {
            ...
            for (var i = 0, l = list.length; i < l; ++i) list[i] && list[i][0] === listener && list[i][1] === ref && list.splice(i, 1);
        ...
        averta.EventDispatcher = function() {
            ...
            dispatchEvent: function(event) {
                if ((event.target = this).listeners[event.type])
                    for (var i = 0, l = this.listeners[event.type].length; i < l; ++i) this.listeners[event.type][i].listener.call(this.listeners[event.type][i].ref, event)
            }
        }
    }(),
    function(window, document) {
        ...
        averta.TouchSwipe = function(element) {
            ...
            this.element = element, this.enabled = !0, this._bindEvents(element, ev_start, this._touchStart), (element.swipe = this).onSwipe = null, this.swipeType = "horizontal", this.noSwipeSelector = "input, textarea, button, .no-swipe, .ms-no-swipe", this.lastStatus = {}
        };
        ...
        p._bindEvents = function(target, events, cb) {
            ...
            return temp_x = this.lastStatus.distanceX || 0, temp_y = this.lastStatus.distanceY || 0, status_data.distanceX = evt.pageX - this.start_x, status_data.distanceY = evt.pageY - this.start_y, status_data.moveX = status_data.distanceX - temp_x, status_data.moveY = status_data.distanceY - temp_y, status_data.distance = parseInt(Math.sqrt(Math.pow(status_data.distanceX, 2) + Math.pow(status_data.distanceY, 2))), status_data.duration = (new Date).getTime() - this.start_time, status_data.direction = this._getDirection(evt.pageX, evt.pageY), status_data
        }, p._reset = function(event) {
            this.reset = !1, this.lastStatus = {}, this.start_time = (new Date).getTime(), this.start_x = isTouch ? event.touches[0].pageX : event.pageX, this.start_y = isTouch ? event.touches[0].pageY : event.pageY
        }, p._touchStart = function(event) {
            if (this.enabled && !event.target.closest(this.noSwipeSelector, this.$element))
                if (usePointer && (this.element.style.msTouchAction = "horizontal" === this.swipeType ? "pan-y" : "pan-x"), this.onSwipe) {
                    if (!this.touchStarted) {
                        var swipeEvent = isTouch ? event.touches[0] : event;
                        this.start_x = swipeEvent.pageX, this.start_y = swipeEvent.pageY, this.start_time = (new Date).getTime(), this._bindEvents(document, ev_end, this._touchEnd), this._bindEvents(document, ev_move, this._touchMove), this._bindEvents(document, ev_cancel, this._touchCancel);
                        var status = this._createStatusObject(swipeEvent);
                        status.phase = "start", this.onSwipe.call(null, status), isTouch || event.preventDefault(), this.lastStatus = status, this.touchStarted = !0
                    }
                } else console.log("Swipe listener is undefined")
        }, p._touchMove = function(event) {
            if (this.touchStarted) {
                clearTimeout(this.timo), this.timo = setTimeout(function() {
                    this._reset(event)
                }, 60);
                var swipeEvent = isTouch ? event.touches[0] : event,
                    status = this._createStatusObject(swipeEvent);
                this._priventDefultEvent(swipeEvent.pageX, swipeEvent.pageY) && event.preventDefault(), status.phase = "move", this.lastStatus = status, this.onSwipe.call(null, status)
            }
            ...
            if (this.touchStarted) {
                ...
                isTouch || event.preventDefault(), status.phase = "end", this.touchStarted = !1, this.priventEvt = null, this._unbindEvents(document, ev_end, this._touchEnd), this._unbindEvents(document, ev_move, this._touchMove), this._unbindEvents(document, ev_cancel, this._touchCancel), status.speed = status.distance / status.duration, this.onSwipe.call(null, status)
            }
    ...
    function(ElementProto) {
        "function" != typeof ElementProto.matches && (ElementProto.matches = ElementProto.msMatchesSelector || ElementProto.mozMatchesSelector || ElementProto.webkitMatchesSelector || function(selector) {
            for (var elements = (this.document || this.ownerDocument).querySelectorAll(selector), index = 0; elements[index] && elements[index] !== this;) ++index;
    ...
    function() {
        ...
        window.AVTAligner = function(type, $container, $img, options) {
            this.$container = $container, this.$img = $img, this.img = $img[0], this.options = options || {}, this.type = type || "stretch", this.widthOnly = !1, this.heightOnly = !1
        };
        var p = AVTAligner.prototype;
        p.init = function(w, h) {
            switch (w = w || this.img.naturalWidth, h = h || this.img.naturalHeight, this.baseWidth = w, this.baseHeight = h, this.imgRatio = w / h, this.imgRatio2 = h / w, this.type) {
                case "tile":
                    this.$container.css("background-image", "url(" + this.$img.attr("src") + ")"), this.$img.hide();
                    break;
                case "center":
            ...
            this.options.srcset && this.$img.on("load", function(e) {
                var img = e.target,
                    w = img.naturalWidth || this.$img.width(),
                    h = img.naturalHeight || this.$image.height();
                this.baseWidth = w, this.baseHeight = h, this.imgRatio = w / h, this.imgRatio2 = h / w, this.align()
            }.bind(this))
        }, p.align = function() {
            if (this.needAlign) {
                this.cont_w = this.options.containerWidth ? this.options.containerWidth() : this.$container.width(), this.cont_h = this.options.containerHeight ? this.options.containerHeight() : this.$container.height();
                var contRatio = this.cont_w / this.cont_h;
                "fill" == this.type ? this.imgRatio < contRatio ? (this.$img.width(this.cont_w), this.$img.height(this.cont_w * this.imgRatio2)) : (this.$img.height(this.cont_h), this.$img.width(this.cont_h * this.imgRatio)) : "fit" == this.type && (this.imgRatio < contRatio ? (this.$img.height(this.cont_h), this.$img.width(this.cont_h * this.imgRatio)) : (this.$img.width(this.cont_w), this.$img.height(this.cont_w * this.imgRatio2))), this.setMargin()
            }
    ...
    function() {
        "use strict";
        var _cssanim = null;
        window.CTween = {}, CTween.animate = function(element, duration, properties, options) {
            if (null == _cssanim && (_cssanim = window._cssanim), options = options || {}, _cssanim) {
            ...
            var options = {};
            !0 === remove ? options.complete = function() {
                target.remove()
            ...
            !1 !== reset && target.css("opacity", 0).css("display", ""), CTween.animate(target, duration || 1e3, {
                opacity: 1
            })
        }
    }(), window.EaseDic = {
    ...
    function() {
        ...
        function SlickController(min, max, options) {
            ...
            for (var key in this.options = options || {}, _options) key in this.options || (this.options[key] = _options[key]);
        ...
        p.changeTo = function(value, animate, speed, snap_num, dispatch) {
            if (this.stopped = !1, this._internalStop(), value = this._checkLimits(value), speed = Math.abs(speed || 0), this.options.snapping && (snap_num = snap_num || this.getSnapNum(value), !1 !== dispatch && this._callsnapChange(snap_num), this.current_snap = snap_num), animate) {
                this.animating = !0;
                var self = this,
            ...
            if (this.stopped = !1, this.options.snapping && Math.abs(speed) <= this.options.snappingMinSpeed) this.cancel();
            else {
                if (this.__speed = speed, this.__startSpeed = speed, this.end_loc = this._calculateEnd(), this.options.snapping) {
                    var snap_loc = this.getSnapNum(this.value),
                        end_snap = this.getSnapNum(this.end_loc);
                    if (this.options.paging) return snap_loc = this.getSnapNum(this.drag_start_loc), this.__isout = !1, void(0 < speed ? this.gotoSnap(snap_loc + 1, !0, speed) : this.gotoSnap(snap_loc - 1, !0, speed));
            ...
            if (!this.options.endless && (curr_snap + 1) * snapsize > this._max_value) {
                if (this._max_value - this.value > .1 * snapsize) return void this.changeTo(this._max_value, !0);
            ...
            if (!this.options.endless && (curr_snap - 1) * snapsize < this._min_value) {
                if (this.value - this._min_value > .1 * snapsize) return void this.changeTo(this._min_value, !0);
                this.__speed = -8, this.__needsSnap = !1, this._startDecelaration()
            } else this.gotoSnap(curr_snap - 1, !0)
    ...
    function(e) {
        ...
        function c(e, r, a) {
            ...
            function o(e) {
                f += "<" + t(e) + Array.prototype.map.call(e.attributes, function(e) {
            ...
            for (var s = 0, f = "", l = []; e.length || r.length;) {
                ...
                if (f += n(a.substr(s, g[0].offset - s)), s = g[0].offset, g == e) {
                    for (l.reverse().forEach(u); c(g.splice(0, 1)[0]), (g = i()) == e && g.length && g[0].offset == s;);
                    l.reverse().forEach(o)
        ...
        function f(e, t, a, i) {
            ...
            function p(e, n, t, r) {
                var i = '<span class="' + (r ? "" : E.classPrefix);
                return (i += e + '">') + n + (t ? "" : "</span>")
            }

            function b() {
                L += void 0 !== k.sL ? function() {
                    var e = "string" == typeof k.sL;
                    if (e && !R[k.sL]) return n(M);
                    var t = e ? f(k.sL, M, !0, y[k.sL]) : l(M, k.sL.length ? k.sL : void 0);
                    return 0 < k.r && (B += t.r), e && (y[k.sL] = t.top), p(t.language, t.value, !1, !0)
                }() : function() {
                    if (!k.k) return n(M);
                    var e = "",
                        t = 0;
            ...
            function m(e, n) {
                ...
                var t = o(n, k);
                if (t) return t.skip ? M += n : (t.eB && (M += n), b(), t.rB || t.eB || (M = n)), v(t), t.rB ? 0 : n.length;
                var r = u(k, n);
                if (r) {
                    var a = k;
                    for (a.skip ? M += n : (a.rE || a.eE || (M += n), b(), a.eE && (M = n)); k.cN && (L += "</span>"), k.skip || (B += k.r), (k = k.parent) != r.parent;);
            ...
            var M = "",
                B = 0;
            try {
                for (var C, j, I = 0; k.t.lastIndex = I, C = k.t.exec(t);) j = m(t.substr(I, C.index - I), C[0]), I = C.index + j;
        ...
        function h(e) {
            ...
            if (!a(n)) {
                var t;
                E.useBR ? (t = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : t = e;
                var r = t.textContent,
                    o = n ? f(n, r, !0) : l(r),
                    s = u(t);
                if (s.length) {
                ...
                o.value = g(o.value), e.innerHTML = o.value, e.className = function(e, n, t) {
                    var r = n ? x[n] : t,
                        a = [e.trim()];
        ...
        var E = {
            ...
            R = {},
            x = {};
        return e.highlight = f, e.highlightAuto = l, e.fixMarkup = g, e.highlightBlock = h, e.configure = function(e) {
            E = o(E, e)
        ...
        }, e.getLanguage = w, e.inherit = o, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*", e.NR = "\\b\\d+(\\.\\d+)?", e.CNR = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", e.BNR = "\\b(0b[01]+)", e.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", e.BE = {
            b: "\\\\[\\s\\S]",
            r: 0
        }, e.ASM = {
            cN: "string",
    ...
    function($, window, document) {
        ...
        var $pswp = $('<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"><div class="pswp__bg"></div><div class="pswp__scroll-wrap"><div class="pswp__container"><div class="pswp__item"></div><div class="pswp__item"></div><div class="pswp__item"></div></div><div class="pswp__ui pswp__ui--hidden"><div class="pswp__top-bar"><div class="pswp__counter"></div><button class="pswp__button pswp__button--close" title="' + (photoswipe_l10n.close || "Close (Esc)") + '"></button><button class="pswp__button pswp__button--share" title="' + (photoswipe_l10n.share || "Share") + '"></button><button class="pswp__button pswp__button--fs" title="' + (photoswipe_l10n.fullscreen || "Toggle fullscreen") + '"></button><button class="pswp__button pswp__button--zoom" title="' + (photoswipe_l10n.zoom || "Zoom in/out") + '"></button><div class="pswp__preloader"><div class="pswp__preloader__icn"><div class="pswp__preloader__cut"><div class="pswp__preloader__donut"></div></div></div></div></div><div class="pswp__share-modal pswp__share-modal--hidden pswp__single-tap"><div class="pswp__share-tooltip"></div> </div><button class="pswp__button pswp__button--arrow--left" title="' + (photoswipe_l10n.previous || "Previous (arrow left)") + '"></button><button class="pswp__button pswp__button--arrow--right" title="' + (photoswipe_l10n.next || "Next (arrow right)") + '"></button><div class="pswp__caption"><div class="pswp__caption__center"></div></div></div></div></div>').appendTo("body"),
            youtubeRegex = /(?:https?:)?(?:\/\/)?(?:[0-9A-Z-]+\.)?(?:youtu\.be\/|youtube(?:-nocookie)?\.com\S*?[^\w\s-])([\w-]{11})(?=[^\w-]|$)(?![?=&+%\w.-]*(?:['"][^<>]*>|<\/a>))[?=&+%\w.-]*/,
        ...
        function JQPhotoSwipe(element, options) {
            this.settings = $.extend({}, defaults, options), this._defaults = defaults, this.slides = [], this.UID = _uid++, this.element = element, this.$element = $(element), this.init()
        }
        $.extend(JQPhotoSwipe.prototype, {
            init: function() {
                ...
                if (hashData.pid && hashData.gid) {
                    ...
                    this.settings.showAnimationDuration = 0, this._openPhotoSwipe(hashData.pid, !0), this.settings.showAnimationDuration = animDuration
                }
            },
            getSlides: function() {
                return this.slides
            ...
            _registerSlide: function(index, item) {
                ...
                if (this.settings.titleMap ? slide.title = this.settings.titleMap($item, index, this) : slide.title = $item.data("caption") || $item.attr("title") || $item.attr("alt"), this.settings.thumbnailMap) {
                    var thumb = this.settings.thumbnailMap($item, index, this);
                    slide.el = thumb.element, slide.msrc = thumb.src
                } else if ($item.is("img")) slide.el = item, slide.msrc = $item.attr("src");
                else {
                    var img = $item.find("img");
                    img.length && (slide.el = img[0], slide.msrc = img.attr("src"))
                }
                $item.data("index", index), $item.on("click.photoswipe", this._onItemClick.bind(this)), this.slides.push(slide)
            },
            _getVideoURLType: function(url) {
                return url.match(youtubeRegex) ? "youtube" : url.match(vimeoRegex) ? "vimeo" : !!url.match(embedURLRegex) && "embed"
            },
            _getVideoHtml: function(url, type) {
                var videoEmbedLink = url;
                "youtube" === type && (videoEmbedLink = "//www.youtube.com/embed/" + url.match(youtubeRegex)[1]);
                "vimeo" === type && (videoEmbedLink = "//player.vimeo.com/video/" + url.match(vimeoRegex)[4]);
                return '<div class="video-wrapper"><iframe class="pswp__video" src="' + videoEmbedLink + '" width="960" height="640" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>'
            },
            _onItemClick: function(e) {
                e.preventDefault(), this._openPhotoSwipe($(e.currentTarget).data("index"))
            },
            ...
            _openPhotoSwipe: function(index, fromURL) {
                var gallery, options = this.settings;
                $.extend(options, {
                    galleryUID: this.UID,
                    getThumbBoundsFn: this._thumbnailBounds.bind(this)
                }), options.index = fromURL ? parseInt(index, 10) - 1 : parseInt(index, 10), isNaN(options.index) || ((gallery = new PhotoSwipe($pswp[0], options.ui, this.slides, options)).init(), this._photoswipeListen(gallery))
            },
            _photoswipeListen: function(gallery) {
                gallery.listen("beforeChange", function() {
                    var $allItems = $(this.container).find(".pswp__video");
                    $allItems.removeClass("active"), $(this.currItem.container).find(".pswp__video").addClass("active"), $allItems.each(function() {
                        $(this).hasClass("active") || $(this).attr("src", $(this).attr("src"))
                    })
                }), gallery.listen("close", function() {
                    $(this.currItem.container).find(".pswp__video").each(function() {
            ...
            return void 0 === options || "object" == typeof options ? this.each(function() {
                $.data(this, plugin) || $.data(this, plugin, new JQPhotoSwipe(this, options))
            }) : "string" == typeof options && "_" !== options[0] && "init" !== options ? (this.each(function() {
                var instance = $.data(this, plugin);
                instance instanceof JQPhotoSwipe && "function" == typeof instance[options] && (returns = instance[options].apply(instance, Array.prototype.slice.call(args, 1))), "destroy" === options && $.data(this, plugin, null)
    ...
    function($, window) {
        ...
        $.extend(Plugin.prototype, {
            init: function() {
                ...
                if (this.dynamicElements = dynamicElements, this.settings.autoLocate && dynamicElements.length)
                    for (var i = 0, l = dynamicElements.length; i !== l; i++) {
                        var element = $(dynamicElements[i]);
                        dynamicElements[i] = element.data("placeholder", $('<span style="display:none;"></span>')).data("layout", "default")
                    }
            ...
            destroy: function() {
                if ($window.off("resize", this._onResize).off("scroll", this._onScroll), this.dynamicElements) {
                    for (var i = 0, l = this.dynamicElements.length; i !== l; i++) {
                        var dynamicElement = this.dynamicElements[i];
                        dynamicElement.data("placeholder").remove(), dynamicElement.data("placeholder", null)
                    }
            ...
            _onResize: function() {
                var width = window.innerWidth,
                    layout = "default",
                    lastPoint = null;
                for (var point in this.settings.breakpoints) width < point && (null === lastPoint || point < lastPoint) && (layout = this.settings.breakpoints[point], lastPoint = point);
                if (layout !== this.lastLayout && (this.$element.removeClass(this.settings.desktopClassName).removeClass(this.settings.phoneClassName).removeClass(this.settings.tabletClassName), "default" === layout ? this.$element.addClass(this.settings.desktopClassName) : this.$element.addClass(this.settings[layout + "ClassName"]), this.settings.checkMiddle && this.$element.find('[class*="-middle"]').each(function(index, element) {
                        $(element).height() % 2 != 0 && (element.style.paddingBottom = "1px")
                    }.bind(this)), this.lastLayout = layout, this.settings.autoLocate))
                    for (var i = 0, l = this.dynamicElements.length; i !== l; i++) this._checkElement(this.dynamicElements[i], layout)
            },
            _checkElement: function($dynamicElement, layout) {
                if ($dynamicElement.data("layout") !== layout) {
                    if ("phone" === layout || "tablet" === layout) {
                        "default" === $dynamicElement.data("layout") && $dynamicElement.after($dynamicElement.data("placeholder"));
                        var target = $dynamicElement.data(layout);
                        void 0 === target ? (target = $dynamicElement.data("locate"), $(target).eq(0)[$dynamicElement.data("locate-method") || "append"]($dynamicElement)) : $(target).eq(0)[$dynamicElement.data(layout + "-method") || "append"]($dynamicElement)
                    } else $dynamicElement.data("placeholder").after($dynamicElement).detach();
    ...
    function($, window) {
        ...
        function Plugin(element, options) {
            for (var attrName in this.element = element, this.$element = $(element), this.settings = $.extend({}, defaults, options), this._defaults = defaults, this._name = pluginName, this._scheme = this.$element.data("color-scheme") || !1, this._stickyScheme = this.$element.data("sticky-scheme") || !1, this._stickyDisableFlag = !1, attributesMap) {
        ...
        $.extend(Plugin.prototype, {
            init: function() {
                this.containerHeight = this.$element.outerHeight(), this.$containerPlaceHolder = $("<div></div>").addClass(this.settings.placeholder), this.$element.before(this.$containerPlaceHolder), this._wpadminbarHeight = $("#wpadminbar").outerHeight() || 0, this.isOverlay = "absolute" === window.getComputedStyle(this.element).position, $window.on("scroll resize", this._update.bind(this)), this._update()
            },
            _disable: function() {
                this.settings.useTransform ? this.element.style[_jcsspfx + "Transform"] = "" : this.element.style.top = "", this._stickyDisableFlag = !0, this.$containerPlaceHolder.css("display", "none"), this.$element.trigger("unsticky")
            },
            _update: function() {
                ...
                else if (this._stickyDisableFlag && this.$containerPlaceHolder.css("display", "initial"), etp < wst && !this.stickyEnabled ? (this.$element.addClass(this.settings.className), this.stickyEnabled = !0, this._scheme !== this._stickyScheme && (this._scheme && this.$element.removeClass(this.settings.schemePrefix + this._scheme), this._stickyScheme && this.$element.addClass(this.settings.schemePrefix + this._stickyScheme)), this.settings.useTransform || this.isOverlay || this.$containerPlaceHolder.height(this.containerHeight), this.settings.rearrange && this._checkForRearrange(!0), this.useTransform || !this.settings.stickyMargin && 0 !== this.settings.stickyMargin || (this.element.style.top = this.settings.stickyMargin + this._wpadminbarHeight + "px"), this.$element.trigger("sticky")) : this.stickyEnabled && wst <= etp && (this.stickyEnabled = !1, this.$containerPlaceHolder.height(0), this.$element.removeClass(this.settings.className), this._scheme !== this._stickyScheme && (this._scheme && this.$element.addClass(this.settings.schemePrefix + this._scheme), this._stickyScheme && this.$element.removeClass(this.settings.schemePrefix + this._stickyScheme)), this.settings.rearrange && this._checkForRearrange(!1), this.useTransform || !this.settings.stickyMargin && 0 !== this.settings.stickyMargin || (this.element.style.top = ""), this.$element.trigger("unsticky")), this.settings.useTransform)
                    if (this.stickyEnabled) {
                        var calc = wst - etp;
                        this.settings.checkBoundaries ? this._checkElementBoundaries(etp, wst, calc) : this.element.style[_jcsspfx + "Transform"] = "translateY(" + calc + "px)"
                    } else this.element.style[_jcsspfx + "Transform"] = "";
                else this.settings.checkBoundaries && this._checkElementBoundaries(etp, wst)
            },
            _checkElementBoundaries: function(etp, wst, calc) {
                etp = etp || this.$containerPlaceHolder.offset().top, wst = wst || $window.scrollTop(), calc = calc || 0, this.$boundryTarget = this.settings.boundryTarget.length ? $(this.settings.boundryTarget) : this.$element.parent().eq(0);
                var diff = this.$boundryTarget.offset().top - this._wpadminbarHeight + this.$boundryTarget.outerHeight(!0) - (etp + this.$element.outerHeight(!0));
                this.element.style[_jcsspfx + "Transform"] = 0 <= calc && calc <= diff ? "translateY(" + calc + "px)" : diff < calc ? "translateY(" + diff + "px)" : ""
            },
            _checkForRearrange: function(attach) {
                var self = this;
                attach ? this.$element.find("[data-sticky-move]").each(function() {
                    var $this = $(this),
                        $target = self.$element.find($this.data("sticky-move"));
                    0 != $target.length && ($this.data("placeholder") || $this.data("placeholder", $('<span style="display:none"></span>')), $this.after($this.data("placeholder")), $target[$this.data("sticky-move-method") || "append"]($this))
                }) : this.$element.find("[data-sticky-move]").each(function() {
                    var $this = $(this);
                    $this.data("placeholder") && $this.data("placeholder").after($this).detach()
                })
            }
        }), $.fn[pluginName] = function(options) {
            return this.each(function() {
    ...
    function($) {
        ...
        function Plugin(element, options) {
            this.element = element, this.$element = $(element), this.settings = $.extend({}, defaults, options), this._name = "AuxinCubeHover", this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                if (this.settings.hitArea) {
                    var target = this.$element.parents(this.settings.hitArea).eq(0);
                    target.on("mouseenter", this._movein.bind(this)), target.on("mouseleave", this._moveout.bind(this))
                } else this.$element.on("mouseenter", this._movein.bind(this)), this.$element.on("mouseleave", this._moveout.bind(this));
                this._fixOrigin()
            },
            _fixOrigin: function() {
                var shift = -this.$element.outerHeight() / 2,
                    dir = -1,
                    axis = "X";
                this.$element.hasClass("aux-rotate-down") ? dir = 1 : this.$element.hasClass("aux-rotate-left") ? (shift = -this.$element.outerWidth() / 2, axis = "Y", dir = 1) : this.$element.hasClass("aux-rotate-right") && (shift = -this.$element.outerWidth() / 2, axis = "Y"), this._outTransform = "perspective(1000px) translateZ(" + shift + "px)", this._inTransform = this._outTransform + " rotate" + axis + "( " + 90 * dir + "deg )", this.element.style[_jcsspfx + "TransitionDuration"] = "0ms", this.element.style[_jcsspfx + "Transform"] = this._outTransform, this.element.style[_jcsspfx + "TransformOrigin"] = "center center " + shift + "px", setTimeout(function() {
                    this.element.style[_jcsspfx + "TransitionDuration"] = ""
                }.bind(this), 5)
            },
            _movein: function() {
                this._fixOrigin(), clearTimeout(this._hoverdelay), this._hoverdelay = setTimeout(function() {
                    this.element.style[_jcsspfx + "Transform"] = this._inTransform
                }.bind(this), 10)
            },
            _moveout: function() {
                clearTimeout(this._hoverdelay), this.element.style[_jcsspfx + "Transform"] = this._outTransform
            },
            destroy: function() {}
        }), $.fn.AuxinCubeHover = function(options) {
            return this.each(function() {
                $.data(this, "plugin_AuxinCubeHover") || $.data(this, "plugin_AuxinCubeHover", new Plugin(this, options))
            })
        }
    }(jQuery, window, document),
    function($) {
        "use strict";
        var defaults = { in: "aux-hover-in",
            out: "aux-hover-out",
            reset: "aux-hover-reset"
        };

        function Plugin(element, options) {
            this.element = element, this.settings = $.extend({}, defaults, options), this._defaults = defaults, this._name = "AuxTwoWayHover", this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                var $element = $(this.element),
                ...
                $element.on("mouseenter", function() {
                    $element.removeClass(st.out).addClass(st.reset), clearTimeout(this._hoverTimeout), this._hoverTimeout = setTimeout(function() {
                        $element.addClass(st.in).removeClass(st.reset)
                    }, 30)
                }.bind(this)).on("mouseleave", function(event) {
                    clearTimeout(this._hoverTimeout), $element.addClass(st.out), $element.removeClass(st.in)
                }.bind(this))
            }
        }), $.fn.AuxTwoWayHover = function(options) {
            return this.each(function() {
                $.data(this, "plugin_AuxTwoWayHover") || $.data(this, "plugin_AuxTwoWayHover", new Plugin(this, options))
            })
        }
    }(jQuery, window, document),
    function($, window) {
        ...
        $.extend(Plugin.prototype, {
            init: function() {
                ...
                }.bind(this)), this._isotope.arrange(), this._currentPage = this._isotope.options.page, this._isotope.items.forEach(function(item) {
                    item.$element || (item.$element = $(item.element))
                }, this), this.settings.lazyload && (this.$loading = this.$element.find(this.settings.itemsLoading).addClass(this.settings.loadingHide).appendTo(this.$element), this._instantlyHideItems(), this._revealItems()), this.settings.updateUponResize && $(window).on("resize", this._arrangeIsotope.bind(this)), this.ـinitFilters()
            },
            arrange: function(method, options) {
                ...
                if (this._currentFilter !== this._filterValue || this.settings.grouping && this._currentGroup !== this._groupValue || this.settings.searchFilter && this._currentSearch !== this._searchValue || this.settings.pagination && this._currentPage !== io.page) {
                    this._currentPage = io.page, this._currentFilter = this._filterValue, this._currentSearch = this._searchValue, this._currentGroup = this._groupValue;
                    ...
                    }), totalHideDuration = st.hideBetweenDelay * i + st.hideTransitionDelay + st.hideTransitionDuration, clearTimeout(this._hidingTimeout), clearTimeout(this._revealingTimeout), this._hidingTimeout = setTimeout(function() {
                        self._instantlyHideItems(), method && "arrange" !== method ? self._isotope[method].apply(self._isotope, options) : self._isotope._noTransition(self._isotope.arrange), self._revealItems()
                    }, totalHideDuration), st.deeplink && self._updateHash(), this.$element.trigger("auxinIsotopeArrange")
                }
            },
            insert: function($item) {
                0 <= this.settings.space && $item.css({
                    "margin-bottom": this.settings.space + "px",
                    "padding-right": this.settings.space + "px"
                }), this._isotope.insert($item), this._isotope.items.forEach(function(item) {
                    item.$element || (item.$element = $(item.element))
                }, this)
            },
            remove: function(items) {
                Array.isArray(items) || (items = [items]), this._isotope.remove(items.map(function(item) {
                    return item.element
                })), this._isotope.arrange()
            },
            removeAll: function() {
                this._isotope.remove(this._isotope.items.map(function(item) {
                    return item.element
                })), this.updateIsotope(), this._isotope.options.page = 1
            },
            updateIsotope: function() {
                this._arrangeIsotope()
            },
            destroy: function() {
                this.settings.pagination && this.$pagination.remove(), this.settings.updateUponResize && $(window).off("resize", this._arrangeIsotope.bind(this)), this.$element.data("isotope", null), this._isotope.destroy(), this.$element.remove()
            },
            changeGroup: function(groupName) {
                this._oldGroup = this._groupValue, this._groupValue = groupName, localStorage.setItem("auxinIsotopeGroup", this._groupValue), this.$filters.find(this.settings.groupingPrefix + this._groupValue).removeClass(this.settings.transitionHelpers.hidden), this.$filters.find(this.settings.groupingPrefix + this._oldGroup).addClass(this.settings.transitionHelpers.hidden), this._internalFilterChange ? this._internalFilterChange = !1 : this.arrange("arrange")
            },
            showLoading: function() {
                this._loadingIsVisible || (this.$element.height(this.settings.loadingHeight), this._loadingIsVisible = !0, clearTimeout(this._loadingTimeout), this.$loading.show(), setTimeout(function() {
                    this.$loading.addClass(this.settings.loadingVisible).removeClass(this.settings.loadingHide)
                }.bind(this), 1))
            },
            hideLoading: function() {
                this._loadingIsVisible && (this._loadingIsVisible = !1, this.$loading.removeClass(this.settings.loadingVisible).addClass(this.settings.loadingHide), clearTimeout(this._loadingTimeout), this._loadingTimeout = setTimeout(function() {
                    this.$loading.hide()
                }.bind(this), this.settings.loadingTransitionDuration))
            },
            _instantlyHideItems: function() {
                this._isotope.items.forEach(function(item) {
                    item.element.style[window._jcsspfx + "TransitionDelay"] = "0", item.element.style[window._jcsspfx + "TransitionDuration"] = "0", this._removeHelpers(item.$element), item.$element.addClass(this.settings.transitionHelpers.hidden)
                }, this)
            },
            _isFilteredItemsLoaded: function() {
                for (var items = this._isotope.filteredItems, i = 0, l = items.length; i !== l; i++)
            ...
            _revealItems: function() {
                var items = this._isotope.filteredItems,
                    st = this.settings,
                    i = 0;
                !st.lazyload || this._isFilteredItemsLoaded() ? (st.lazyload && (this.hideLoading(), this._isotope._noTransition(this._isotope.layout), this._waitForLoad = !1), this._revealingTimeout = setTimeout(function() {
                    items.forEach(function(item) {
                        this._removeHelpers(item.$element), item.$element.addClass(st.transitionHelpers.hidden), this._revealItem(item, st.revealBetweenDelay * ++i, st.revealTransitionDuration)
                    }, this)
                }.bind(this), Math.max(st.revealTransitionDelay, 10)), this.$element.trigger("auxinIsotopeReveal", [items])) : (this.showLoading(), this._waitForLoad = !0)
            },
            _revealItem: function(item, delay, duration) {
                item.element.style[window._jcsspfx + "TransitionDelay"] = delay + "ms", item.element.style[window._jcsspfx + "TransitionDuration"] = duration + "ms", this._removeHelpers(item.$element), item.$element.addClass(this.settings.transitionHelpers.revealing), clearTimeout(item._animTimeout), item._animTimeout = setTimeout(function() {
                    this._removeHelpers(item.$element), item.element.style[window._jcsspfx + "TransitionDelay"] = "", item.element.style[window._jcsspfx + "TransitionDuration"] = "", item.$element.addClass(this.settings.transitionHelpers.visible)
                }.bind(this), delay + duration)
            },
            _hideItem: function(item, delay, duration) {
                item.element.style[window._jcsspfx + "TransitionDelay"] = delay + "ms", item.element.style[window._jcsspfx + "TransitionDuration"] = duration + "ms", this._removeHelpers(item.$element), item.$element.addClass(this.settings.transitionHelpers.hiding), clearTimeout(item._animTimeout), item._animTimeout = setTimeout(function() {
                    this._removeHelpers(item.$element), item.element.style[window._jcsspfx + "TransitionDelay"] = "", item.element.style[window._jcsspfx + "TransitionDuration"] = "", item.$element.addClass(this.settings.transitionHelpers.hidden)
                }.bind(this), delay + duration)
            },
            ...
            _setLazyload: function(item, imagesloaded) {
                ...
                imagesloaded.on("always", function(e) {
                    item.loaded = !0, item.element.style.height = "", item.element.style.width = "", setTimeout(function() {
                        this.elements.forEach(function(element) {
                            $(element).removeClass(this.settings.loadingClass)
                        }, that), that._revealItems()
                    }.bind(this))
                })
            },
            _filtering: function(itemElement) {
                var $item = $(itemElement);
                return !(this._filterValue && "all" !== this._filterValue && !$item.is(this._filterValue)) && (!(this._searchValue && !$item.text().match(this._searchValue) && !itemElement.className.match(this._searchValue)) && !(this._groupValue && !$item.is(this.settings.groupingPrefix + this._groupValue)))
            },
            "ـinitFilters": function() {
                if (this.settings.filters) {
                    if (this.$filters = this.$element.siblings(this.settings.filters).eq(0), !this.$filters) return;
                    var self = this;
                    this.$filters.find("li").on("click", function(e) {
                        var filter = $(this).data("filter");
                        filter.length ? self._filterValue = "all" !== filter && "." + filter : self._filterValue = !1, !self._internalFilterChange && e.originalEvent ? self.arrange("arrange") : self._internalFilterChange = !1, e.preventDefault()
                    }), this.$filters.find(self.settings.searchClass).on("keyup", this._debounce(function(e) {
                        var filter = $(this).val();
                        2 < filter.length ? self._searchValue = new RegExp(filter, "gi") : self._searchValue = !1, !self._internalFilterChange && e.originalEvent ? self.arrange("arrange") : self._internalFilterChange = !1
                    }, 200)), setTimeout(this._updateSelectedFilter.bind(this), 300)
                }
            },
            _setGroupValue: function() {
                this._localGroupValue = localStorage.getItem("auxinIsotopeGroup"), this._groupValue = this._localGroupValue ? this._localGroupValue : this.settings.grouping
            },
            _updateSelectedFilter: function() {
                this._internalFilterChange = !0, this.$filters.find('[data-filter="' + (this._filterValue || "all").replace(".", "") + '"] a').trigger("click")
            },
            ...
            _initPagination: function() {
                this.$pagination = $("<nav></nav>").addClass(this.settings.paginationClass), this.settings.paginationLoc ? this.$pagination.appendTo(this.settings.paginationLoc) : this.$pagination.insertAfter(this.$element), this.$pagination.on("click", this._updatePage.bind(this)), this._isotope.on("paginationUpdate", this._updatePagination.bind(this))
            },
            _updatePagination: function(currentPage, totalPage, items) {
                if (this._internalPaginate) this._internalPaginate = !1;
                    ...
                    html += "</ul>", this.$pagination.html(html)
                }
            },
            _updatePage: function(event) {
                var page, $btn = $(event.target);
                if (void 0 !== $btn.data("page")) page = $btn.data("page");
                else if ($btn.data("next")) page = Math.min(this._isotope.currentPage() + 1, this._isotope.totalPages());
                else {
                    if (!$btn.data("prev")) return;
                    page = Math.max(this._isotope.currentPage() - 1, 1)
                }
                this._isotope.options.page = page, this.$pagination.find(".page").removeClass("active").eq(page - 1).addClass("active"), this._internalPaginate = !0, this.arrange("arrange"), event.preventDefault()
            },
            _initDeeplink: function() {
                this._readHash(!1), $(window).on("hashchange", this._readHash.bind(this))
            },
            _findHashData: function() {
                for (var result, hash = window.location.hash.slice(1).split(","), i = 0, l = hash.length; i !== l; i++)
                    if (-1 !== (result = hash[i].split("/")).indexOf(this.settings.slug)) return result;
                return !1
            },
                ...
                if (this._internalHashUpdate) this._internalHashUpdate = !1;
                    ...
                    if (result) {
                        var io = this._isotope.options,
                            ...
                            oldPage = io.page;
                        this._filterValue = this._parseFilter(result[2]), this.settings.pagination && (io.page = this._checkPagePolicy(parseInt(result[3]))), arrange && (this._filterValue !== oldFilter || this.settings.pagination && io.page !== oldPage) && (this.$filters && this._updateSelectedFilter(), this._internalHashRead = !0, this.arrange("arrange"))
                    }
                }
            },
            _updateHash: function() {
                if (this._internalHashRead) this._internalHashRead = !1;
                    ...
                    this.settings.pagination && (hashStr += "/" + this._isotope.options.page);
                    var inHash = this._findHashData();
                    if (this._internalHashUpdate = !0, inHash) {
                        for (var hash = currentHash.split(","), i = 0, l = hash.length; i !== l; i++)
                            if (-1 !== hash[i].split("/").indexOf(this.settings.slug)) {
                                hash[i] = hashStr;
                                break
                            }
                        window.location.hash = hash.join(",")
                    } else currentHash.length ? window.location.hash = currentHash + "," + hashStr : window.location.hash = hashStr
                }
            },
            _checkPagePolicy: function(page) {
                if (this._isotope.options.pagination) return page <= 0 ? 1 : page > this._isotope.totalPages() ? this._isotope.totalPages() : isNaN(page) ? 1 : page
            },
            _sanitizeFilter: function(filter) {
                return filter ? filter.replace(/\s/g, "&").replace(".", "") : "all"
            },
            _parseFilter: function(filter) {
                if ("all" !== filter && void 0 !== filter) return "." + filter.replace("&", " .").trim()
            }
        }), $.fn.AuxIsotope = function(options) {
            var returns, args = arguments,
                plugin = "plugin_AuxIsotope";
            return void 0 === options || "object" == typeof options ? this.each(function() {
                $.data(this, plugin) || $.data(this, plugin, new Plugin(this, options))
            }) : "string" == typeof options && "_" !== options[0] && "init" !== options ? (this.each(function() {
                var instance = $.data(this, plugin);
                instance instanceof Plugin && "function" == typeof instance[options] && (returns = instance[options].apply(instance, Array.prototype.slice.call(args, 1))), "destroy" === options && $.data(this, plugin, null)
            }), void 0 !== returns ? returns : this) : void 0
        }
    }(jQuery, window, document),
    function($, window) {
        ...
        function Plugin(element, options) {
            for (var attrName in this.element = element, this.$element = $(element), this.settings = $.extend({}, defaults, options), this._defaults = defaults, this._name = "AuxLoadMore", this._isotopeLayout = this.$element.find(".aux-isotope-ready").length, this.ajaxView = this.$element.find(".aux-ajax-view"), attributesMap) {
                var value = this.ajaxView.data(attrName);
                void 0 !== value && (this.settings[attributesMap[attrName]] = value)
            }
            this.content = auxin.content.loadmore[this.settings.elementID], this.args = this.content.args, this.nonce = this.content.nonce, this.handler = this.content.handler, this.postPerPage = parseInt(this.args.loadmore_per_page), this.offset = parseInt(this.args.offset) || 0, this.defaultOffset = this.offset, this.ajaxController = this.$element.find(".aux-ajax-controller"), this.loadNextPrev = this.ajaxController.find(".aux-load-next-prev"), this.loadMoreBtn = this.ajaxController.find(".aux-load-more"), this.ajaxLoaded = !0, this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                this.$element.is(".aux-ajax-type-next-prev") ? this.loadNextPrev.on("click", this._loadNextPrev.bind(this)) : this.$element.is(".aux-ajax-type-scroll") ? $window.scroll(this._loadScroll.bind(this)) : this.$element.is(".aux-ajax-type-next") && this.loadMoreBtn.on("click", this._loadNext.bind(this))
            },
            _callAjax: function(type, offset) {
                this.args.offset = offset, this.ajaxLoaded = !1, $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: auxin.ajax_url,
                    data: {
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            switch (type) {
                                case "next-prev":
                                    this._isotopeLayout ? this.ajaxView.AuxIsotope("removeAll") : $(this.ajaxView).empty(), offset === this.defaultOffset ? this.ajaxController.find(".np-prev-section").addClass("hidden") : this.ajaxController.find(".np-prev-section").removeClass("hidden");
                                    break;
                                default:
                            ...
                            postCounter = $newContent.filter(".aux-post-count").text(), allpostCounter = $newContent.filter(".aux-all-posts-count").text(), $newContent = $newContent.filter(".aux-ajax-item, .aux-date-label, style"), this._isotopeLayout ? $newContent.each(function(index, element) {
                                var $item = $(element);
                                $item.is("style") ? this.ajaxView.append($item) : (this.ajaxView.AuxIsotope("insert", $item), $item.imagesLoaded({}, function() {
                                    this.ajaxView.AuxIsotope("arrange").AuxIsotope("updateIsotope")
                                }.bind(this)), this._afterAppend($item))
                            }.bind(this)) : $newContent.each(function(index, element) {
                                var $item = $(element);
                                this.ajaxView.append($item), $item.is("style") || this._afterAppend($item)
                            }.bind(this)), this.ajaxController.find(".np-next-section").removeClass("hidden")
                        }
                        if (postCounter < this.postPerPage || !response.success || parseInt(offset) + parseInt(postCounter) == parseInt(allpostCounter)) switch (type) {
                            case "next-prev":
                        ...
                        $newContent && this.ajaxView.hasClass("aux-match-height") && ($.fn.matchHeight._maintainScroll = !0, $newContent.imagesLoaded({}, function() {
                            this.ajaxView.find(".aux-col").matchHeight(), setTimeout($.fn.matchHeight._update, 100)
                        }.bind(this))), this.ajaxLoaded = !0
                    }.bind(this)
                })
            },
            _afterAppend: function($content) {
                $content.setOnAppear(!0, 100).addClass("aux-ajax-anim"), $content.hasClass("aux-image-box") && $content.AuxinImagebox(), $content.AuxinCarouselInit(), $content.find(".aux-frame-cube").AuxinCubeHover(), $content.find(".aux-hover-twoway").AuxTwoWayHover(), $content.find(".aux-media-video, .aux-media-audio").length && ($content.find("iframe").length ? $content.fitVids({
                    customSelector: 'iframe[src^="http://w.soundcloud.com"], iframe[src^="https://w.soundcloud.com"]'
                }) : $content.find("video,audio").mediaelementplayer()), $content.find(".aux-lightbox-frame").photoSwipe({
            ...
            _loadNext: function() {
                this.ajaxLoaded && (this.offset += this.postPerPage, this.loadMoreBtn.addClass("aux-active-loading"), this.$element.addClass("aux-in-progress"), this._callAjax("next", this.offset))
            },
            _loadScroll: function(event) {
                this.ajaxLoaded && (this.ajaxController[0].getBoundingClientRect().bottom <= $window.height() && (this.offset += this.postPerPage, this.$element.addClass("aux-in-progress"), this.loadMoreBtn.addClass("aux-active-loading"), this._callAjax("scroll", this.offset)), event.preventDefault())
            },
            _loadNextPrev: function(event) {
                this.ajaxLoaded && ($(event.currentTarget).hasClass("np-next-section") ? this.offset += this.postPerPage : this.offset = this.offset <= this.defaultOffset ? this.defaultOffset : this.offset - this.postPerPage, this.$element.addClass("aux-in-progress"), this._callAjax("next-prev", this.offset), event.preventDefault())
            }
        }), $.fn.AuxLoadMore = function(options) {
            return this.each(function() {
                $.data(this, "plugin_AuxLoadMore") || $.data(this, "plugin_AuxLoadMore", new Plugin(this, options))
            })
        }
    }(jQuery, window, document),
    function($, window) {
        ...
        function Plugin(element, options) {
            window.AuxinCarousel || (window.AuxinCarousel = {}), this.element = element, this.settings = $.extend({}, defaults, options), this.$element = $(element), this._defaults = defaults, this._name = "AuxinCarousel", this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                if (window.MasterCarousel) {
                    for (var attrName in attributeOptionsMap) {
                        var value = this.$element.data(attrName);
                        void 0 !== value && (this.settings[attributeOptionsMap[attrName]] = value)
                    }
                    if (this.$element.data("responsive")) {
                        var resp = {};
                        $.each(this.settings.responsive.replace(/\s+/g, "").split(","), function(index, value) {
                            value = value.split(":"), resp[value[0]] = {
                                columns: value[1]
                            }
                        }), this.settings.responsive = resp
                    }
                    this.settings.matchHeight && $window.on("resize", this._updateItemsHeight.bind(this)), this.mc = new MasterCarousel(this.$element[0], this.settings), this.mc.addEventListener(MCEvents.INIT, this._onCarouselInit, this), this.mc.setup(), this.$element.removeClass(this.settings.noJS), AuxinCarousel[this.settings.elementID] = this
                } else $.error("Master Carousel does not found in the page.")
            },
            _onCarouselInit: function() {
                var st = this.settings;
                this.$element.addClass(this.settings.initClass).removeClass(this.settings.beforeInit), (st.arrows || st.bullets && st.wrapControls) && (this.$controlsWrap = $("<div></div>").addClass(st.controlsClass).insertAfter(this.$element)), st.arrows && (this.$prevArrow = $("<div></div>").addClass(st.arrowsClass + " aux-prev").on("click", {
                    action: "prev"
                }, this._controlCarousel.bind(this)), st.wrapControls ? this.$prevArrow.appendTo(this.$controlsWrap) : this.$prevArrow.insertAfter(this.$element), st.arrowPrevMarkup && this.$element.find(st.arrowPrevMarkup).appendTo(this.$prevArrow), this.$nextArrow = $("<div></div>").addClass(st.arrowsClass + " aux-next").on("click", {
                    action: "next"
                }, this._controlCarousel.bind(this)), st.wrapControls ? this.$nextArrow.appendTo(this.$controlsWrap) : this.$nextArrow.insertAfter(this.$element), st.arrowNextMarkup && this.$element.find(st.arrowNextMarkup).appendTo(this.$nextArrow)), st.bullets && (this.$bullets = $("<div></div>").addClass(st.bulletsClass), this._generateBullets(), this.mc.view.addEventListener(MCEvents.SCROLL, this._updateCurrentBullet, this), $window.on("resize", this._updateBullets.bind(this))), st.matchHeight && (this.matchHeightTo = setTimeout(this._updateItemsHeight.bind(this), 150, !0)), this.$element.parents(".siteorigin-panels-stretch").length && ($window.on("resize.master-carousel", this._updateCarouselSize.bind(this)), this._updateCarouselSize()), st.initCb && st.initCb(this), this.$element.trigger("auxinCarouselInit")
            },
            _updateCarouselSize: function() {
                setTimeout(this.mc.view._resize.bind(this.mc.view), 0)
            },
            _generateBullets: function() {
                this.$bullets.children().remove(), this._bullets = [], this.settings.wrapControls ? this.$bullets.appendTo(this.$controlsWrap) : this.insertAfter(this.$element);
                for (var i = 0, l = this.mc.count(); i !== l; i++) this._bullets.push($("<div></div>").addClass(this.settings.bulletClass).appendTo(this.$bullets).on("click", {
                    action: "bullet",
                    index: i
            ...
            _updateItemsHeight: function(withDelay) {
                if (this.mc.items) {
                    if (!0 !== withDelay) return clearTimeout(this.matchHeightTo), void(this.matchHeightTo = setTimeout(this._updateItemsHeight.bind(this), 20, !0));
                    var maxHeight = 0;
                    this.mc.items.forEach(function(item) {
                        item.$element[0].style.height = "", maxHeight = Math.max(item.$element.height(), maxHeight)
                    }.bind(this)), this.mc.items.forEach(function(item) {
            ...
            _updateCurrentBullet: function() {
                ...
                this._currentPosition !== target && (this._currentPosition = target, this.$bullets.find("." + this.settings.bulletClass).removeClass(this.settings.selectedBulletClass).eq(target).addClass(this.settings.selectedBulletClass))
            },
            destroy: function() {
                this.mc.removeEventListener(MCEvents.INIT, this._onCarouselInit, this), this.mc.view.removeEventListener(MCEvents.SCROLL, this._updateCurrentBullet, this), this.settings.matchHeight && $window.off("resize", this._updateItemsHeight.bind(this)), $window.off("resize.master-carousel"), this.settings.arrows && (this.$nextArrow.remove(), this.$prevArrow.remove()), this.settings.bullets && ($window.off("resize", this._updateBullets.bind(this)), this.$bullets.remove()), this.mc.destroy(), this.$element.remove()
            }
    ...
    function($, window) {
        ...
        function Plugin(element, options) {
            this.element = element, this.$element = $(element), this.settings = $.extend({}, defaults, options), this._defaults = defaults, this._name = "AuxinToggleSelected", this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                this.$targets = this.$element.find(this.settings.target), this.$targets.on(this.settings.event, this._toggleSelected.bind(this)), this.$element.hasClass(this.settings.overlayClass) && (this.overlay = this.$element.find("." + this.settings.overlay)[0], $(window).on("resize", this._locateOverlay.bind(this))), 0 === this.$element.find("." + this.settings.selected).length && (this.$current = this.$targets.eq(0), this._toggleSelected({
                    currentTarget: this.$current[0]
                })), this._locateOverlay()
            },
            _toggleSelected: function(event) {
                this.$targets.removeClass(this.settings.selected);
                var $this = $(event.currentTarget);
                $this.addClass(this.settings.selected), this.settings.isotope && this.settings.isotope.arrange({
                    filter: $this.data("filter")
                }), this.$current = $this, this._locateOverlay()
            },
            _locateOverlay: function() {
                this.overlay && this.$current && (this.overlay.style[window._jcsspfx + "Transform"] = "translate(" + (this.$current.offset().left - this.$element.offset().left) + "px, " + (this.$current.offset().top - this.$element.offset().top) + "px  )", this.settings.resizeOverlay && (this.overlay.style.width = this.$current.outerWidth() - 1 + "px", this.overlay.style.height = this.$current.outerHeight() - 1 + "px"))
            },
            destroy: function() {
                $(window).off("resize", this._locateOverlay), this.$overlay = null, this.$element.remove()
            }
        }), $.fn.AuxinToggleSelected = function(options) {
            var returns, args = arguments,
                plugin = "plugin_AuxinToggleSelected";
            return void 0 === options || "object" == typeof options ? this.each(function() {
                $.data(this, plugin) || $.data(this, plugin, new Plugin(this, options))
            }) : "string" == typeof options && "_" !== options[0] && "init" !== options ? (this.each(function() {
                var instance = $.data(this, plugin);
    ...
    function($, window) {
        ...
        function Plugin(element, options) {
            this.element = element, this.$element = $(element), this._name = "AuxinVideobox", this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                this.$video = this.$element.find(">video"), 0 !== this.$video.length && (this.video = this.$video[0], this.video.addEventListener("loadedmetadata", this._initVideo.bind(this)), AVTAligner ? (this.aligner = new AVTAligner(this.$element.data("fill") || "fill", this.$element, this.$video), $(window).on("resize", this._alignVideo.bind(this))) : $.error("AVTAligner is not defined in this page, Auxin video box requires this library to perform correctly."))
            },
            _initVideo: function() {
                this._videoInit || (this._videoInit = !0, this.aligner.init(this.video.videoWidth, this.video.videoHeight), this.aligner.align(), this.video.play())
            },
    ...
    function($, window) {
        ...
        function Plugin(element, options) {
            this.element = element, this.$element = $(element), this.settings = $.extend({}, defaults, options), this._name = "AuxinImagebox", this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                if (AVTAligner) {
                    ...
                    this.$image = this.$element.find(this.settings.target), this.$image.length && (this.$image.preloadImg(this.$image.attr("src"), this._initAligner.bind(this)), this.$frame = this.settings.frame ? this.$element.find(this.settings.frame) : this.$element, this.aligner = new AVTAligner(this.settings.fill, this.$parent, this.$image, {
                ...
                } else $.error("AVTAligner is not defined in this page, Auxin image box requires this library to perform correctly.")
            },
    ...
    function($, window) {
        ...
        function Plugin(element, options) {
            this.element = element, this.$element = $(element), this._name = pluginName, this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
    ...
    function($, window, document) {
        ...
        var pluginName = "AuxinAnimateAndRedirect",
            defaults = {
                ...
                checkTargetEvents: !0,
                skipRelativeLinks: !0,
                noAnimate: '.aux-no-page-animate, .aux-lightbox-btn, [data-elementor-open-lightbox="yes"], [bdt-lightbox] a',
        ...
        $.extend(Plugin.prototype, {
            init: function() {
                ...
                this.element.href;
                st.animateIn && !$target.data("isAnimated") && ($target.addClass(st.animateIn).data("isAnimated", !0), st.startToShow && st.startToShow()), st.noAnimate && this.$element.is(st.noAnimate) || st.skipRelativeLinks && !/http(s?):\/\//.test(this.$element.attr("href")) || "_blank" !== this.$element.attr("target") && (st.checkTargetEvents && ("click" in evts || this.element.onclick) || "" !== this.element.hash && this.element.origin + this.element.pathname + this.element.search === location.origin + location.pathname + location.search || st.disableOn && this.$element.parents(st.disableOn).length || this.$element.on("click", function(e) {
                    if (!e.ctrlKey && !e.metaKey && 1 === e.which) {
                        e.preventDefault();
                        var scrollTop = document.documentElement.scrollTop;
                        $target.addClass(st.beforeAnimateOut).removeClass(st.animateIn), setTimeout(function() {
                            $target.addClass(st.animateOut)
                        }, 1), st.fixScroll && $scrollTarget.scrollTop(scrollTop), st.linkClicked && st.linkClicked(), clearTimeout(this.timeout), this.timeout = setTimeout(function() {
                            window.location.href = this.element.href, st.startToHide && st.startToHide()
                        }.bind(this), st.delay)
                    }
                }.bind(this)))
            }
    ...
    function($, window) {
        ...
        $.extend(Plugin.prototype, {
            init: function() {
                this.$targets = this.$element.find("." + this.settings.targets), this._targetsNum = this.$targets.length, this._prefix = window._jcsspfx || "", 0 !== this._targetsNum && ($window.on("scroll resize", this.update.bind(this)), this.update())
            },
            _setPosition: function($target, scrollValue) {
                var value, origin = $target.data("parallax-origin") || this.settings.defaultOrigin,
                ...
                if (disablePoint >= window.innerWidth) {
                    ...
                    return $target.data("disabled", !0), void("background" === type ? $target[0].style.backgroundPosition = "" : $target[0].style[this._prefix + "Transform"] = "")
                }
                ...
                value = value < 0 ? Math.max(value, -window.innerHeight) : Math.min(value, window.innerHeight), "background" === type ? $target[0].style.backgroundPosition = "50% " + value * dir + "px" : $target[0].style[this._prefix + "Transform"] = "translateY(" + value * dir + "px)" + (this.settings.forceHR ? " translateZ(1px)" : "")
            },
            update: function() {
                this._boxHeight = this.$element.height(), this._spaceFromTop = this.$element[0].getBoundingClientRect().top, this._spaceFromBot = window.innerHeight - this._boxHeight - this._spaceFromTop, this._spaceFromMid = window.innerHeight / 2 - this._boxHeight / 2 - this._spaceFromTop;
                for (var i = 0; i !== this._targetsNum; i++) this._setPosition(this.$targets.eq(i), $window.scrollTop())
            },
            enable: function() {
    ...
    function($, window, document) {
        ...
        function Plugin(element, options) {
            ...
            var tempData, elementData = {};
            for (var attribute in attributeDataMap) void 0 !== (tempData = this.$element.data(attribute)) && (elementData[attributeDataMap[attribute]] = tempData);
            this.settings = $.extend({}, defaults, options, elementData), this._defaults = defaults, this._name = pluginName, this.items = this.$element.find(".aux-parallax-item"), this.oldBreakPoint = null, this.loading = !1, this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                this.showLoading(), $window.on("load resize", this.initializeLayout.bind(this)), setTimeout(function() {
                    this.hideLoading()
                }.bind(this), 1e3)
            },
            update: function() {
                if (this.items.length <= this.columns.length || this.items.length % this.columns.length == 0) return this.columns.css(window._jcsspfx + "Transform", "none"), void(this.element.style.marginBottom = 0);
                var shortCol = this.shortCol,
                    shortColRect = shortCol.getBoundingClientRect(),
                    refDeltaNormal = (window.innerHeight - window.innerHeight * this.settings.offset - shortColRect.top) / shortColRect.height;
                this.element.style.marginBottom = shortCol.offsetHeight * this.settings.insetOffset - this.element.offsetHeight + "px", 1 <= refDeltaNormal ? refDeltaNormal = 1 : refDeltaNormal <= 0 && (refDeltaNormal = 0), this.columns.each(function(index, column) {
                    var colTransform;
                    colTransform = -1 * (column.offsetHeight + column.offsetTop - (shortColRect.height * this.settings.insetOffset + shortCol.offsetTop)) * refDeltaNormal, column.style[window._jcsspfx + "Transform"] = "translateY(" + colTransform + "px)"
                }.bind(this))
            },
            initializeLayout: function() {
                var columnsNum, currentBreakPoint;
                if (currentBreakPoint = $window.width() < 1024 && 768 < $window.width() ? (columnsNum = this.settings.tabletColumns, "tablet") : $window.width() < 768 ? (columnsNum = this.settings.mobileColumns, "mobile") : (columnsNum = this.settings.columns, "desktop"), this.oldBreakPoint !== currentBreakPoint) {
                    this.oldBreakPoint = currentBreakPoint;
                    var shortCol, colObject = this.initializeColumn(columnsNum),
                        columns = [],
                        self = this;
                    this.columns && this.columns.remove(), Object.keys(colObject).forEach(function(key) {
                        var columnNode = document.createElement("div");
                        columnNode.classList.add(self.settings.columnClass + "-" + key), colObject[key].posts.forEach(function(item) {
                            columnNode.appendChild(item)
                        }), self.element.appendChild(columnNode), columns.push(columnNode), (!shortCol || columnNode.offsetHeight < shortCol.offsetHeight) && (shortCol = columnNode)
                    }), this.shortCol = shortCol, this.columns = $(columns), $window.on("scroll resize", this.update.bind(this))
                }
            },
            initializeColumn: function(columnsNum) {
                this.settings.numItems !== this.items.length && (this.settings.numItems = this.items.length);
                for (var colObj = {}, numExtraItems = this.settings.numItems < columnsNum ? 0 : this.settings.numItems % columnsNum, orderdItems = 0 != numExtraItems ? this.items.slice(0, -1 * numExtraItems) : this.items, extraItems = 0 != numExtraItems ? this.items.slice(-1 * numExtraItems) : null, i = 1; i <= columnsNum; i++) colObj[i] = {
                    posts: []
                };
                if (orderdItems.each(function(index, item) {
                        var columnIndex = (index + 1) % columnsNum;
                        colObj[columnIndex = 0 === columnIndex ? columnsNum : columnIndex].posts.push(item)
                    }), extraItems) switch (columnsNum) {
                    case 5:
                        1 == 5 - numExtraItems ? extraItems.each(function(index, item) {
                            colObj[index + 1].posts.push(item)
                        }) : 2 == 5 - numExtraItems ? extraItems.each(function(index, item) {
                            colObj[2 * index + 1].posts.push(item)
                        }) : 3 == 5 - numExtraItems ? extraItems.each(function(index, item) {
                            colObj[2 * (index + 1)].posts.push(item)
                        ...
                        break;
                    case 4:
                        1 == 4 - numExtraItems ? extraItems.each(function(index, item) {
                            colObj[index + 1].posts.push(item)
                        }) : 2 == 4 - numExtraItems ? extraItems.each(function(index, item) {
                            colObj[2 * (index + 1)].posts.push(item)
                        }) : extraItems.each(function(index, item) {
                            colObj[index + 1].posts.push(item)
                        });
                        break;
                    case 3:
                        1 == 3 - numExtraItems ? extraItems.each(function(index, item) {
                            colObj[2 * index + 1].posts.push(item)
                        }) : extraItems.each(function(index, item) {
                            colObj[2 * (index + 1)].posts.push(item)
                        });
            ...
            insertItem: function(items) {
                this.oldBreakPoint = null, this.columns.remove(), this.items = items, this.initializeLayout()
            }
        }), $.fn[pluginName] = function(options) {
            var _arguments = arguments;
            return this.each(function() {
    ...
    function($, window) {
        ...
        function Plugin(element, options) {
            ...
            var tempData, elementData = {};
            for (var attribute in attributeDataMap) void 0 !== (tempData = this.$element.data(attribute)) && (elementData[attributeDataMap[attribute]] = tempData);
            this.settings = $.extend({}, defaults, options, elementData), this._defaults = defaults, this._name = pluginName, this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                this._prefix = window._jcsspfx || "", this.settings.viewPortOrigin = [this.settings.viewPortTopOrigin, this.settings.viewPortBotOrigin], this.oldEffect = this.settings.moveInEffect, 0 !== this.$element.length && ($window.on("scroll resize", this.update.bind(this)), this.update())
            },
            _setStyles: function($target, scrollValue) {
                var effect, delta = this._getDelta($target[0], this.settings.elementOrigin, this.settings.viewPortOrigin),
                    styles = this._getStyle(delta);
                effect = delta < 0 ? this.settings.moveOutEffect : 0 < delta ? this.settings.moveInEffect : this.oldEffect, this.oldEffect !== effect && this._generateEffect(this.oldEffect, this._getStyle(0), $target.find(this.settings.containerTarget)), this._generateEffect(effect, styles, $target.find(this.settings.containerTarget)), this.oldEffect = effect
            },
            _getDelta: function($target, elementOrigin, viewPortOrigin) {
                ...
                return lowerRange <= elementPosition && elementPosition <= upperRange ? 0 : upperRange <= elementPosition ? Math.min((elementTop - window.innerHeight * upperRange) / (window.innerHeight - window.innerHeight * upperRange), 1) : Math.max((elementTop - window.innerHeight * lowerRange) / (window.innerHeight * lowerRange), -1)
            },
            _getStyle: function(delta) {
                var style = {};
                return style.opacity = 1 - Math.abs(delta), style.xAxis = this.settings.xAxis * delta, style.yAxis = this.settings.yAxis * delta, style.slide = Math.abs(100 * delta), style.mask = Math.abs(100 * delta), style.rotate = this.settings.rotate * delta, style.scale = (this.settings.scale - 1) * Math.abs(delta) + 1, style
            },
            _generateEffect: function(effect, styles, $target) {
                switch (effect) {
                    ...
                    case "fade":
                        ...
                        break;
                    case "fadeTop":
                        $target[0].style.opacity = styles.opacity, $target[0].style[this._prefix + "Transform"] = "translateY(" + -1 * styles.yAxis + "px)";
                        break;
                    case "fadeBottom":
                        $target[0].style.opacity = styles.opacity, $target[0].style[this._prefix + "Transform"] = "translateY(" + styles.yAxis + "px)";
                        break;
                    case "fadeRight":
                        $target[0].style.opacity = styles.opacity, $target[0].style[this._prefix + "Transform"] = "translateX(" + styles.xAxis + "px)";
                        break;
                    case "fadeLeft":
                        $target[0].style.opacity = styles.opacity, $target[0].style[this._prefix + "Transform"] = "translateX(" + -1 * styles.xAxis + "px)";
                        break;
                    case "slideRight":
                        $target.parent()[0].style.overflow = "hidden", $target[0].style[this._prefix + "Transform"] = "translateX(" + styles.slide + "%)";
                        break;
                    case "slideLeft":
                        $target.parent()[0].style.overflow = "hidden", $target[0].style[this._prefix + "Transform"] = "translateX(" + -1 * styles.slide + "%)";
                        break;
                    case "slideTop":
                        $target.parent()[0].style.overflow = "hidden", $target[0].style[this._prefix + "Transform"] = "translateY(" + -1 * styles.slide + "%)";
                        break;
                    case "slideBottom":
                        $target.parent()[0].style.overflow = "hidden", $target[0].style[this._prefix + "Transform"] = "translateY(" + styles.slide + "%)";
                        break;
                    case "maskTop":
                    ...
                    case "rotateOut":
                        ...
                        break;
                    case "fadeScale":
                        $target[0].style.opacity = styles.opacity, $target[0].style[this._prefix + "Transform"] = "scale(" + styles.scale + ")";
                        break;
                    case "scale":
            ...
            update: function() {
                $window.width() <= this.settings.disableScrollAnims ? this.disable() : this._setStyles(this.$element, $window.scrollTop())
            },
            enable: function() {
                $window.on("resize scroll", this.update), this.update()
            },
    ...
    function($, window) {
        ...
        function Plugin(element, options) {
            this.element = element, this.$element = $(element), this.settings = $.extend({}, defaults, options), this._defaults = defaults, this._name = "AuxinTimeline", this.init()
        }
        $.extend(Plugin.prototype, {
            init: function() {
                void 0 !== this.$element.data("layout") && (this.settings.layout = this.$element.data("layout")), $window.on("resize", this._onResize.bind(this)), this._onResize()
            },
            _onResize: function(e) {
                var width = $window.width(),
                    layout = this.settings.layout;
                for (var bp in this.settings.responsive) width < bp && (layout = this.settings.responsive[bp]);
                this._update(layout)
            },
            _update: function(newLayout) {
                if (this._currentLayout !== newLayout) {
                    for (var key in this._currentLayout = newLayout, this.settings.layoutMap) this.$element.removeClass(this.settings.layoutMap[key]);
                    this.$element.addClass(this.settings.layoutMap[newLayout])
                }
            }
        }), $.fn.AuxinTimeline = function(options) {
            return this.each(function() {
                $.data(this, "plugin_AuxinTimeline") || $.data(this, "plugin_AuxinTimeline", new Plugin(this, options))
            })
        }
    }(jQuery, window, document), "function" != typeof Object.create && (Object.create = function(obj) {
        function F() {}
        return F.prototype = obj, new F
    }),
    function($) {
        var Container = {
            init: function(el, options) {
                this.options = $.extend({}, $.fn.avertaAccordion.defaultOptions, options || {}), this.$el = $(el), this.el = el, this.$items = this.$el.find(this.options.items), this.$items.length && (this.$items.find(this.options.itemContent).wrap('<div class="' + this.options.contentWrapClass + '"></div>'), this.$headers = this.$items.find(this.options.itemHeader), this.$contents = this.$items.find("." + this.options.contentWrapClass), this.setup())
            },
            setup: function() {
                if (this.$headers.on("click", {
                        self: this
                    }, this.onHeaderClicked), (this.options.collapseOnInit || this.options.oneVisible) && (this._closeContent(this.$contents, 0), this.options.onCollapse(this.$items)), this.options.oneVisible) {
                    var $actives = this.$items.filter("." + this.options.itemActiveClass).first();
                    $actives = $actives.length ? $actives : this.$items.first().addClass(this.options.itemActiveClass), this._openContent($actives.find("." + this.options.contentWrapClass), 0), this.options.onExpand($actives)
                } else this.options.collapseOnInit && this.$items.removeClass(this.options.itemActiveClass);
                window.location.hash && this.options.expandHashItem && this.expandHashItem(), this.options.expandHashItem && $(window).on("hashchange", this.expandHashItem)
            },
            expandHashItem: function() {
                $(window.location.hash).find(this.options.itemHeader).trigger("click", {
                    self: this
            ...
            _openContent: function($contents, duration, $exclude) {
                var self = this;
                $contents.length || ($contents = [$contents]), $.each($contents, function(index, content) {
                    var $content = $(content);
                    $exclude && $content === $exclude || (clearTimeout($content.data("toggle-to")), 0 === duration ? $content.css("height", "auto") : ($content.css("height", $content.find(self.options.itemContent).outerHeight() + "px"), $content.data("toggle-to", setTimeout(function() {
            ...
            _closeContent: function($contents, duration, $exclude) {
                ...
                $contents.length || ($contents = [$contents]), $.each($contents, function(index, content) {
                    var $content = $(content);
                    $exclude && $content === $exclude || (clearTimeout($content.data("toggle-to")), 0 === duration ? $content.css("height", "0") : ($content.css("height", $content.find(self.options.itemContent).outerHeight() + "px"), $content.data("toggle-to", setTimeout(function() {
    ...
    function($) {
        var Container = {
            init: function(el, options) {
                this.options = $.extend({}, $.fn.avertaLiveTabs.defaultOptions, options || {}), this.$el = $(el), this.el = el, this.$tabs = this.$el.find(this.options.tabs), this.$contents = this.$el.find(this.options.contents), this.setup()
            },
            setup: function() {
                var $activeTab;
                if (this.$tabs.on("click", {
                        self: this
                    }, this.onTabClicked), this.options.enableHash && "" !== window.location.hash) {
                    var id = this.trimID(window.location.hash);
                    $activeTab = this.getTabById(id)
                } else $activeTab = this.$tabs.filter("." + this.options.tabsActiveClass);
                ($activeTab = $activeTab.length ? $activeTab : this.$tabs.first()).trigger("click", !0)
            },
            onTabClicked: function(event, fromSetup) {
                event.preventDefault();
                var $tabContent, activeId, self = event.data.self,
                    $this = $(this);
                !fromSetup && $this.hasClass("active") || (self.$tabs.removeClass(self.options.tabsActiveClass), $this.addClass(self.options.tabsActiveClass), self.$contents.hide(), ($tabContent = "id" === self.options.connectType ? (activeId = self.getIdByTab($this), self.getContentById(activeId)) : self.$contents.eq($this.index())).fadeIn(self.options.duration), self.options.updateHash && (activeId = self.getIdByTab($this), activeId = (activeId = self.trimID(activeId)) ? activeId + self.options.hashSuffix : "", window.history && window.history.pushState ? window.history.pushState(null, null, window.location.href.split("#")[0] + "#" + activeId) : window.location.hash = activeId), self.$el.trigger("avtTabChange", $tabContent.attr("id")))
            },
            getTabById: function(id) {
                id = id.split(this.options.hashSuffix)[0];
                var $activeTab = this.$tabs.find('[href="#' + id + '"]').eq(0);
                return $activeTab.length || ($activeTab = this.$tabs.find('[href="' + id + '"]').eq(0)), $activeTab.length ? $activeTab.parent() : $activeTab
            },
        ...
        $.extend(MasterMenuPlugin.prototype, {
            ...
            _menuInteract: function(event) {
                var $this = $(event.currentTarget),
                    ...
                    st = this.settings,
                    etype = event.type;
                $this.hasClass(st.subIndicator) ? $menuItem = $this.parents("." + st.menuItem).eq(0) : $this.hasClass(st.submenuBack) && ($menuItem = $this.parents("." + st.menuItem).eq(0));
                var hasSubmenu = 0 !== $menuItem.find(">." + st.submenu).length;
                switch (etype) {
                    case "mouseenter":
                    case "focusin":
                        $menuItem.addClass(st.hover), hasSubmenu && this.openOnOver && this._openMenu($menuItem, st.openDelay);
                        break;
                    case "mouseleave":
                    case "focusout":
                        $menuItem.removeClass(st.hover), hasSubmenu && this.openOnOver && this._closeMenu($menuItem, st.closeDelay);
                        break;
                    case "mouseup":
                    case "click":
                        $menuItem.is(document) ? this._closeAll() : ($menuItem.hasClass(st.open) ? (this._closeMenu($menuItem, 0), event.preventDefault()) : ("toggle" !== this.type && this._closeOthers($menuItem), hasSubmenu && (this._openMenu($menuItem, 0), event.preventDefault())), event.stopPropagation())
                }
            },
            _autoSwitch: function(event) {
                var autoSwitchType = this.settings.autoSwitchType;
                this.type !== autoSwitchType && window.innerWidth <= this.settings.autoSwitch ? (this.changeType(autoSwitchType), this.settings.autoSwitchParent && this.changeLocation(this.settings.autoSwitchParent)) : this.type !== this.settings.type && window.innerWidth > this.settings.autoSwitch && (this.changeType("default"), this.settings.autoSwitchParent && this.changeLocation("default"))
            },
            _insertCoverMenuElements: function() {
                ...
                self.$element.find("." + st.submenu).each(function() {
                    var $this = $(this);
                    $("<li></li>").html('<div class="' + st.menuItemContent + '">' + st.backLabel + "</div>").addClass(st.menuItem).addClass(st.submenuBack).prependTo($this).on(self.pressEvent, self.handlerProxy);
                    if (st.insertHeaderInSubs) {
                        var headerContent = $this.parent().find(">." + st.menuItemContent).eq(0).clone();
                        headerContent.find("." + st.subIndicator).remove(), $("<li></li>").append(headerContent).prependTo($this).addClass(st.menuItem).addClass(st.submenuHeader)
                    }
                })
            },
            _removeCoverMenuElements: function() {
                var st = this.settings;
                this.$element.find("." + st.submenuBack).remove(), st.insertHeaderInSubs && this.$element.find("." + st.submenuHeader).remove()
            },
            _checkSubmenuPosition: function($menuItem) {
                ...
                if (!$menuItem.parent().hasClass(st.megamenu)) {
                    ...
                    submenu.height();
                    if ($menuItem.parent().is(this.$element) && offsetRight > $window.width()) {
                        var lastShift = submenu.data("menu-shift") || 0,
                            shift = $window.width() - offsetRight + lastShift;
                        return $("body").hasClass("rtl") ? submenu.css("right", Math.min(0, shift)) : submenu.css("left", Math.min(0, shift)), void submenu.data("menu-shift", shift)
                    }
                    offsetRight > $window.width() ? submenu.addClass(st.submenuAlignMap.left) : offsetLeft < 0 && submenu.addClass(st.submenuAlignMap.right)
                }
            },
            _openMenu: function($menuItem, delay) {
                var st = this.settings;
                if (clearTimeout($menuItem.data("openTo")), clearTimeout($menuItem.data("closeTo")), st.skipDelayForTabs && $menuItem.hasClass(st.tab) && (delay = 0), 0 === delay) return this.$element.trigger({
                    type: "beforeOpen",
                    item: $menuItem
                }), $menuItem.addClass(this.settings.open), !this.isNarrow && st.keepSubmenuInView && this._checkSubmenuPosition($menuItem), this.keepTabs && $menuItem.hasClass(st.tab) && this._closeOthers($menuItem, !1), void this.$element.trigger({
                    type: "afterOpen",
                    item: $menuItem
                });
            ...
            _closeMenu: function($menuItem, delay, notTabs) {
                var st = this.settings;
                if (void 0 === notTabs && (notTabs = this.keepTabs), clearTimeout($menuItem.data("closeTo")), clearTimeout($menuItem.data("openTo")), 0 === delay) return this.$element.trigger({
                    type: "beforeClose",
                    item: $menuItem
                }), notTabs && $menuItem.hasClass(st.tab) || $menuItem.removeClass(st.open), $menuItem.find("." + st.menuItem + "." + st.open + (notTabs ? ":not(." + st.tab + ")" : "")).removeClass(st.open), void this.$element.trigger({
                    type: "afterClose",
                    item: $menuItem
                });
            ...
            _closeOthers: function($menuItem, notTabs) {
                void 0 === notTabs && (notTabs = this.keepTabs), this._closeMenu($menuItem.siblings(), 0, notTabs)
            },
            _closeAll: function(notTabs) {
                void 0 === notTabs && (notTabs = this.keepTabs), this.$element.find("." + this.settings.open + (notTabs ? ":not(." + this.settings.tab + ")" : "")).removeClass(this.settings.open)
            },
            changeType: function(type) {
                if (void 0 !== this.type) this.$element.removeClass(this.settings.typeMap[this.type]);
                else
                    for (var typeKey in this.settings.typeMap) this.$element.removeClass(this.settings.typeMap[typeKey]);
                "default" === type && (type = this.settings.type), this.type = type, this.$element.addClass(this.settings.typeMap[this.type]), this._onTypeChanged()
            },
            changeLocation: function(location) {
                this.lastLocation !== location && ("default" === location ? (this.locationChanged = !1, 0 === this.defaultPrev.length ? this.$element.prependTo(this.defaultParent[0]) : this.defaultPrev[0].after(this.$element)) : (this.locationChanged = !0, this.$element.appendTo(location)), this.lastLocation = location, this.$element.trigger("locationChanged"))
            }
        }), window.MasterMenuPlugin = window.MasterMenuPlugin || MasterMenuPlugin, $.fn.mastermenu = function(options) {
            var returns, args = arguments,
                plugin = "plugin_mastermenu";
            return void 0 === options || "object" == typeof options ? this.each(function() {
                $.data(this, plugin) || $.data(this, plugin, new MasterMenuPlugin(this, options))
            }) : "string" == typeof options && "_" !== options[0] && "init" !== options ? (this.each(function() {
                var instance = $.data(this, plugin);
                instance instanceof MasterMenuPlugin && "function" == typeof instance[options] && (returns = instance[options].apply(instance, Array.prototype.slice.call(args, 1))), "destroy" === options && $.data(this, plugin, null)
            }), void 0 !== returns ? returns : this) : void 0
        }
    }(jQuery, window, document),
    function($, window) {
        ...
        function Plugin(element, options) {
            for (var key in this.element = element, this.$element = $(element), this.settings = $.extend({}, defaults, options), attributesMap) {
        ...
        $.extend(Plugin.prototype, {
            init: function() {
                "object" == typeof this.settings.offset ? (this._offsetTop = this.settings.offset.top, this._offsetBottom = this.settings.offset.bottom) : this._offsetTop = this._offsetBottom = this.settings.offset, this._isOnViewPort(this.$element) && (this._offsetTop = this._offsetBottom = 0), this._appeared = !1, this._lastScroll = 0, $window.on("scroll resize", this.update.bind(this)), setTimeout(this.update.bind(this))
            },
            update: function(event) {
                ...
                rect.top + insetOffset <= areaBottom && rect.bottom - insetOffset >= areaTop ? (this._appeared || this.$element.trigger("appear", [{
                    from: this._lastScroll <= $window.scrollTop() ? "bottom" : "top"
                }]), this._appeared = !0) : this._appeared && (this.$element.trigger("disappear", [{
                    from: rect.top < areaTop ? "top" : "bottom"
                }]), this._appeared = !1), this._lastScroll = $window.scrollTop()
            },
            _parseOffset: function(value, inset) {
                var percentage = "string" == typeof value && -1 !== value.indexOf("%");
                return value = parseInt(value), percentage ? (inset ? this.element.offsetHeight : window.innerHeight) * value / 100 : value
            },
            ...
            return this.each(function() {
                $.data(this, "plugin_appearl") || $.data(this, "plugin_appearl", new Plugin(this, options))
            })
        }
    }(jQuery, window, document),
    function(global, factory) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = factory() : "function" == typeof define && define.amd ? define(factory) : (global = global || self).PerfectScrollbar = factory()
    }(this, function() {
        "use strict";
        ...
        function processScrollDiff(i, axis, diff, useScrollingClass, forceFireReachEvent) {
            ...
            if (void 0 === useScrollingClass && (useScrollingClass = !0), void 0 === forceFireReachEvent && (forceFireReachEvent = !1), "top" === axis) fields = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
                ...
                diff && (element.dispatchEvent(createEvent("ps-scroll-" + y)), diff < 0 ? element.dispatchEvent(createEvent("ps-scroll-" + up)) : 0 < diff && element.dispatchEvent(createEvent("ps-scroll-" + down)), useScrollingClass && function(i, x) {
        ...
        function updateGeometry(i) {
            ...
            i.containerWidth = Math.round(rect.width), i.containerHeight = Math.round(rect.height), i.contentWidth = element.scrollWidth, i.contentHeight = element.scrollHeight, element.contains(i.scrollbarXRail) || (queryChildren(element, cls.element.rail("x")).forEach(function(el) {
                    return remove(el)
                }), element.appendChild(i.scrollbarXRail)), element.contains(i.scrollbarYRail) || (queryChildren(element, cls.element.rail("y")).forEach(function(el) {
                    return remove(el)
        ...
        function bindMouseScrollHandler(i, ref) {
            ...
            function mouseMoveHandler(e) {
                e.touches && e.touches[0] && (e[pageY] = e.touches[0].pageY), element[scrollTop] = startingScrollTop + scrollBy * (e[pageY] - startingMousePageY), addScrollingClass(i, y), updateGeometry(i), e.stopPropagation(), e.preventDefault()
            }

            function mouseUpHandler() {
                removeScrollingClass(i, y), i[scrollbarYRail].classList.remove(cls.state.clicking), i.event.unbind(i.ownerDocument, "mousemove", mouseMoveHandler)
            }

            function bindMoves(e, touchMode) {
                startingScrollTop = element[scrollTop], touchMode && e.touches && (e[pageY] = e.touches[0].pageY), startingMousePageY = e[pageY], scrollBy = (i[contentHeight] - i[containerHeight]) / (i[railYHeight] - i[scrollbarYHeight]), touchMode ? i.event.bind(i.ownerDocument, "touchmove", mouseMoveHandler) : (i.event.bind(i.ownerDocument, "mousemove", mouseMoveHandler), i.event.once(i.ownerDocument, "mouseup", mouseUpHandler), e.preventDefault()), i[scrollbarYRail].classList.add(cls.state.clicking), e.stopPropagation()
            }
        ...
        var handlers = {
                ...
                keyboard: function(i) {
                    ...
                    i.event.bind(i.ownerDocument, "keydown", function(e) {
                        if (!(e.isDefaultPrevented && e.isDefaultPrevented() || e.defaultPrevented) && (matches(element, ":hover") || matches(i.scrollbarX, ":focus") || matches(i.scrollbarY, ":focus"))) {
                            ...
                            i.settings.suppressScrollX && 0 !== deltaX || i.settings.suppressScrollY && 0 !== deltaY || (element.scrollTop -= deltaY, element.scrollLeft += deltaX, updateGeometry(i), function(deltaX, deltaY) {
                                var scrollTop = Math.floor(element.scrollTop);
                                if (0 === deltaX) {
                                    if (!i.scrollbarYActive) return !1;
                                    if (0 === scrollTop && 0 < deltaY || scrollTop >= i.contentHeight - i.containerHeight && deltaY < 0) return !i.settings.wheelPropagation
                                }
                                var scrollLeft = element.scrollLeft;
                                if (0 === deltaY) {
                                    if (!i.scrollbarXActive) return !1;
                                    if (0 === scrollLeft && deltaX < 0 || scrollLeft >= i.contentWidth - i.containerWidth && 0 < deltaX) return !i.settings.wheelPropagation
                                }
                                return !0
                    ...
                    function mousewheelHandler(e) {
                        ...
                        if (! function(target, deltaX, deltaY) {
                                ...
                                for (var cursor = target; cursor && cursor !== element;) {
                                    if (cursor.classList.contains(cls.element.consuming)) return !0;
                                    var style = get(cursor);
                                    if (deltaY && style.overflowY.match(/(scroll|auto)/)) {
                                        var maxScrollTop = cursor.scrollHeight - cursor.clientHeight;
                                        if (0 < maxScrollTop && (0 < cursor.scrollTop && deltaY < 0 || cursor.scrollTop < maxScrollTop && 0 < deltaY)) return !0
                                    }
                                    if (deltaX && style.overflowX.match(/(scroll|auto)/)) {
                                        var maxScrollLeft = cursor.scrollWidth - cursor.clientWidth;
                                        if (0 < maxScrollLeft && (0 < cursor.scrollLeft && deltaX < 0 || cursor.scrollLeft < maxScrollLeft && 0 < deltaX)) return !0
                                    }
                ...
                touch: function(i) {
                    ...
                    function touchMove(e) {
                        if (shouldHandle(e)) {
                            ...
                            0 < timeGap && (speed.x = differenceX / timeGap, speed.y = differenceY / timeGap, startTime = currentTime),
                                function(deltaX, deltaY) {
                                    ...
                                    if (magnitudeX < magnitudeY) {
                                        if (deltaY < 0 && scrollTop === i.contentHeight - i.containerHeight || 0 < deltaY && 0 === scrollTop) return 0 === window.scrollY && 0 < deltaY && env.isChrome
                                    } else if (magnitudeY < magnitudeX && (deltaX < 0 && scrollLeft === i.contentWidth - i.containerWidth || 0 < deltaX && 0 === scrollLeft)) return !0;
                                    return !0
                    ...
                    function touchEnd() {
                        i.settings.swipeEasing && (clearInterval(easingLoop), easingLoop = setInterval(function() {
                            i.isInitialized ? clearInterval(easingLoop) : speed.x || speed.y ? Math.abs(speed.x) < .01 && Math.abs(speed.y) < .01 ? clearInterval(easingLoop) : i.element ? (applyTouchMove(30 * speed.x, 30 * speed.y), speed.x *= .8, speed.y *= .8) : clearInterval(easingLoop) : clearInterval(easingLoop)
                        }, 10))
                    }
                }
            },
            PerfectScrollbar = function(element, userSettings) {
                ...
                for (var key in (this.element = element).classList.add(cls.main), this.settings = {
                ...
                this.isRtl = "rtl" === get(element).direction, !0 === this.isRtl && element.classList.add(cls.rtl), this.isNegativeScroll = (originalScrollLeft = element.scrollLeft, element.scrollLeft = -1, result = element.scrollLeft < 0, element.scrollLeft = originalScrollLeft, result), this.negativeScrollAdjustment = this.isNegativeScroll ? element.scrollWidth - element.clientWidth : 0, this.event = new EventManager, this.ownerDocument = element.ownerDocument || document, this.scrollbarXRail = div(cls.element.rail("x")), element.appendChild(this.scrollbarXRail), this.scrollbarX = div(cls.element.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", focus), this.event.bind(this.scrollbarX, "blur", blur), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
                ...
                this.scrollbarXBottom = parseInt(railXStyle.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = toInt(railXStyle.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = toInt(railXStyle.borderLeftWidth) + toInt(railXStyle.borderRightWidth), set(this.scrollbarXRail, {
                    ...
                    display: ""
                }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = div(cls.element.rail("y")), element.appendChild(this.scrollbarYRail), this.scrollbarY = div(cls.element.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", focus), this.event.bind(this.scrollbarY, "blur", blur), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
                var railYStyle = get(this.scrollbarYRail);
                this.scrollbarYRight = parseInt(railYStyle.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = toInt(railYStyle.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? function(element) {
        ...
        return PerfectScrollbar.prototype.update = function() {
    ...
    function(factory) {
        ...
        var S2 = function() {
                ...
                var requirejs, require, define, main, req, makeMap, handlers, defined, waiting, config, defining, hasOwn, aps, jsSuffixRegExp, factory;
                ...
                function normalize(name, baseName) {
                    var nameParts, nameSegment, mapValue, foundMap, lastIndex, foundI, foundStarMap, starI, i, j, part, baseParts = baseName && baseName.split("/"),
                        ...
                        starMap = map && map["*"] || {};
                    if (name) {
                        for (lastIndex = (name = name.split("/")).length - 1, config.nodeIdCompat && jsSuffixRegExp.test(name[lastIndex]) && (name[lastIndex] = name[lastIndex].replace(jsSuffixRegExp, "")), "." === name[0].charAt(0) && baseParts && (name = baseParts.slice(0, baseParts.length - 1).concat(name)), i = 0; i < name.length; i++)
                        ...
                        for (i = (nameParts = name.split("/")).length; 0 < i; i -= 1) {
                            if (nameSegment = nameParts.slice(0, i).join("/"), baseParts)
                                for (j = baseParts.length; 0 < j; j -= 1)
                                    if (mapValue = (mapValue = map[baseParts.slice(0, j).join("/")]) && mapValue[nameSegment]) {
                ...
                function splitPrefix(name) {
                    ...
                    return -1 < index && (prefix = name.substring(0, index), name = name.substring(index + 1, name.length)), [prefix, name]
                }

                function makeRelParts(relName) {
                    return relName ? splitPrefix(relName) : []
                }
                return S2 && S2.requirejs || (S2 ? require = S2 : S2 = {}, defined = {}, waiting = {}, config = {}, defining = {}, hasOwn = Object.prototype.hasOwnProperty, aps = [].slice, jsSuffixRegExp = /\.js$/, makeMap = function(name, relParts) {
                    var plugin, parts = splitPrefix(name),
                        prefix = parts[0],
                        relResourceName = relParts[1];
                    return name = parts[1], prefix && (plugin = callDep(prefix = normalize(prefix, relResourceName))), prefix ? name = plugin && plugin.normalize ? plugin.normalize(name, function(relName) {
                        return function(name) {
                            return normalize(name, relName)
                        }
                    }(relResourceName)) : normalize(name, relResourceName) : (prefix = (parts = splitPrefix(name = normalize(name, relResourceName)))[0], name = parts[1], prefix && (plugin = callDep(prefix))), {
                    ...
                    var cjsModule, depName, ret, map, i, relParts, usingExports, args = [],
                    ...
                    if (relParts = makeRelParts(relName = relName || name), "undefined" == callbackType || "function" == callbackType) {
                        ...
                        ret = callback ? callback.apply(defined[name], args) : void 0, name && (cjsModule && void 0 !== cjsModule.exports && cjsModule.exports !== defined[name] ? defined[name] = cjsModule.exports : void 0 === ret && usingExports || (defined[name] = ret))
                    ...
                    return callback = callback || function() {}, "function" == typeof relName && (relName = forceSync, forceSync = alt), forceSync ? main(void 0, deps, callback, relName) : setTimeout(function() {
                    ...
                    jQuery: !0
                }, S2.requirejs = requirejs, S2.require = require, S2.define = define), S2.define("almond", function() {}), S2.define("jquery", [], function() {
                    var _$ = jQuery || $;
                    ...
                    function getMethods(theClass) {
                        ...
                        for (var methodName in proto) {
                            "function" == typeof proto[methodName] && "constructor" !== methodName && methods.push(methodName)
                        }
                        return methods
                    }
                    Utils.Extend = function(ChildClass, SuperClass) {
                        ...
                        function DecoratedClass() {
                            ...
                            0 < argCount && (unshift.call(arguments, SuperClass.prototype.constructor), calledConstructor = DecoratorClass.prototype.constructor), calledConstructor.apply(this, arguments)
                        }
                        DecoratorClass.displayName = SuperClass.displayName, DecoratedClass.prototype = new function() {
                    ...
                    Observable.prototype.on = function(event, callback) {
                        ...
                        this.listeners = this.listeners || {}, null == params && (params = []), 0 === params.length && params.push({}), (params[0]._type = event) in this.listeners && this.invoke(this.listeners[event], slice.call(arguments, 1)), "*" in this.listeners && this.invoke(this.listeners["*"], arguments)
                        ...
                        for (var originalKey in data) {
                            ...
                            if (1 !== keys.length) {
                                for (var k = 0; k < keys.length; k++) {
                                    var key = keys[k];
                                    (key = key.substring(0, 1).toLowerCase() + key.substring(1)) in dataLevel || (dataLevel[key] = {}), k == keys.length - 1 && (dataLevel[key] = data[originalKey]), dataLevel = dataLevel[key]
                                }
                    ...
                    return Utils.GetUniqueElementId = function(element) {
                        ...
                        return null != select2Id || (select2Id = element.id ? "select2-data-" + element.id : "select2-data-" + (++id).toString() + "-" + Utils.generateChars(4), element.setAttribute("data-select2-id", select2Id)), select2Id
                    ...
                    return Utils.Extend(Results, Utils.Observable), Results.prototype.render = function() {
                        ...
                        return this.options.get("multiple") && $results.attr("aria-multiselectable", "true"), this.$results = $results
                        ...
                        0 < $selected.length ? $selected.first().trigger("mouseenter") : $options.first().trigger("mouseenter"), this.ensureHighlightVisible()
                        ...
                        this.data.current(function(selected) {
                            ...
                            self.$results.find(".select2-results__option--selectable").each(function() {
                                var $option = $(this),
                                    ...
                                    id = "" + item.id;
                                null != item.element && item.element.selected || null == item.element && -1 < selectedIds.indexOf(id) ? (this.classList.add("select2-results__option--selected"), $option.attr("aria-selected", "true")) : (this.classList.remove("select2-results__option--selected"), $option.attr("aria-selected", "false"))
                            })
                        })
                        ...
                        this.$results.attr("id", id), container.on("results:all", function(params) {
                            ...
                            if (0 !== $highlighted.length) {
                                ...
                                $highlighted.hasClass("select2-results__option--selected") ? self.trigger("close", {}) : self.trigger("select", {
                                    data: data
                                })
                            }
                            ...
                            if (!(nextIndex >= $options.length)) {
                                ...
                                0 === nextIndex ? self.$results.scrollTop(0) : currentOffset < nextBottom && self.$results.scrollTop(nextOffset)
                            }
                            ...
                            $this.hasClass("select2-results__option--selected") ? self.options.get("multiple") ? self.trigger("unselect", {
                                originalEvent: evt,
                                data: data
                            }) : self.trigger("close", {}) : self.trigger("select", {
                                originalEvent: evt,
                                data: data
                            })
                        }), this.$results.on("mouseenter", ".select2-results__option--selectable", function(evt) {
                            var data = Utils.GetData(this, "data");
                            self.getHighlightedResults().removeClass("select2-results__option--highlighted").attr("aria-selected", "false"), self.trigger("results:focus", {
                                data: data,
                                element: $(this)
                            })
                        })
                    ...
                    return Utils.Extend(BaseSelection, Utils.Observable), BaseSelection.prototype.render = function() {
                        ...
                        return this._tabindex = 0, null != Utils.GetData(this.$element[0], "old-tabindex") ? this._tabindex = Utils.GetData(this.$element[0], "old-tabindex") : null != this.$element.attr("tabindex") && (this._tabindex = this.$element.attr("tabindex")), $selection.attr("title", this.$element.attr("title")), $selection.attr("tabindex", this._tabindex), $selection.attr("aria-disabled", "false"), this.$selection = $selection
                        ...
                        this.container = container, this.$selection.on("focus", function(evt) {
                            ...
                            self.$selection.attr("aria-expanded", "false"), self.$selection.removeAttr("aria-activedescendant"), self.$selection.removeAttr("aria-owns"), self.$selection.trigger("focus"), self._detachCloseHandler(container)
                    ...
                    return Utils.Extend(SingleSelection, BaseSelection), SingleSelection.prototype.render = function() {
                        ...
                        return $selection[0].classList.add("select2-selection--single"), $selection.html('<span class="select2-selection__rendered"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>'), $selection
                    }, SingleSelection.prototype.bind = function(container, $container) {
                        var self = this;
                        SingleSelection.__super__.bind.apply(this, arguments);
                        var id = container.id + "-container";
                        this.$selection.find(".select2-selection__rendered").attr("id", id).attr("role", "textbox").attr("aria-readonly", "true"), this.$selection.attr("aria-labelledby", id), this.$selection.attr("aria-controls", id), this.$selection.on("mousedown", function(evt) {
                            1 === evt.which && self.trigger("toggle", {
                                originalEvent: evt
                            })
                        }), this.$selection.on("focus", function(evt) {}), this.$selection.on("blur", function(evt) {}), container.on("focus", function(evt) {
                    ...
                    return Utils.Extend(MultipleSelection, BaseSelection), MultipleSelection.prototype.render = function() {
                        ...
                        var id = container.id + "-container";
                        this.$selection.find(".select2-selection__rendered").attr("id", id), this.$selection.on("click", function(evt) {
                            self.trigger("toggle", {
                                originalEvent: evt
                            })
                        ...
                        return $('<li class="select2-selection__choice"><button type="button" class="select2-selection__choice__remove" tabindex="-1"><span aria-hidden="true">&times;</span></button><span class="select2-selection__choice__display"></span></li>')
                        ...
                        if (this.clear(), 0 !== data.length) {
                            for (var $selections = [], selectionIdPrefix = this.$selection.find(".select2-selection__rendered").attr("id") + "-choice-", d = 0; d < data.length; d++) {
                                ...
                                selection.id ? selectionId += selection.id : selectionId += Utils.generateChars(4), $selection.find(".select2-selection__choice__display").append(formatted).attr("id", selectionId);
                                var title = selection.title || selection.text;
                                title && $selection.attr("title", title);
                                var removeItem = this.options.get("translations").get("removeItem"),
                                    $remove = $selection.find(".select2-selection__choice__remove");
                                $remove.attr("title", removeItem()), $remove.attr("aria-label", removeItem()), $remove.attr("aria-describedby", selectionId), Utils.StoreData($selection[0], "data", selection), $selections.push($selection)
                            }
                    ...
                    return Placeholder.prototype.normalizePlaceholder = function(_, placeholder) {
                        ...
                        if (1 < data.length || singlePlaceholder) return decorated.call(this, data);
                        this.clear();
                    ...
                    return AllowClear.prototype.bind = function(decorated, container, $container) {
                        ...
                        if (decorated.call(this, data), this.$selection.find(".select2-selection__clear").remove(), this.$selection[0].classList.remove("select2-selection--clearable"), !(0 < this.$selection.find(".select2-selection__placeholder").length || 0 === data.length)) {
                            ...
                            $remove.attr("title", removeAll()), $remove.attr("aria-label", removeAll()), $remove.attr("aria-describedby", selectionId), Utils.StoreData($remove[0], "data", data), this.$selection.prepend($remove), this.$selection[0].classList.add("select2-selection--clearable")
                        }
                    }, AllowClear
                    ...
                    return Search.prototype.render = function(decorated) {
                        var searchLabel = this.options.get("translations").get("search"),
                            $search = $('<span class="select2-search select2-search--inline"><textarea class="select2-search__field" type="search" tabindex="-1" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" ></textarea></span>');
                        this.$searchContainer = $search, this.$search = $search.find("textarea"), this.$search.prop("autocomplete", this.options.get("autocomplete")), this.$search.attr("aria-label", searchLabel());
                        ...
                        decorated.call(this, container, $container), self.$search.attr("aria-describedby", selectionId), container.on("open", function() {
                        ...
                        var width = "100%";
                        "" === this.$search.attr("placeholder") && (width = .75 * (this.$search.val().length + 1) + "em");
                        this.$search.css("width", width)
                    }, Search
                }), S2.define("select2/selection/selectionCss", ["../utils"], function(Utils) {
                    function SelectionCSS() {}
                    return SelectionCSS.prototype.render = function(decorated) {
                        var $selection = decorated.call(this),
                            selectionCssClass = this.options.get("selectionCssClass") || "";
                        return -1 !== selectionCssClass.indexOf(":all:") && (selectionCssClass = selectionCssClass.replace(":all:", ""), Utils.copyNonInternalCssClasses($selection[0], this.$element[0])), $selection.addClass(selectionCssClass), $selection
                    }, SelectionCSS
                    ...
                    return Utils.Extend(SelectAdapter, BaseAdapter), SelectAdapter.prototype.current = function(callback) {
                        var self = this;
                        callback(Array.prototype.map.call(this.$element[0].querySelectorAll(":checked"), function(selectedElement) {
                            return self.item($(selectedElement))
                        }))
                    }, SelectAdapter.prototype.select = function(data) {
                        var self = this;
                        if (data.selected = !0, null != data.element && "option" === data.element.tagName.toLowerCase()) return data.element.selected = !0, void this.$element.trigger("input").trigger("change");
                        if (this.$element.prop("multiple")) this.current(function(currentData) {
                            var val = [];
                            (data = [data]).push.apply(data, currentData);
                            for (var d = 0; d < data.length; d++) {
                                var id = data[d].id; - 1 === val.indexOf(id) && val.push(id)
                            }
                        ...
                        if (this.$element.prop("multiple")) {
                            if (data.selected = !1, null != data.element && "option" === data.element.tagName.toLowerCase()) return data.element.selected = !1, void this.$element.trigger("input").trigger("change");
                        ...
                        var option = $option[0];
                        if ("option" === option.tagName.toLowerCase()) data = {
                            id: $option.val(),
                            text: $option.text(),
                        ...
                        return null != (item = $.extend({}, {
                            text: ""
                        }, item)).id && (item.id = item.id.toString()), null != item.text && (item.text = item.text.toString()), null == item._resultId && item.id && null != this.container && (item._resultId = this.generateResultId(this.container, item)), $.extend({}, {
                            selected: !1,
                            disabled: !1
                        }, item)
                    ...
                    return Utils.Extend(ArrayAdapter, SelectAdapter), ArrayAdapter.prototype.bind = function(container, $container) {
                        ...
                        var self = this,
                            ...
                            existingIds = $existing.map(function() {
                    ...
                    return Utils.Extend(AjaxAdapter, ArrayAdapter), AjaxAdapter.prototype._applyDefaults = function(options) {
                        ...
                        function request() {
                            var $request = options.transport(options, function(data) {
                                ...
                                self.options.get("debug") && window.console && console.error && (results && results.results && Array.isArray(results.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), callback(results)
                            }, function() {
                    ...
                    return Tags.prototype.query = function(decorated, params, callback) {
                        var self = this;
                        this._removeOldTags(), null != params.term && null == params.page ? decorated.call(this, params, function wrapper(obj, child) {
                    ...
                    return Tokenizer.prototype.bind = function(decorated, container, $container) {
                        ...
                        tokenData.term !== params.term && (this.$search.length && (this.$search.val(tokenData.term), this.$search.trigger("focus")), params.term = tokenData.term), decorated.call(this, params, callback)
                    ...
                    return MaximumInputLength.prototype.query = function(decorated, params, callback) {
                        params.term = params.term || "", 0 < this.maximumInputLength && params.term.length > this.maximumInputLength ? this.trigger("results:message", {
                    ...
                    return MaximumSelectionLength.prototype.bind = function(decorated, container, $container) {
                        ...
                        this.current(function(currentData) {
                            ...
                            0 < self.maximumSelectionLength && count >= self.maximumSelectionLength ? self.trigger("results:message", {
                    ...
                    return Search.prototype.render = function(decorated) {
                        var $rendered = decorated.call(this),
                            ...
                            $search = $('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></span>');
                        return this.$searchContainer = $search, this.$search = $search.find("input"), this.$search.prop("autocomplete", this.options.get("autocomplete")), this.$search.attr("aria-label", searchLabel()), $rendered.prepend($search), $rendered
                    }, Search.prototype.bind = function(decorated, container, $container) {
                        var self = this,
                            resultsId = container.id + "-results";
                        decorated.call(this, container, $container), this.$search.on("keydown", function(evt) {
                            ...
                            self.$search.attr("tabindex", 0), self.$search.attr("aria-controls", resultsId), self.$search.trigger("focus"), window.setTimeout(function() {
                                self.$search.trigger("focus")
                            }, 0)
                        }), container.on("close", function() {
                            ...
                            null != params.query.term && "" !== params.query.term || (self.showSearch(params) ? self.$searchContainer[0].classList.remove("select2-search--hide") : self.$searchContainer[0].classList.add("select2-search--hide"))
                        }), container.on("results:focus", function(params) {
                            params.data._resultId ? self.$search.attr("aria-activedescendant", params.data._resultId) : self.$search.removeAttr("aria-activedescendant")
                        })
                    ...
                    return HidePlaceholder.prototype.append = function(decorated, data) {
                        ...
                        for (var modifiedData = data.slice(0), d = data.length - 1; 0 <= d; d--) {
                            var item = data[d];
                    ...
                    return InfiniteScroll.prototype.append = function(decorated, data) {
                        ...
                        if (!this.loading && isLoadMoreVisible) {
                            var currentOffset = this.$results.offset().top + this.$results.outerHeight(!1);
                            this.$loadingMore.offset().top + this.$loadingMore.outerHeight(!1) <= currentOffset + 50 && this.loadMore()
                        }
                    ...
                    return AttachBody.prototype.bind = function(decorated, container, $container) {
                        ...
                        $dropdown.attr("class", $container.attr("class")), $dropdown[0].classList.remove("select2"), $dropdown[0].classList.add("select2-container--open"), $dropdown.css({
                            position: "absolute",
                            top: -999999
                        ...
                        return $container.append($dropdown), this.$dropdownContainer = $container
                    ...
                    return MinimumResultsForSearch.prototype.showSearch = function(decorated, params) {
                        return !(function countResults(data) {
                            for (var count = 0, d = 0; d < data.length; d++) {
                                var item = data[d];
                                item.children ? count += countResults(item.children) : count++
                            }
                            return count
                        }(params.data.results) < this.minimumResultsForSearch) && decorated.call(this, params)
                    ...
                    return DropdownCSS.prototype.render = function(decorated) {
                        ...
                        return -1 !== dropdownCssClass.indexOf(":all:") && (dropdownCssClass = dropdownCssClass.replace(":all:", ""), Utils.copyNonInternalCssClasses($dropdown[0], this.$element[0])), $dropdown.addClass(dropdownCssClass), $dropdown
                    }, DropdownCSS
                }), S2.define("select2/dropdown/tagsSearchHighlight", ["../utils"], function(Utils) {
                    function TagsSearchHighlight() {}
                    return TagsSearchHighlight.prototype.highlightFirstItem = function(decorated) {
                    ...
                    return Defaults.prototype.apply = function(options) {
                        ...
                        this.defaults = {
                            ...
                            matcher: function matcher(params, data) {
                                ...
                                if (data.children && 0 < data.children.length) {
                                    for (var match = $.extend(!0, {}, data), c = data.children.length - 1; 0 <= c; c--) null == matcher(params, data.children[c]) && match.children.splice(c, 1);
                                    return 0 < match.children.length ? match : matcher(params, match)
                                }
                        ...
                        var optionLanguage = options.language,
                            ...
                            languages = Array.prototype.concat.call(this._resolveLanguage(elementLanguage), this._resolveLanguage(optionLanguage), this._resolveLanguage(defaultLanguage), this._resolveLanguage(parentLanguage));
                        ...
                        for (var resolvedLanguages = [], l = 0; l < languages.length; l++)
                            if (resolvedLanguages.push(languages[l]), "string" == typeof languages[l] && 0 < languages[l].indexOf("-")) {
                        ...
                        for (var translations = new Translation, l = 0; l < languages.length; l++) {
                            ...
                            if ("string" == typeof language) try {
                                ...
                                try {
                                    ...
                                    debug && window.console && console.warn && console.warn('Select2: The language file for "' + language + '" could not be automatically loaded. A fallback will be used instead.')
                                }
                    ...
                    function Options(options, $element) {
                        this.options = options, null != $element && this.fromElement($element), null != $element && (this.options = Defaults.applyFromElement(this.options, $element)), this.options = Defaults.apply(this.options)
                    }
                    return Options.prototype.fromElement = function($e) {
                        var excludedData = ["select2"];
                        null == this.options.multiple && (this.options.multiple = $e.prop("multiple")), null == this.options.disabled && (this.options.disabled = $e.prop("disabled")), null == this.options.autocomplete && $e.prop("autocomplete") && (this.options.autocomplete = $e.prop("autocomplete")), null == this.options.dir && ($e.prop("dir") ? this.options.dir = $e.prop("dir") : $e.closest("[dir]").prop("dir") ? this.options.dir = $e.closest("[dir]").prop("dir") : this.options.dir = "ltr"), $e.prop("disabled", this.options.disabled), $e.prop("multiple", this.options.multiple), Utils.GetData($e[0], "select2Tags") && (this.options.debug && window.console && console.warn && console.warn('Select2: The `data-select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of Select2.'), Utils.StoreData($e[0], "data", Utils.GetData($e[0], "select2Tags")), Utils.StoreData($e[0], "tags", !0)), Utils.GetData($e[0], "ajaxUrl") && (this.options.debug && window.console && console.warn && console.warn("Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of Select2."), $e.attr("ajax--url", Utils.GetData($e[0], "ajaxUrl")), Utils.StoreData($e[0], "ajax-Url", Utils.GetData($e[0], "ajaxUrl")));
                        var dataset = {};
                        ...
                        for (var key in data = Utils._convertData(data)) - 1 < excludedData.indexOf(key) || ($.isPlainObject(this.options[key]) ? $.extend(this.options[key], data[key]) : this.options[key] = data[key]);
                        return this
                    ...
                    var Select2 = function($element, options) {
                        null != Utils.GetData($element[0], "select2") && Utils.GetData($element[0], "select2").destroy(), this.$element = $element, this.id = this._generateId($element), options = options || {}, this.options = new Options(options, $element), Select2.__super__.constructor.call(this);
                        ...
                        }), $element[0].classList.add("select2-hidden-accessible"), $element.attr("aria-hidden", "true"), this._syncAttributes(), Utils.StoreData($element[0], "select2", this), $element.data("select2", this)
                    };
                    return Utils.Extend(Select2, Utils.Observable), Select2.prototype._generateId = function($element) {
                        ...
                        if ("style" != method) return "computedstyle" != method ? method : window.getComputedStyle($element[0]).width;
                        ...
                        for (var attrs = style.split(";"), i = 0, l = attrs.length; i < l; i += 1) {
                            ...
                            if (null !== matches && 1 <= matches.length) return matches[1]
                        }
                        return null
                        ...
                        this.$element.on("change.select2", function() {
                            ...
                            self.trigger("focus", evt)
                        }), this._syncA = Utils.bind(this._syncAttributes, this), this._syncS = Utils.bind(this._syncSubtree, this), this._observer = new window.MutationObserver(function(mutations) {
                        ...
                        if (mutations.addedNodes && 0 < mutations.addedNodes.length)
                            for (var n = 0; n < mutations.addedNodes.length; n++) {
                                ...
                                if (mutations.removedNodes && 0 < mutations.removedNodes.length) return !0;
                                if (Array.isArray(mutations)) return mutations.some(function(mutation) {
                        ...
                        var newVal = args[0];
                        Array.isArray(newVal) && (newVal = newVal.map(function(obj) {
                            return obj.toString()
                        })), this.$element.val(newVal).trigger("input").trigger("change")
                    }, Select2.prototype.destroy = function() {
                        Utils.RemoveData(this.$container[0]), this.$container.remove(), this._observer.disconnect(), this._observer = null, this._syncA = null, this._syncS = null, this.$element.off(".select2"), this.$element.attr("tabindex", Utils.GetData(this.$element[0], "old-tabindex")), this.$element[0].classList.remove("select2-hidden-accessible"), this.$element.attr("aria-hidden", "false"), Utils.RemoveData(this.$element[0]), this.$element.removeData("select2"), this.dataAdapter.destroy(), this.selection.destroy(), this.dropdown.destroy(), this.results.destroy(), this.dataAdapter = null, this.selection = null, this.dropdown = null, this.results = null
                    }, Select2.prototype.render = function() {
                        var $container = $('<span class="select2 select2-container"><span class="selection"></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>');
                        return $container.attr("dir", this.options.get("dir")), this.$container = $container, this.$container[0].classList.add("select2-container--" + this.options.get("theme")), Utils.StoreData($container[0], "element", this.$element), $container
                    }, Select2
                    ...
                    return AttachContainer.prototype.position = function(decorated, $dropdown, $container) {
                        $container.find(".dropdown-wrapper").append($dropdown), $dropdown[0].classList.add("select2-dropdown--below"), $container[0].classList.add("select2-container--below")
                    }, AttachContainer
                }), S2.define("select2/dropdown/stopPropagation", [], function() {
                    function StopPropagation() {}
                    return StopPropagation.prototype.bind = function(decorated, container, $container) {
                        decorated.call(this, container, $container);
                        this.$dropdown.on(["blur", "change", "click", "dblclick", "focus", "focusin", "focusout", "input", "keydown", "keyup", "keypress", "mousedown", "mouseenter", "mouseleave", "mousemove", "mouseover", "mouseup", "search", "touchend", "touchstart"].join(" "), function(evt) {
                            evt.stopPropagation()
                        })
                    }, StopPropagation
                    ...
                    return StopPropagation.prototype.bind = function(decorated, container, $container) {
                        decorated.call(this, container, $container);
                        this.$selection.on(["blur", "change", "click", "dblclick", "focus", "focusin", "focusout", "input", "keydown", "keyup", "keypress", "mousedown", "mouseenter", "mouseleave", "mousemove", "mouseover", "mouseup", "search", "touchend", "touchstart"].join(" "), function(evt) {
                            evt.stopPropagation()
                        })
                    }, StopPropagation
                }), factory = function($) {
                ...
                }, "function" == typeof S2.define && S2.define.amd ? S2.define("jquery-mousewheel", ["jquery"], factory) : "object" == typeof exports ? module.exports = factory : factory(jQuery), S2.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function($, _, Select2, Defaults, Utils) {
                    if (null == $.fn.select2) {
                        ...
                        $.fn.select2 = function(options) {
                            ...
                            if ("string" != typeof options) throw new Error("Invalid arguments for Select2: " + options);
    ...
    function($, window, document) {
        ...
        function MasterCarousel(target, options) {
            this.defaultOptions = {
                ...
                item: "basic",
                disablePlugins: []
            }, this.$element = "Array" == typeof target ? target : $(target), this.options = options, this.view = null, this.items = [], this.controls = [], this.plugins = [], averta.EventDispatcher.call(this)
        }
        MasterCarousel._plugins = [], MasterCarousel._views = {}, MasterCarousel._items = {}, MasterCarousel._controls = {}, MasterCarousel.registerPlugin = function(plugin) {
            -1 === MasterCarousel._plugins.indexOf(plugin) && MasterCarousel._plugins.push(plugin)
            ...
            MasterCarousel._controls[name] || (MasterCarousel._controls[name] = control)
        ...
        p.setup = function() {
            if (!this._setup) {
                this._setup = !0;
                var self = this;
                return $.each(MasterCarousel._plugins, function(index, plugin) {
                    self.plugins.push(new plugin(self))
                }), this.options = $.extend(this.defaultOptions, this.options), this._callPluginsMethod("aftereSetup"), $(document).ready(function() {
                    self._init()
                }), this
            }
        }, p.control = function(name, options) {
            var controlClass = MasterCarousel._controls[name];
            if (!controlClass) return console.log('Master Carousel Warning: The "' + name + '" UI control is not defined.'), this;
            ...
            if (this.view) return "perpage" === this.options.navigation ? this.view.page : this.view.index + 1
        }, p.index = function() {
            if (this.view) return this.view.index
        }, p.count = function() {
            if (this.view) return "perpage" === this.options.navigation ? this.view.totalPages : this.view.itemsCount
        }, p.items = function() {
            ...
            $.each(this.plugins, function(index, plugin) {
                ...
                control.destroy()
            }), this.plugins = null, this.controls = null, this.view.destroy(), this.view = null, this.$element.remove(), this.dispatchEvent(new MCEvents(MCEvents.DESTROY))
        }, p._init = function() {
            this._callPluginsMethod("beforeInit");
            var op = this.options,
                viewClass = MasterCarousel._views[op.view];
            viewClass || (console.log('Master Carousel Error: The "' + op.view + '" view is not defined in carousel.'), viewClass = MasterCarousel._views.basic), this.view = new viewClass(op), this.$element.find(">." + op.itemClass).each(this._addItem.bind(this)), $.each(this.controls, function(index, control) {
                control.view = self.view, control.carousel = self, control.setup()
            }), this.$element.append(this.view.$element), this.view.init(), this._callPluginsMethod("afterInit"), this._readOptions(), this.dispatchEvent(new MCEvents(MCEvents.INIT))
            ...
            itemClass || (console.log('Master Carousel Error: The "' + itemType + '" item is not defined in carousel.'), itemClass = MasterCarousel._items.basic);
            var item = new itemClass($element, this.view);
            (item.carousel = this).items.push(item), this.view.appendItem(item), item.setup()
        ...
        p.appendItem = function(item) {
            ...
            if ("perpage" !== this.options.navigation)
                if (this.options.loop) {
                    ...
                    targetIndex < 0 && (targetIndex += this.itemsCount), this.gotoItem(targetIndex, !1 !== animate, speed || this.scroller.options.friction)
                } else 0 <= this.index - 1 ? this.gotoItem(this.index - 1, !1 !== animate, speed || this.scroller.options.friction) : !1 !== bounce && this.scroller.bounce(-10);
            else this.scroller.prevSnap(!1 !== animate, speed || this.scroller.options.friction)
        }, p.goto = function(target, animate, speed) {
            if ("perpage" === this.options.navigation) {
            ...
            this.$container.remove(), this.$element.remove(), this.scroller.destroy(), this.swipeController = null, this.items = null, this.currentItem = null, this.options = null, $(window).off("resize", this._resize)
        }, p._resize = function(update) {
            var self = this;
            self.width = self.$element.width(), self.height = self.$element.height(), self.oneColumnSize = self[self._dimension] / self.options.columns, clearTimeout(self._resizeDelay), !1 !== update && (self._resizeDelay = setTimeout(function() {
                self._updateView(), self.gotoItem(self.index)
            }, this.resizeDelayTime)), this.dispatchEvent(new MCEvents(MCEvents.RESIZE))
        }, p._readOptions = function() {
            var op = this.options;
            "h" === op.dir ? (this._dimension = "width", this._offset = "left", this._transAxis = "translateX") : (this._dimension = "height", this._offset = "top", this._transAxis = "translateY"), this._resize(!1);
            var so = this.scroller.options;
            "scroll" === op.navigation ? (so.paging = !1, so.snapping = !1) : (so.snapping = !0, so.paging = "snapping" !== op.navigation, "perpage" === op.navigation && (so.snapsize = this[this._dimension] + this.options.space)), so.endless = op.loop, so.friction = (100 - .5 * op.speed) / 100, so.snappingMinSpeed = op.minSnappingSpeed, op.swipe && (window._touch || op.mouseSwipe) ? (this.swipeController ? this.swipeController.enable() : (this.swipeController = new averta.TouchSwipe(this.$element), this.swipeController.onSwipe = this._swipeMove.bind(this)), "h" === op.dir ? (this.swipeController.swipeType = "horizontal", this._swipeMoveDir = "moveX", this._swipeMoveDistance = "distanceX", this._scrollTransitin = "") : (this.swipeController.swipeType = "vertical", this._swipeMoveDir = "moveY", this._swipeMoveDistance = "distanceY")) : this.swipeController && this.swipeController.disable(), this._balancingItems = Math.floor(op.columns / 2), op.rtl && (this._offset = "right", this._reverse = -1), this._firstInit || this._resetItems(), this._updateView(), this._initilized && this._reset(), this.totalPages = Math.ceil(this.itemsCount / op.columns), this.gotoItem(op.startItem - 1), this._findActiveItems(), this.scroller.cancel(), this._firstInit = !1
        }, p._resetItems = function() {
            for (var item, i = 0, l = this.items.length; i !== l; i++)(item = this.items[i]).position = 0, item.$element.attr("style", "")
        }, p._setupItem = function(item) {
            item.view = this, item.$container = this.$container, item.size = 0, item.position = 0, item.sleep()
        }, p._updateView = function() {
            var item, l = this.items.length,
                before = 0,
                op = this.options,
                space = op.space,
                middle = 0;
            this.itemsCount = l, this.currentItem || (this.currentItem = this.items[0]), "perpage" === op.navigation && (this.scroller.options.snapsize = this[this._dimension] + op.space), op.loop && (middle = Math.ceil(l / 2) + this.index + this._balancingItems);
            for (var i = 0; i !== l; i++)(item = this.items[(i + middle) % l]).position = before, item.size = (this[this._dimension] - space * (op.columns - 1)) * (item.merge / op.columns) + space * (item.merge - 1), before += item.size + space;
            var middlePosition = this.currentItem.position;
            for (op.loop || (this.scroller._max_value = before - space - this[this._dimension], middlePosition = 0, this._spaceBuffer = 0, op.center && (this.scroller._max_value = before - this[this._dimension] / 2 + this.items[0].size)), i = 0; i !== l; i++)(item = this.items[i]).position = this._spaceBuffer + item.position - middlePosition, item.$element[0].style[this._offset] = item.position + "px", item.$element[0].style[this._dimension] = item.size + "px"
            ...
            this._updateView(), this.scroller.changeTo(this.currentItem.position + diff, !1, null, null, !1)
        }, p._findActiveItems = function() {
            var item;
            this.activeItems = [];
            for (var i = 0; i !== this.itemsCount; i++)(item = this.items[i]).position < this.scroller.value + this[this._dimension] && item.position + item.size > this.scroller.value ? (item.active(), this.activeItems.push(item)) : item.inactive();
            for (i = 0; i !== this.itemsCount; i++) this.items[i].inactive(i);
            for (i = 0; i !== this.activeItems.length; i++) this.activeItems[i].active(i)
        }, p._onSnappingCompelet = function(snap, type) {
            this.options.loop && this._reset(), this.dispatchEvent(new MCEvents(MCEvents.CHANGE_END))
        }, p._onSnappingUpdate = function(scroller, snap, change) {}, p._scroll = function(scroller, value) {
            var op = this.options,
                loop = op.loop,
                currentItemIndex = this._findItemIndexAtValue(value, !0),
                steps = this._getShortestPath(currentItemIndex);
            if (0 !== steps && (this.index = currentItemIndex, this.currentItem = this.items[this.index], this.page = Math.floor(this.index / this.options.columns) + 1, loop)) {
                for (var i = 0, l = Math.min(Math.abs(steps), Math.floor(this.itemsCount / 2)); i < l; i++)
                    if (0 < steps) {
                        var index = this.index - i - 1;
                        index < 0 && (index = this.itemsCount + index), this._spaceBuffer += this.items[index].size + this.options.space
                    } else this._spaceBuffer -= this.items[(this.index + i) % this.itemsCount].size + this.options.space;
                this._updateView()
            }
            op.center && (value -= (this[this._dimension] - this.items[0].size) / 2), this._css3 ? this.$container[0].style[window._jcsspfx + "Transform"] = this._transAxis + "(" + -value * this._reverse + "px)" + this._translatePostfix : this.$container[0].style[this._offset] = -value + "px", this._findActiveItems(), this.dispatchEvent(new MCEvents(MCEvents.SCROLL))
        }, p._findItemIndexAtValue = function(value, fromMiddle) {
            for (var item, size, i = 0, l = this.itemsCount; i !== l; i++)
                if (item = this.items[i], size = fromMiddle ? this.oneColumnSize / 2 : 0, item.position - size <= value && item.position + item.size + this.options.space - size > value) return i;
            return this.index
        }, p._getSnapNum = function(value) {
            var op = this.options;
            return "perpage" === op.navigation || "scroll" === op.navigation ? Math.floor((value + this.scroller.options.snapsize / 2) / this.scroller.options.snapsize) : this._findItemIndexAtValue(value, !0)
        }, p._gotoSnap = function(snapNum, animate, speed) {
            var scroller = this.scroller,
                op = this.options;
            if ("perpage" === op.navigation || "scroll" === op.navigation) scroller.changeTo(snapNum * scroller.options.snapsize, animate, speed, snapNum);
            else {
                var loop = this.options.loop,
                    count = this.itemsCount;
                snapNum < 0 ? snapNum = loop ? count + snapNum : 0 : !loop && count <= snapNum && (snapNum = count - 1), scroller.changeTo(this.items[snapNum % this.itemsCount].position, animate, speed, snapNum)
            }
        }, p._calculateExtraMove = function(value) {
            var snapsize, m, op = this.options;
            this.scroller;
            if ("perpage" === op.navigation || "scroll" === op.navigation) m = value % (snapsize = scroller.options.snapsize);
            else {
                op.loop && (value = this.currentItem.position + value - this._spaceBuffer);
                var item = this.items[this._findItemIndexAtValue(value, !0)];
                snapsize = item.size + op.space, m = this._spaceBuffer + value - item.position
            }
            return m < snapsize / 2 ? -m : snapsize - m
        }, p._swipeMove = function(status) {
            var phase = status.phase;
            if ("start" === phase) this.scroller.stop(), this.dispatchEvent(new MCEvents(MCEvents.SWIPE_START, status));
            else if ("move" === phase) this.scroller.drag(status[this._swipeMoveDir] * this._reverse), this.dispatchEvent(new MCEvents(MCEvents.SWIPE_MOVE, status));
            else if ("end" === phase || "cancel" === phase) {
                var speed = status[this._swipeMoveDistance] / status.duration * 50 / 3;
                .1 < Math.abs(speed) ? (this.scroller.push(-speed * this._reverse), speed > this.scroller.options.snappingMinSpeed && this.dispatchEvent(new MCEvents(MCEvents.SWIPE_END, status))) : (this.scroller.cancel(), this.dispatchEvent(new MCEvents(MCEvents.SWIPE_CANCEL, status)))
            }
        }, averta.EventDispatcher.extend(p), MasterCarousel.registerView("basic", CarouselView)
    }(jQuery, window, document),
    function() {
        "use strict";

        function item($element, view) {
            this.$element = $element, this.view = view, this.merge = $element.data("merge") || 1
        }
        var p = item.prototype;
        p.sleep = function() {
            this.detached || (this.$element.detach(), this.detached = !0)
        }, p.wakeup = function() {
            this.detached && (this.view.$container.append(this.$element), this.detached = !1)
        }, p.setup = function() {
            this.view.$container.append(this.$element)
        }, p.active = function(counter) {
            this.$element.addClass("mc-item-active"), counter && this.$element.addClass("mc-item-active" + counter)
        }, p.inactive = function(counter) {
            this.$element.removeClass("mc-item-active"), counter && this.$element.removeClass("mc-item-active" + counter)
        }, p.destroy = function() {
    ...
    function() {
        ...
        function inViewController(carousel) {
            this.carousel = carousel, this.carousel.defaultOptions.inView = 10, this.carousel.defaultOptions.inViewMargin = 30
        }
        var p = inViewController.prototype;
        p.readOptions = function() {
            this.disabled = this.carousel.view.itemsCount <= this.carousel.options.inView, this.disabled ? (this._reset(), this.carousel.view.removeEventListener(MCEvents.SCROLL, this._onScroll, this)) : (this.carousel.view.addEventListener(MCEvents.SCROLL, this._onScroll, this), this._onScroll())
        }, p.destroy = function() {
            this.carousel.view && this.carousel.view.removeEventListener(MCEvents.SCROLL, this._onScroll, this), this.carousel = null
        }, p._onScroll = function() {
            for (var item, view = this.carousel.view, items = view.items, scrollerVal = view.scroller.value, viewSize = view[view._dimension], margin = viewSize * this.carousel.options.inViewMargin / 100, i = 0; i !== view.itemsCount; i++)(item = items[i]).position + item.size >= scrollerVal - margin && item.position < viewSize + margin + scrollerVal ? item.wakeup() : item.sleep()
        }, p._reset = function() {
            for (var view = this.carousel.view, i = 0; i !== view.itemsCount; i++) view.items[i].wakeup()
    ...
    function($) {
        ...
        function Autoplay(carousel) {
            this.carousel = carousel, $.extend(this.carousel.defaultOptions, {
                autoplay: !1,
                pauseOnHover: !0,
                autoplayDelay: 2
            }), this.timer = new averta.Timer(100), this.timer.onTimer = this._onTimer, (this.timer.refrence = this)._delayProgress = 0, this._id = pluginId++, this.carousel.pause = function() {
                this.options.autoplay && (this.setOptions({
                    autoplay: !1
        ...
        p.afterInit = function() {
            ...
            var op = this.carousel.options,
                self = this;
            op.autoplay ? (this.view.addEventListener(MCEvents.SWIPE_START, this._stopTimer, this), this.view.addEventListener(MCEvents.CHANGE_END, this._onChangeEnd, this), this._startTimer(), op.pauseOnHover ? this.carousel.$element.on("mouseenter.mc-timer-" + this._id, function() {
            ...
            }) : this.carousel.$element.off("mouseenter.mc-timer-" + this._id, "mouseleave.mc-timer-" + this._id)) : (this.view.removeEventListener(MCEvents.SWIPE_START, this._stopTimer, this), this.view.removeEventListener(MCEvents.CHANGE_END, this._onChangeEnd, this), this.carousel.$element.off("mouseenter.mc-timer-" + this._id, "mouseleave.mc-timer-" + this._id), this._resetTimer(), this._stopTimer()), this._delayProgress = 0
        }, p.destroy = function() {
            this.view.removeEventListener(MCEvents.SWIPE_START, this._stopTimer, this), this.view.removeEventListener(MCEvents.CHANGE_END, this._onChangeEnd, this), this.carousel.$element.off("mouseenter.mc-timer-" + this._id, "mouseleave.mc-timer-" + this._id), this._resetTimer(), this._stopTimer(), this.view = null, this.carousel = null
        }, p._onChangeEnd = function() {
            this.carousel.options.autoplay && this._startTimer()
        }, p._startTimer = function() {
            var op = this.carousel.options;
            !this._mouseIsOver && (op.loop || this.view.index + op.columns < this.view.itemsCount) && this.timer.start()
        }, p._stopTimer = function() {
            this.timer.stop()
        }, p._onTimer = function() {
            var time = this.timer.getTime();
            this._delayProgress = time / (10 * this.carousel.options.autoplayDelay), time >= 1e3 * this.carousel.options.autoplayDelay && (this.carousel.next(), this._resetTimer()), this.carousel.dispatchEvent(new MCEvents(MCEvents.WAITING))
    ...
    function($, window) {
        ...
        function BetterResponsive(carousel) {
            this.carousel = carousel, this.$window = $(window), this._activePos = 0, $.extend(this.carousel.defaultOptions, {
                autoWidth: !1
            })
        }
        ...
        p.afterInit = function() {
            ...
            if (this._internalChange) this._internalChange = !1;
                ...
                var op = this.carousel.options;
                this._copyOptions = $.extend({}, op), op.autoWidth ? this.$window.off("resize", this._onResize) : op.responsive && (this.$window.on("resize", this._onResize.bind(this)), this._onResize())
            }
        }, p.destroy = function() {
            this.$window.off("resize", this._onResize), this.view = null, this.carousel = null, this.$window = null
        }, p._onResize = function() {
            var pos, respOptions, lastPos, op = this.carousel.options,
                size = this.$window[this.view._dimension]();
            for (var key in op.responsive) size <= (pos = Number(key)) && (!lastPos || pos < lastPos) && (respOptions = op.responsive[key], lastPos = pos);
            respOptions && this._activePos !== lastPos ? (this._internalChange = !0, this._activePos = lastPos, this.carousel.setOptions($.extend({}, this._copyOptions, respOptions))) : !respOptions && this._activePos && (this._internalChange = !0, this.carousel.setOptions(this._copyOptions), this._activePos = null)
    ...
    function($) {
        ...
        p.readOptions = function() {
            this.carousel.options.preload ? (this.carousel.options.insertPreloadClass && this.carousel.$element.find("." + this.carousel.options.itemClass).addClass("mc-preloading"), this.carousel.view.addEventListener(MCEvents.SCROLL, this._onScroll, this), this._onScroll()) : this.carousel.view.removeEventListener(MCEvents.SCROLL, this._onScroll, this)
        }, p.destroy = function() {
            this.carousel.view && this.carousel.view.removeEventListener(MCEvents.SCROLL, this._onScroll, this), this.carousel = null
        }, p._onScroll = function() {
            for (var item, actives = this.carousel.view.activeItems, i = 0, l = actives.length; i !== l; i++)(item = actives[i]).preloading || this._startPreloadItem(item)
            ...
            0 !== preloadCount ? imgs.each(function(index) {
                var $this = $(this);
                $this.preloadImg($this.attr(attr), function(event) {
                    0 === --preloadCount && item.$element.removeClass("mc-preloading")
                }).removeAttr(attr)
    ...
    function($, window) {
        ...
        function HeightController(carousel) {
            this.carousel = carousel, this.carousel.defaultOptions.autoHeight = !1, this.carousel.defaultOptions.emptyHeight = 450, this._maxHeight = 0
        }
        var p = HeightController.prototype;
        p.afterInit = function() {
            for (var items = this.carousel.view.items, i = 0, l = items.length; i !== l; i++) items[i].$element.find("img").on("load", this._updateHeight.bind(this));
            $(window).on("resize", this._updateHeight.bind(this)), this._updateHeight({
                type: "resize"
            })
        }, p.readOptions = function() {
            this.autoHeight = this.carousel.options.autoHeight, this.autoHeight ? (this.carousel.view.addEventListener(MCEvents.SCROLL, this._updateHeight, this), this._maxHeight = 0, this._updateHeight()) : this.carousel.view.removeEventListener(MCEvents.SCROLL, this._updateHeight, this)
        }, p.destroy = function() {
            this.carousel.view && this.carousel.view.removeEventListener(MCEvents.SCROLL, this._updateHeight, this);
            for (var items = this.carousel.view.items, i = 0, l = items.length; i !== l; i++) items[i].$element.find("img").off("load");
            $(window).off("resize", this._updateHeight), this.carousel = null
        }, p._updateHeight = function(e) {
            clearTimeout(this._resizeTo), e && "resize" === e.type && (this._resizeTo = setTimeout(this._updateHeight.bind(this), 150));
            for (var items = this.carousel.options.autoHeight ? this.carousel.view.activeItems : this.carousel.view.items, oldHeight = this._maxHeight, i = this._maxHeight = 0, l = items.length; i !== l; i++) this._maxHeight = Math.max(items[i].$element.height(), this._maxHeight);
            0 === this._maxHeight && (this._maxHeight = this.carousel.options.emptyHeight), this.carousel.$element[0].style.height = this._maxHeight + "px", oldHeight !== this._maxHeight && this.carousel.dispatchEvent(new MCEvents(MCEvents.HEIGHT_CHANGE))
    ...
    function($, window) {
        ...
        function autoScrollController(carousel) {
            this.carousel = carousel, this.carousel.defaultOptions.autoScroll = !1, this.carousel.defaultOptions.autoScrollSpeed = 1
        }
        var p = autoScrollController.prototype;
        p.readOptions = function() {
            this._scroll = this._scroll.bind(this), $.extend(this.carousel, {
                startAutoScroll: function() {
                    this._stop && (this._stop = !1, this.carousel.view.addEventListener(MCEvents.SWIPE_START, this._onSwipe, this), this.carousel.view.addEventListener(MCEvents.CHANGE_END, this._onSwipe, this), this.carousel.view.addEventListener(MCEvents.SWIPE_END, this._onSwipe, this), this.carousel.view.addEventListener(MCEvents.SWIPE_CANCEL, this._onSwipe, this), this._scroll())
                }.bind(this),
                stopAutoScroll: function() {
                    this._stop || (this._stop = !0, this.carousel.view.removeEventListener(MCEvents.SWIPE_START, this._onSwipe, this), this.carousel.view.removeEventListener(MCEvents.CHANGE_END, this._onSwipe, this), this.carousel.view.removeEventListener(MCEvents.SWIPE_END, this._onSwipe, this), this.carousel.view.removeEventListener(MCEvents.SWIPE_CANCEL, this._onSwipe, this))
                }.bind(this)
            }), this.carousel.options.autoScroll ? this.carousel.startAutoScroll() : this.carousel.stopAutoScroll()
        }, p.destroy = function() {
            this.carousel.view && (this.carousel.view.removeEventListener(MCEvents.SWIPE_START, this._onSwipe, this), this.carousel.view.removeEventListener(MCEvents.SWIPE_END, this._onSwipe, this), this.carousel.view.removeEventListener(MCEvents.SWIPE_CANCEL, this._onSwipe, this), this.carousel.view.removeEventListener(MCEvents.CHANGE_END, this._onSwipe, this)), this.carousel = null
        }, p._onSwipe = function(event) {
            var oldState = this._stop;
            this._stop = event.type === MCEvents.SWIPE_START, this._stop || this._stop === oldState || this._scroll()
        }, p._scroll = function() {
            this._stop || window.requestAnimationFrame(this._scroll), this.carousel.view.scroller.drag(-this.carousel.options.autoScrollSpeed)
    ...
    function($, window) {
        if (window.MasterMenuPlugin && window.CTween) {
            var p = MasterMenuPlugin.prototype,
                superInit = p.init;
            p.init = function() {
                superInit.apply(this, arguments), !1 !== this.settings.toggleAnimation && (this.$element.on("typeChanged", this._checkForToggle.bind(this)), this.settings.toggleAnimationDuration = this.settings.toggleAnimationDuration || 600, this._checkForToggle())
            }, p._checkForToggle = function() {
                "toggle" === this.type || "accordion" === this.type ? (this.$element.on("beforeOpen", this._openAnimate.bind(this)), this.$element.on("beforeClose", this._closeAnimate.bind(this))) : (this.$element.off("beforeOpen beforeClose"), this.$element.find(".aux-submenu").css("height", ""))
            }, p._openAnimate = function(e) {
                var $submenu = e.item.find(">.aux-submenu").eq(0),
                    lastTween = $submenu.data("tween");
                subHeight = 0, $submenu.find(">*").each(function(index, item) {
                    subHeight += $(item).outerHeight()
                }), lastTween && lastTween.stop(!0), lastTween = CTween.animate($submenu, this.settings.toggleAnimationDuration, {
                    height: subHeight + "px"
                }, {
                    ease: "easeInOutQuart",
                    complete: function() {
                ...
                var $submenus = e.item.find(">.aux-submenu"),
                    ...
                    self = this;
                lastTween && lastTween.stop(!0), $submenus.each(function(index, submenu) {
                    var subHeight = 0;
                    $(submenu).find(">*").each(function(index, item) {
                        subHeight = $(item).outerHeight()
                    }), 0 !== $(submenu).height() && ($(submenu).height(subHeight), lastTween = CTween.animate($(submenu), self.settings.toggleAnimationDuration, {
                        height: "0"
                    }, {
                        ease: "easeInOutQuart",
                        complete: function() {
    ...
    function() {
        ...
        if ("undefined" != typeof window) {
            ...
            if ("objectFit" in document.documentElement.style != 0 && !e) return window.objectFitPolyfill = function() {
                return !1
            };
            var o = function(t, e, i) {
                    ...
                    return n === l || o === l ? void(e.style[l] = "0") : n === a || o === a ? void(e.style[a] = "0") : "center" === n || "50%" === n ? (e.style[l] = "50%", void(e.style["margin-" + l] = d / -2 + "px")) : 0 <= n.indexOf("%") ? void((n = parseInt(n)) < 50 ? (e.style[l] = n + "%", e.style["margin-" + l] = d * (n / -100) + "px") : (n = 100 - n, e.style[a] = n + "%", e.style["margin-" + a] = d * (n / -100) + "px")) : void(e.style[l] = n)
                },
                l = function(t) {
                    ...
                    }(t), t.style.position = "absolute", t.style.height = "100%", t.style.width = "auto", "scale-down" === e && (t.style.height = "auto", t.clientWidth < a.clientWidth && t.clientHeight < a.clientHeight ? (o("x", t, l), o("y", t, l)) : (e = "contain", t.style.height = "100%")), "none" === e ? (t.style.width = "auto", t.style.height = "auto", o("x", t, l), o("y", t, l)) : "cover" === e && t.clientWidth > a.clientWidth || "contain" === e && t.clientWidth < a.clientWidth ? (t.style.top = "0", t.style.marginTop = "0", o("x", t, l)) : "scale-down" !== e && (t.style.width = "100%", t.style.height = "auto", t.style.left = "0", t.style.marginLeft = "0", o("y", t, l))
                },
                a = function(t) {
                    ...
                    for (var i = 0; i < t.length; i++)
                        if (t[i].nodeName) {
                            ...
                            "img" !== n || e ? "video" === n && (0 < t[i].readyState ? l(t[i]) : t[i].addEventListener("loadedmetadata", function() {
                                l(this)
    ...
    function() {
        ...
        function createsStackingContext(el) {
            for (; el && el !== document.body;) {
                ...
                if (s.opacity < 1 || invalid("zIndex", "auto") || invalid("transform", "none") || invalid("mixBlendMode", "normal") || invalid("filter", "none") || invalid("perspective", "none") || "isolate" === s.isolation || "fixed" === s.position || "touch" === s.webkitOverflowScrolling) return !0;
                el = el.parentElement
            }
            return !1
        }
        ...
        function isFormMethodDialog(el) {
            return !(!el || !el.hasAttribute("method")) && "dialog" === el.getAttribute("method").toLowerCase()
        }

        function dialogPolyfillInfo(dialog) {
            if (this.dialog_ = dialog, this.replacedStyleTop_ = !1, this.openAsModal_ = !1, dialog.hasAttribute("role") || dialog.setAttribute("role", "dialog"), dialog.show = this.show.bind(this), dialog.showModal = this.showModal.bind(this), dialog.close = this.close.bind(this), "returnValue" in dialog || (dialog.returnValue = ""), "MutationObserver" in window) {
                ...
                function delayModel(ev) {
                    if (ev.target === dialog) {
                        ...
                        removed |= ev.type.substr(0, cand.length) === cand, window.clearTimeout(timeout), timeout = window.setTimeout(cb, 0)
                    }
                }
                var timeout, removed = !1,
                    cb = function() {
                        removed ? this.downgradeModal() : this.maybeHideModal(), removed = !1
                    }.bind(this);
        ...
        supportCustomEvent && "object" != typeof supportCustomEvent || ((supportCustomEvent = function(event, x) {
            x = x || {};
            var ev = document.createEvent("CustomEvent");
            return ev.initCustomEvent(event, !!x.bubbles, !!x.cancelable, x.detail || null), ev
        }).prototype = window.Event.prototype), dialogPolyfillInfo.prototype = {
            get dialog() {
                return this.dialog_
            },
            ...
            downgradeModal: function() {
                this.openAsModal_ && (this.openAsModal_ = !1, this.dialog_.style.zIndex = "", this.replacedStyleTop_ && (this.dialog_.style.top = "", this.replacedStyleTop_ = !1), this.backdrop_.parentNode && this.backdrop_.parentNode.removeChild(this.backdrop_), dialogPolyfill.dm.removeDialog(this))
            },
            setOpen: function(value) {
                value ? this.dialog_.hasAttribute("open") || this.dialog_.setAttribute("open", "") : (this.dialog_.removeAttribute("open"), this.maybeHideModal())
            },
            backdropClick_: function(e) {
                if (this.dialog_.hasAttribute("tabindex")) this.dialog_.focus();
                else {
                    var fake = document.createElement("div");
                    this.dialog_.insertBefore(fake, this.dialog_.firstChild), fake.tabIndex = -1, fake.focus(), this.dialog_.removeChild(fake)
                }
                var redirectedEvent = document.createEvent("MouseEvents");
                redirectedEvent.initMouseEvent(e.type, e.bubbles, e.cancelable, window, e.detail, e.screenX, e.screenY, e.clientX, e.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, e.button, e.relatedTarget), this.dialog_.dispatchEvent(redirectedEvent), e.stopPropagation()
            },
            focus_: function() {
                var target = this.dialog_.querySelector("[autofocus]:not([disabled])");
                if (!target && 0 <= this.dialog_.tabIndex && (target = this.dialog_), !target) {
            ...
            showModal: function() {
                ...
                createsStackingContext(this.dialog_.parentElement) && console.warn("A dialog is being shown inside a stacking context. This may cause it to be unusable. For more information, see this link: https://github.com/GoogleChrome/dialog-polyfill/#stacking-context"), this.setOpen(!0), this.openAsModal_ = !0, dialogPolyfill.needsCentering(this.dialog_) ? (dialogPolyfill.reposition(this.dialog_), this.replacedStyleTop_ = !0) : this.replacedStyleTop_ = !1, this.dialog_.parentNode.insertBefore(this.backdrop_, this.dialog_.nextSibling), this.focus_()
            },
            close: function(opt_returnValue) {
                ...
                this.setOpen(!1), void 0 !== opt_returnValue && (this.dialog_.returnValue = opt_returnValue);
        ...
        var dialogPolyfill = {
            ...
            needsCentering: function(dialog) {
                return "absolute" === window.getComputedStyle(dialog).position && (!("auto" !== dialog.style.top && "" !== dialog.style.top || "auto" !== dialog.style.bottom && "" !== dialog.style.bottom) && !dialogPolyfill.isInlinePositionSetByStylesheet(dialog))
            },
            forceRegisterDialog: function(element) {
                if ((window.HTMLDialogElement || element.showModal) && console.warn("This browser already supports <dialog>, the polyfill may not work correctly", element), "dialog" !== element.localName) throw new Error("Failed to register dialog: The element is not a dialog.");
            ...
            DialogManager: function() {
                ...
                }.bind(this)), this.handleKey_ = this.handleKey_.bind(this), this.handleFocus_ = this.handleFocus_.bind(this), this.zIndexLow_ = 1e5, this.zIndexHigh_ = 100150, this.forwardTab_ = void 0, "MutationObserver" in window && (this.mo_ = new MutationObserver(function(records) {
                    var removed = [];
                    records.forEach(function(rec) {
                        for (var c, i = 0; c = rec.removedNodes[i]; ++i) c instanceof Element && ("dialog" === c.localName && removed.push(c), removed = removed.concat(c.querySelectorAll("dialog")))
                    }), removed.length && checkDOM(removed)
                }))
            }
        };
        if (dialogPolyfill.DialogManager.prototype.blockDocument = function() {
                ...
                for (var dpi, zIndex = this.zIndexHigh_, i = 0; dpi = this.pendingDialogStack[i]; ++i) dpi.updateZIndex(--zIndex, --zIndex), 0 === i && (this.overlay.style.zIndex = --zIndex);
                var last = this.pendingDialogStack[0];
                last ? (last.dialog.parentNode || document.body).appendChild(this.overlay) : this.overlay.parentNode && this.overlay.parentNode.removeChild(this.overlay)
                ...
                if (!this.containedByTopDialog_(event.target) && (event.preventDefault(), event.stopPropagation(), safeBlur(event.target), void 0 !== this.forwardTab_)) {
                    var dpi = this.pendingDialogStack[0];
                    return dpi.dialog.compareDocumentPosition(event.target) & Node.DOCUMENT_POSITION_PRECEDING && (this.forwardTab_ ? dpi.focus_() : document.documentElement.focus()), !1
                }
                ...
                this.pendingDialogStack.slice().forEach(function(dpi) {
                    -1 !== removed.indexOf(dpi.dialog) ? dpi.downgradeModal() : dpi.maybeHideModal()
                })
            }, dialogPolyfill.DialogManager.prototype.pushDialog = function(dpi) {
                var allowed = (this.zIndexHigh_ - this.zIndexLow_) / 2 - 1;
                return !(this.pendingDialogStack.length >= allowed) && (1 === this.pendingDialogStack.unshift(dpi) && this.blockDocument(), this.updateStacking(), !0)
            }, dialogPolyfill.DialogManager.prototype.removeDialog = function(dpi) {
                var index = this.pendingDialogStack.indexOf(dpi); - 1 !== index && (this.pendingDialogStack.splice(index, 1), 0 === this.pendingDialogStack.length && this.unblockDocument(), this.updateStacking())
            }, dialogPolyfill.dm = new dialogPolyfill.DialogManager, dialogPolyfill.formSubmitter = null, dialogPolyfill.useValue = null, void 0 === window.HTMLDialogElement) {
            var testForm = document.createElement("form");
            if (testForm.setAttribute("method", "dialog"), "dialog" !== testForm.method) {
                ...
                if (methodDescriptor) {
                    ...
                    methodDescriptor.set = function(v) {
                        return "string" == typeof v && "dialog" === v.toLowerCase() ? this.setAttribute("method", v) : realSet.call(this, v)
                    }, Object.defineProperty(HTMLFormElement.prototype, "method", methodDescriptor)
                }
            }
            document.addEventListener("click", function(ev) {
                if (dialogPolyfill.formSubmitter = null, dialogPolyfill.useValue = null, !ev.defaultPrevented) {
                    var target = ev.target;
                    if (target && isFormMethodDialog(target.form)) {
                        if (!("submit" === target.type && -1 < ["button", "input"].indexOf(target.localName))) {
                            if ("input" !== target.localName || "image" !== target.type) return;
                            dialogPolyfill.useValue = ev.offsetX + "," + ev.offsetY
                        }
                        findNearestDialog(target) && (dialogPolyfill.formSubmitter = target)
                    }
                }
            }, !1);
            ...
            HTMLFormElement.prototype.submit = function() {
                ...
                if (isFormMethodDialog(form)) {
                    ...
                    if (dialog) {
                        ...
                        s && s.form === form ? dialog.close(dialogPolyfill.useValue || s.value) : dialog.close(), dialogPolyfill.formSubmitter = null
                    }
                }
            }, !0)
        }
        dialogPolyfill.forceRegisterDialog = dialogPolyfill.forceRegisterDialog, dialogPolyfill.registerDialog = dialogPolyfill.registerDialog, "function" == typeof define && "amd" in define ? define(function() {
            return dialogPolyfill
        }) : "object" == typeof module && "object" == typeof module.exports ? module.exports = dialogPolyfill : window.dialogPolyfill = dialogPolyfill
    }();
