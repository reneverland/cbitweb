...
(function($, window, document, undefined) {
    ...
    $(window).on('elementor/frontend/init', function() {
        ...
        if (elementorFrontend.isEditMode()) {
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/aux_video.default', function($scope) {
                window.wp.mediaelement.initialize()
            });
            elementorFrontend.hooks.addAction('frontend/element_ready/aux_audio.default', function($scope) {
                window.wp.mediaelement.initialize()
            });
            ...
            elementorFrontend.hooks.addAction('frontend/element_ready/aux_recent_portfolios_grid.default',
                function($scope) {
                    $.fn.AuxinIsotopeLayoutInit($('body'));
                }
            );
