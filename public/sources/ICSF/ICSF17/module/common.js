...
var i18n_header_footer = {
	'en-us': {
		'issf': 'Intercollegiate Conference on Smart Finance 2017',
		'home': 'Home',
		'about': 'About',
		...
		'host': 'hosts',
		'contact': 'Secretariat of ICSF 2017',
...
var generateHeaderFrame = function() {
	return  '<div class="container">'+
			...
			'					<a title="Intercollegiate Conference on Smart Finance 2017" href="index.html">' + 
			'						ICSF 2017' + 
			'					</a>' + 
			'				</div>' + 
			'			</div>' + 
...
var generateFooterFrame = function() {
	return  '<div class="container">' + 
			'	<div class="row">' + 
			'		Email <a href="mailto:ICSF2017@163.com">ICSF2017@163.com</a>/ ' + 
			'		<a href="guide.html#map" target="_blank" style="text-decoration:none;">Conference Address</a>/ ' + 
			'		Copyright © 2017 <span>SYSU</span> All rights reserved. ' + 
			'	</div>' + 
			'</div>';
};
...
var generateFooter = function(p_locale) {
	...
	var html_text = i18n_header_footer[p_locale]['email'] + 
					'&nbsp;&nbsp;<a href="mailto:ICSF2017@163.com">ICSF2017@163.com</a>&nbsp;/&nbsp;' +
