...
var generateHeaderFrame = function() {
	return  '<div class="container">'+
			...
			'					<a title="International Conference on Smart Finance 2019" href="index.html">' + 
			'						ICSF 2019' + 
			'					</a>' + 
			'				</div>' + 
			'			</div>' + 
...
var generateFooterFrame = function() {
	return  '<div class="container">' + 
			...
			'ICSF 2019' +
			'		Copyright © 2019 <span>BJUT</span> All rights reserved. ' + 
		    '<span> July 26-28, 2019  Beijing University of Technology</span>' +
		    '</div>' +
		    '</div>';
};
...
var generateFooter = function(p_locale) {
	...
	var html_text =  
					...
					'ICSF 2019 Copyright © 2019 <span>BJUT</span> All rights reserved.'+ '<span> July 26-28, 2019  Beijing University of Technology</span>';
