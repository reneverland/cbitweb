...
var i18n_header_footer = {
	'en-us': {
		'issf': 'International Conference on Smart Finance',
		'home': 'Home',
		'about': 'About',
		...
		'travelinfo_value': 'travelinfo.html',

		'host': 'hosts',
		'contact': 'Secretariat of ICSF 2018',
...
var generateHeaderFrame = function() {
	return  '<div class="container">'+
			...
			'					<a title="International Conference on Smart Finance 2020" href="index.html">' + 
			'						ICSF 2020' + 
			'					</a>' + 
			'				</div>' + 
			'			</div>' + 
			...
			'		   				<div class="row">' + 
			'		   					<div class="col-md-3 col-sm-12 col-xs-12 menu-item">' + 
			'		   						<a id="menu_travel" href="travelinfo.html">Travel Information</a>' + 
			'		   					</div>' + 
			'                    </div>' +
			'		   			</div>' + 
			'		   		</div>' + 
...
var generateHeader = function(p_locale) {
	...
	$('#menu_travel').html(i18n_header_footer[p_locale]['travelinfo']);
	$('#menu_travel').attr('href', i18n_header_footer[p_locale]['travelinfo_value']);
	...
	if(dotBegin > pageIndexBegin) {
		...
		}else if(pageOrigin == 'travelinfo') {
			$('#menu_travel').parent().addClass('active');
...
var generateFooterFrame = function() {
	return  '<div class="container">' + 
			...
			'ICSF 2020' +
			'		Copyright © 2020 <span></span> All rights reserved. ' + 
		    '<span> June 28-30, 2020  Beijing University of Technology</span>' +
		    '</div>' +
		    '</div>';
};
...
var generateFooter = function(p_locale) {
	...
	var html_text =  
					...
					'ICSF 2020 Copyright © 2020 <span></span> All rights reserved.'+ '<span> June 28-30, 2020  Beidaihe, Heibei, China</span>';
